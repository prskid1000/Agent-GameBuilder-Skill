...
| `premade/code_snippets.txt` | Paste-ready GDScript constants (MACHINE_PREVIEW_TEXTURES, seed_amount, TOOL_TEXTURES, SOIL_DIRECTIONS) | See scene-files.md for full annotated content |
