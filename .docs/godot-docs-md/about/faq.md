...
available under the OSI-approved MIT license. This means it is
...
as well as the LICENSE.txt
and LOGO_LICENSE.txt files
...
<span id="doc_faq_what_is_gdscript"></span>
...
you, check out the [GDScript scripting guide](../tutorials/scripting/gdscript/index.md#doc_gdscript).
...
languages can be found in the [doc_gdscript_more_efficiently](../tutorials/scripting/gdscript/gdscript_advanced.md#doc_gdscript_more_efficiently) tutorial.
...
<span id="doc_faq_which_programming_language_is_fastest"></span>
...
C++, using [GDExtension](../tutorials/scripting/gdextension/what_is_gdextension.md#doc_what_is_gdextension), will almost always be
...
[cross-language scripting](../tutorials/scripting/cross_language_scripting.md#doc_cross_language_scripting), or by using
...
[doc_importing_3d_scenes](../tutorials/assets_pipeline/importing_3d_scenes/index.md#doc_importing_3d_scenes) documentation.
...
for additional languages, take a look at [EditorPlugins](../tutorials/plugins/editor/making_plugins.md#doc_making_plugins)
and tool scripts.
...
as well as the Jolt physics engine integration
...
- Rename and move the Godot binary to a location present in your `PATH` environment variable.
  ...
  [run the Godot editor from a terminal](../tutorials/editor/command_line_tutorial.md#doc_command_line_tutorial) by entering `godot`.
...
See [doc_data_paths](../tutorials/io/data_paths.md#doc_data_paths) for more information.

If *true* portable operation is desired (e.g. for use on a USB stick),
follow the steps in [doc_data_paths_self_contained_mode](../tutorials/io/data_paths.md#doc_data_paths_self_contained_mode).
...
[compile custom export templates with unused features disabled](../engine_details/development/compiling/optimizing_for_size.md#doc_optimizing_for_size)
...
2. Use the stretch options in Godot; canvas items stretching while keeping
   aspect ratios works best. Check the [doc_multiple_resolutions](../tutorials/rendering/multiple_resolutions.md#doc_multiple_resolutions) tutorial
...
3. Determine a minimum resolution and then decide if you want your game
   ...
   instead. This is also explained in [doc_multiple_resolutions](../tutorials/rendering/multiple_resolutions.md#doc_multiple_resolutions).

4. For user interfaces, use the [anchoring](../tutorials/ui/size_and_anchors.md#doc_size_and_anchors)
...
When it's ready! See [doc_release_policy_when_is_next_release_out](release_policy.md#doc_release_policy_when_is_next_release_out) for more
information.
...
[doc_release_policy_which_version_should_i_use](release_policy.md#doc_release_policy_which_version_should_i_use) for more information.
...
[doc_release_policy_should_i_upgrade_my_project](release_policy.md#doc_release_policy_should_i_upgrade_my_project) for more information.

### Should I use the Forward+, Mobile, or Compatibility renderer?

You can find a detailed comparison of the renderers in [doc_renderers](../tutorials/rendering/renderers.md#doc_renderers).
...
what other ways to contribute are there in our documentation for contributors.
...
Godot, start by discussing it with our community.
...
<span id="doc_faq_non_game_applications"></span>
...
See [doc_creating_applications](../tutorials/ui/creating_applications.md#doc_creating_applications) for more information.

<span id="doc_faq_use_godot_as_library"></span>
...
migeran/libgodot_project GitHub repository.
...
This custom UI toolkit can be [embedded into other applications](faq.md#doc_faq_use_godot_as_library)
(experimental). However, the preferred way to use it is to
[use Godot to create non-game applications with the editor](faq.md#doc_faq_non_game_applications).

<span id="doc_faq_why_scons"></span>

### Why does Godot use the SCons build system?

Godot uses the SCons build system. There are no
...
-  Godot's build process is not simple. Several files are generated by
   ...
   customization ([modules](../engine_details/engine_api/custom_modules_in_cpp.md#doc_custom_modules_in_cpp)). This requires
...
<span id="doc_faq_why_not_stl"></span>
...
Check out [Godot's container types](../engine_details/architecture/core_types.md#doc_core_types) for alternatives.
