<span id="doc_release_policy"></span>
...
.. seealso::
    ...
    See [doc_upgrading_to_godot_4](../tutorials/migrating/upgrading_to_godot_4.md#doc_upgrading_to_godot_4) for instructions on migrating a project
    from Godot 3.x to 4.x.

<span id="doc_release_policy_which_version_should_i_use"></span>
...
[doc_upgrading_to_godot_4](../tutorials/migrating/upgrading_to_godot_4.md#doc_upgrading_to_godot_4) open in a separate tab to check which methods
...
<span id="doc_release_policy_should_i_upgrade_my_project"></span>

### Should I upgrade my project to use new engine versions?

> **Note:** Upgrading software while working on a project is inherently risky, so consider whether it's a good idea for your project before attempting an upgrade. Also, make backups of your project or use version control to prevent losing data in case the upgrade goes wrong. That said, we do our best to keep minor and especially patch releases compatible with existing projects.
...
<span id="doc_release_policy_when_is_next_release_out"></span>
