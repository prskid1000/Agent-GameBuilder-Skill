...
The [Tutorials and resources](../community/tutorials.md#doc_community_tutorials) page lists
video tutorials contributed by the community. If you prefer video to text,
consider checking them out. Otherwise, [Getting Started](../getting_started/introduction/index.md#doc_getting_started_intro)
is a great starting point.

In case you have trouble with one of the tutorials or your project,
you can find help on the various Community channels,
especially the Godot Discord community and
Forum.
...
if you need a quick write-up about Godot Engine:
    ...
    It is supported by the Godot Foundation
    not-for-profit.
...
- **About** contains this introduction as well as
  ...
  also contains the [doc_faq](faq.md#doc_faq).
- **Getting Started** contains all necessary information on using the engine to
  make games. It starts with the [doc_getting_started_intro](../getting_started/introduction/index.md#doc_getting_started_intro) section which
...
- **Community** is dedicated to the life of Godot's community and contains a list of
  ...
  communities, which are now listed on the Godot website.
...
If you are interested in helping, see How to contribute
and Writing documentation,
or get in touch with the Documentation team
on Godot Contributors Chat.
