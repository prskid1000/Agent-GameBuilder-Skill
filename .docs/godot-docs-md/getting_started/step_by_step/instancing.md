<span id="doc_instancing"></span>

## Creating instances

> **Note:** 
   This tutorial refers to instancing scenes in the editor. To learn how
   to instance scenes from code, see [doc_nodes_and_scene_instances](../../tutorials/scripting/nodes_and_scene_instances.md#doc_nodes_and_scene_instances).
   ...
   objects quickly. See [doc_using_multimesh](../../tutorials/performance/using_multimesh.md#doc_using_multimesh) instead.
...
and bounce on walls, a [Sprite2D](../../classes/class_sprite2d.md#class_Sprite2D) node, and a
[CollisionShape2D](../../classes/class_collisionshape2d.md#class_CollisionShape2D).

![](img/instancing_ball_scene.webp)
...
![](img/instancing_ball_instances_example.webp)
...
![](img/instancing_2d_scene_select.webp)

![](img/instancing_main_scene.webp)
...
![](img/instancing_ball_duplicated.webp)

You can repeat this process until you have several in the scene.

![](img/instancing_main_scene_with_balls.webp)
...
> **Note:** corresponding packed scene.
Let's try this. Double-click `ball.tscn` in the FileSystem to open it.

![](img/instancing_ball_scene_open.webp)
...
> **Note:** You may notice you are unable to change the values of the :inspector:`PhysicsMaterial` of the ball. This is because :inspector:`PhysicsMaterial` is a *resource*, and needs to be made unique before you can edit it in a scene that is linking to its original scene. To make a resource unique for one instance, right-click on the :inspector:`Physics Material` property in the :ui:`Inspector` and click :button:`Make Unique` in the context menu. Resources are another essential building block of Godot games we will cover in a later lesson.
