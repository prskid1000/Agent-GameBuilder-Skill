...
<span id="doc_scripting_player_input"></span>

## Listening to player input

Building upon the previous lesson, [doc_scripting_first_script](scripting_first_script.md#doc_scripting_first_script), let's look
...
1. The built-in input callbacks, mainly `_unhandled_input()`. Like
   ...
   more about input callbacks, see [doc_inputevent](../../tutorials/inputs/inputevent.md#doc_inputevent).
...
> **Note:** :menu:`Project > Project Settings` and clicking on the :ui:`Input Map` tab.
...
In the next lesson, [doc_signals](signals.md#doc_signals), we'll build upon the relationship between
