<span id="doc_your_first_3d_game"></span>
...
The game we'll code here is similar to [doc_your_first_2d_game](../first_2d_game/index.md#doc_your_first_2d_game), with a twist:
...
- Squash the Creeps source code (GDScript)
- Squash the Creeps source code (C#)
...
- [01.Game Setup](01.game_setup.md)
- [02.Player Input](02.player_input.md)
- [03.Player Movement Code](03.player_movement_code.md)
- [04.Mob Scene](04.mob_scene.md)
- [05.Spawning Mobs](05.spawning_mobs.md)
- [06.Jump And Squash](06.jump_and_squash.md)
- [07.Killing Player](07.killing_player.md)
- [08.Score And Replay](08.score_and_replay.md)
- [09.Adding Animations](09.adding_animations.md)
