<span id="doc_first_3d_game_score_and_replay"></span>
...
In the main scene, add a new child node [Control](../../classes/class_control.md#class_Control) to `Main` and name it
`UserInterface`. Ensure you are on the 2D screen, where you can edit your User Interface (UI).

Add a [Label](../../classes/class_label.md#class_Label) node and name it `ScoreLabel`
...
.. seealso::
    ...
    creating and editing themes, see [doc_gui_skinning](../../tutorials/ui/gui_skinning.md#doc_gui_skinning).
...
.. seealso::
    ...
    You can learn more about string formatting here: [doc_gdscript_printf](../../tutorials/scripting/gdscript/gdscript_format_string.md#doc_gdscript_printf).
...
child node [ColorRect](../../classes/class_colorrect.md#class_ColorRect), and name it `Retry`. This node fills a
...
Next, add a [Label](../../classes/class_label.md#class_Label) as a child of `Retry` and give it the *Text*
...
another feature in Godot: [autoloads](../../tutorials/scripting/singletons_autoload.md#doc_singletons_autoload).

To play audio, all you need to do is add an [AudioStreamPlayer](../../classes/class_audiostreamplayer.md#class_AudioStreamPlayer) node to your
...
Click the *Other Node* button to create an [AudioStreamPlayer](../../classes/class_audiostreamplayer.md#class_AudioStreamPlayer) and rename it to
`MusicPlayer`.
