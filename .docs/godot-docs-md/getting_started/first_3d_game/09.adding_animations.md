<span id="doc_first_3d_game_character_animation"></span>
...
Open the player scene, select the `Player` node, and add an [AnimationPlayer](../../classes/class_animationplayer.md#class_AnimationPlayer) node.
...
![](img/09.adding_animations/curves.webp)
...
Then open `mob.tscn`, create an [AnimationPlayer](../../classes/class_animationplayer.md#class_AnimationPlayer) child
