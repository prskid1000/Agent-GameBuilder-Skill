<span id="doc_first_3d_game_killing_the_player"></span>
...
kinds of collisions. Instead, though, we will use an [Area3D](../../classes/class_area3d.md#class_Area3D) node, which
works well for hitboxes.

### Hitbox with the Area node

Head back to the `player.tscn` scene and add a new child node [Area3D](../../classes/class_area3d.md#class_Area3D). Name it
`MobDetector`
Add a [CollisionShape3D](../../classes/class_collisionshape3d.md#class_CollisionShape3D) node as a child of it.
...
The *MobDetector* will emit `body_entered` when a [CharacterBody3D](../../classes/class_characterbody3d.md#class_CharacterBody3D) or a
[RigidBody3D](../../classes/class_rigidbody3d.md#class_RigidBody3D) node enters it. As it only masks the "enemies" physics
