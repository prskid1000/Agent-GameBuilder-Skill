<span id="doc_first_3d_game_spawning_monsters"></span>
...
[PathFollow3D](../../classes/class_pathfollow3d.md#class_PathFollow3D) node to sample random locations on it.
...
Select the [Camera3D](../../classes/class_camera3d.md#class_Camera3D) node and click the *Preview* checkbox in the bottom
viewport.
...
Let's add the placeholder meshes. Add a new [Node3D](../../classes/class_node3d.md#class_Node3D) as a child of the
`Main` node and name it `Cylinders`. We'll use it to group the cylinders. Select `Cylinders` and add a child node [MeshInstance3D](../../classes/class_meshinstance3d.md#class_MeshInstance3D)
...
In the *Inspector*, expand the *Material* section and assign a [StandardMaterial3D](../../classes/class_standardmaterial3d.md#class_StandardMaterial3D) to slot *0*.
...
![](img/05.spawning_mobs/albedo_section.webp)
...
Add a child node [Path3D](../../classes/class_path3d.md#class_Path3D) to `Main` node. In the toolbar, four icons appear. Click
...
To sample random positions on it, we need a [PathFollow3D](../../classes/class_pathfollow3d.md#class_PathFollow3D) node. Add a
[PathFollow3D](../../classes/class_pathfollow3d.md#class_PathFollow3D) as a child of the `Path3D`. Rename the two nodes to `SpawnLocation` and
...
Add a new [Timer](../../classes/class_timer.md#class_Timer) node as a child of `Main`. Name it `MobTimer`.
