<span id="doc_your_first_2d_game_creating_the_enemy"></span>
...
- [RigidBody2D](../../classes/class_rigidbody2d.md#class_RigidBody2D) (named `Mob`)

   - [AnimatedSprite2D](../../classes/class_animatedsprite2d.md#class_AnimatedSprite2D)
   - [CollisionShape2D](../../classes/class_collisionshape2d.md#class_CollisionShape2D)
   - [VisibleOnScreenNotifier2D](../../classes/class_visibleonscreennotifier2d.md#class_VisibleOnScreenNotifier2D)
...
property in the [RigidBody2D](../../classes/class_rigidbody2d.md#class_RigidBody2D)
section of the inspector to `0`.
This will prevent the mob from falling downwards.

In addition, under the [CollisionObject2D](../../classes/class_collisionobject2d.md#class_CollisionObject2D)
...
![](img/set_collision_mask.webp)

Set up the [AnimatedSprite2D](../../classes/class_animatedsprite2d.md#class_AnimatedSprite2D) like you did for the
...
In the GDScript code, we use the [Array.pick_random](../../classes/class_array.md#class_Array_method_pick_random) method
