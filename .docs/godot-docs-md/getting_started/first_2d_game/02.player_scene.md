<span id="doc_your_first_2d_game_player_scene"></span>
...
![](img/player_scale.webp)

Finally, add a [CollisionShape2D](../../classes/class_collisionshape2d.md#class_CollisionShape2D) as a child of
