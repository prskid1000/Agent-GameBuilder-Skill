<span id="doc_your_first_2d_game_finishing_up"></span>
...
One way to do this is to use a [ColorRect](../../classes/class_colorrect.md#class_ColorRect) node. Make it
...
[TextureRect](../../classes/class_texturerect.md#class_TextureRect) node instead.
...
Add two [AudioStreamPlayer](../../classes/class_audiostreamplayer.md#class_AudioStreamPlayer) nodes as children of
...
![](img/unique_resource_music.webp)
...
![](img/input-mapping-start_game.webp)
...
property in the Inspector. Create a new [Shortcut](../../classes/class_shortcut.md#class_Shortcut) resource
by clicking within the box, open the **Events** array and add a new array element
to it by clicking on **Array[InputEvent] (size 0)**.

![](img/start_button_shortcut.webp)

Create a new [InputEventAction](../../classes/class_inputeventaction.md#class_InputEventAction) and select the `start_game` action.

![](img/start_button_shortcut2.webp)
...
And when you're ready, you can move on to [doc_your_first_3d_game](../first_3d_game/index.md#doc_your_first_3d_game) to learn
...
playable on. See [doc_exporting_projects](../../tutorials/export/exporting_projects.md#doc_exporting_projects) for instructions.
