<span id="doc_your_first_2d_game_the_main_game_scene"></span>

## The main game scene

Now it's time to bring everything we did together into a playable game scene.

Create a new scene and add a [Node](../../classes/class_node.md#class_Node) named `Main`.
...
![](img/instance_scene.webp)

Now, add the following nodes as children of `Main`, and name them as shown:

- [Timer](../../classes/class_timer.md#class_Timer) (named `MobTimer`) - to control how often mobs
  spawn
- [Timer](../../classes/class_timer.md#class_Timer) (named `ScoreTimer`) - to increment the score
  every second
- [Timer](../../classes/class_timer.md#class_Timer) (named `StartTimer`) - to give a delay before
  starting
- [Marker2D](../../classes/class_marker2d.md#class_Marker2D) (named `StartPosition`) - to indicate
...
add a child [Path2D](../../classes/class_path2d.md#class_Path2D) node named `MobPath`. When you select
`Path2D`, you will see some new buttons at the top of the editor:

![](img/path2d_buttons.webp)
...
Now that the path is defined, add a [PathFollow2D](../../classes/class_pathfollow2d.md#class_PathFollow2D)
