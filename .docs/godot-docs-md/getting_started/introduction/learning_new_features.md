...
<span id="doc_learning_new_features"></span>
...
![](img/manual_class_reference_search.webp)

To browse it online, head to the manual's [Class Reference](../../classes/index.md#doc_class_reference)
section.
...
![](img/manual_class_reference_inheritance.webp)
...
> **Note:** information, please open an Issue in the official `godot-docs <https://github.com/godotengine/godot-docs/issues>`_ GitHub repository to report it.
...
3. If there is code involved, **share a code sample**. Other users won't be able
   ...
   box, or use a website like Pastebin to share long
   files.
...
![](img/key_concepts_scene_tree.webp)
   ...
   Alternatively, you can use a program like ShareX
   on Windows, or Flameshot on Windows/macOS/Linux.
...
5. Sharing a video of your running game can also be really **useful to
   ...
   You can then use a service like streamable or a
...
[doc_community_tutorials](../../community/tutorials.md#doc_community_tutorials), which lists content made by the Godot community.
