...
<span id="doc_key_concepts_overview"></span>
...
<span id="doc_key_concepts_overview_scenes"></span>
...
![](img/key_concepts_character_nodes.webp)

It is made of a `CharacterBody2D` node named "Player", a `Camera2D`, a
`Sprite2D`, and a `CollisionShape2D`.

> **Note:** counterparts have names that end with "3D". Be aware that "Spatial" Nodes are now called "Node3D" starting with Godot 4.
...
![](img/key_concepts_node_menu.webp)
...
<span id="doc_key_concepts_signals"></span>
...
![](img/key_concepts_signals.webp)

> **Note:** more about it here: https://gameprogrammingpatterns.com/observer.html
