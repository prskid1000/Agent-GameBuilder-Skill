<span id="doc_introduction_to_godot"></span>
...
You can code your games using [GDScript](../../tutorials/scripting/gdscript/index.md#doc_gdscript), a
Godot-specific and tightly integrated language with a lightweight syntax, or
[C#](../../tutorials/scripting/c_sharp/index.md#doc_c_sharp), which is popular in the games industry.
These are the two main scripting languages we support.

With the [GDExtension](../../tutorials/scripting/gdextension/what_is_gdextension.md#doc_what_is_gdextension) technology, you can also
write gameplay or high-performance algorithms in [C++](../../tutorials/scripting/cpp/index.md#doc_godot_cpp) or
[other languages](../../tutorials/scripting/other_languages.md#doc_scripting_languages) without recompiling the engine.
...
<span id="doc_introduction_learning_programming"></span>
...
[doc_learning_new_features](learning_new_features.md#doc_learning_new_features).
