<span id="doc_javaclasswrapper_and_androidruntimeplugin"></span>
...
These don't make sense in Godot core itself so Godot has long provided an [Android plugin system](android_plugin.md#doc_android_plugin).
The [Android plugin system](android_plugin.md#doc_android_plugin) enables developers to create Godot Android plugins using Java or Kotlin code,
...
`JavaClassWrapper` is a [Godot singleton](../../../classes/class_javaclasswrapper.md#class_JavaClassWrapper) which allows
