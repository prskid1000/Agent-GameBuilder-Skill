<span id="doc_android_in_app_purchases"></span>
...
Make sure you have enabled and successfully set up [Android Gradle Builds](../../export/android_gradle_build.md#doc_android_gradle_build).
...
The signal has a single parameter: a [Dictionary](../../../classes/class_dictionary.md#class_Dictionary) with
...
of purchases in [Dictionary](../../../classes/class_dictionary.md#class_Dictionary) format. The purchase Dictionary
