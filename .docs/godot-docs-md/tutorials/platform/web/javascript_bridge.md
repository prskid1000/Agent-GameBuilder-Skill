<span id="doc_web_javascript_bridge"></span>

## The JavaScriptBridge singleton

In web builds, the [JavaScriptBridge](../../../classes/class_javascriptbridge.md#class_JavaScriptBridge) singleton
...
a Godot [JavaScriptObject](../../../classes/class_javascriptobject.md#class_JavaScriptObject) that tries to feel
natural in the context of Godot scripting (e.g. GDScript and C#).

The [JavaScriptBridge.get_interface()](../../../classes/class_javascriptbridge.md#class_JavaScriptBridge_method_get_interface)
...
The [JavaScriptBridge.create_object()](../../../classes/class_javascriptbridge.md#class_JavaScriptBridge_method_create_object)
...
[Head Include](../../export/exporting_for_web.md#doc_javascript_export_options) during export (see below),
or even [write your own template](customizing_html5_shell.md#doc_customizing_html5_shell).
 ...
 * JavaScript `number` is returned as [class_float](../../../classes/class_float.md#class_float)
 * JavaScript `boolean` is returned as [class_bool](../../../classes/class_bool.md#class_bool)
 * JavaScript `string` is returned as [class_String](../../../classes/class_string.md#class_String)
 * JavaScript `ArrayBuffer`, `TypedArray`, and `DataView` are returned as [PackedByteArray](../../../classes/class_packedbytearray.md#class_PackedByteArray)
...
HTML5 export templates may be [built](../../../engine_details/development/compiling/compiling_for_web.md#doc_compiling_for_web) without
...
`web` [feature tag](../../export/feature_tags.md#doc_feature_tags):
...
<span id="doc_web_downloading_files"></span>
...
a dedicated [JavaScriptBridge.download_buffer()](../../../classes/class_javascriptbridge.md#class_JavaScriptBridge_method_download_buffer)
