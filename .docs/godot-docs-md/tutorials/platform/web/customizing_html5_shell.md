<span id="doc_customizing_html5_shell"></span>
...
See the [HTML5 shell class reference](html5_shell_classref.md#doc_html5_shell_classref), for the full list of methods and options available.
...
[OS.get_executable_path()](../../../classes/class_os.md#class_OS_method_get_executable_path) method and defines the name of
