<span id="doc_internationalizing_games"></span>
...
[doc_importing_translations](../assets_pipeline/importing_translations.md#doc_importing_translations) tutorial. If you haven't read the Importing
translations page before, we recommend you give it a read before reading this
page.

> **Note:** `download it from the Asset Library <https://godotengine.org/asset-library/asset/2776>`_.
<span id="doc_internationalizing_games_configuring_imported_translation"></span>
...
obtained via [OS.get_locale_language()](../../classes/class_os.md#class_OS_method_get_locale_language).
...
A [locale](locales.md#doc_locales) is commonly a combination of a language with a
...
Some controls, such as [Button](../../classes/class_button.md#class_Button) and [Label](../../classes/class_label.md#class_Label),
...
In code, the [Object.tr()](../../classes/class_object.md#class_Object_method_tr) function can be used.
...
<span id="doc_internationalizing_games_translation_contexts"></span>
...
<span id="doc_internationalizing_games_pluralization"></span>
...
this, make sure to read the tutorial on [doc_size_and_anchors](../ui/size_and_anchors.md#doc_size_and_anchors), as
dynamically adjusting control sizes may help.
[Container](../../classes/class_container.md#class_Container) can be useful, as well as the text wrapping
options available in [Label](../../classes/class_label.md#class_Label).

To check whether your UI can accommodate translations with longer strings than
the original, you can enable [pseudolocalization](pseudolocalization.md#doc_pseudolocalization)
...
called the [TranslationServer](../../classes/class_translationserver.md#class_TranslationServer).
Translations can be added or removed during runtime;
the current language can also be changed at runtime.

<span id="doc_internationalizing_games_bidi"></span>
...
[TextServer.format_number(string, language)](../../classes/class_textserver.md#class_TextServer_method_format_number)
can be used to convert Western Arabic numbers (0..9) to the localized numbering system
and [TextServer.parse_number(string, language)](../../classes/class_textserver.md#class_TextServer_method_parse_number)
to convert it back.
...
![](img/locale_editor_preview.webp)

All text in scenes in the editor should now be displayed using the selected language.

Translations can also be tested when [running Godot from the command line](../editor/command_line_tutorial.md#doc_command_line_tutorial).
...
![](img/localized_name.webp)

If you are unsure about the language code to use, refer to the
[list of locale codes](locales.md#doc_locales).
