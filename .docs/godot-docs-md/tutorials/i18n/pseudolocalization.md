<span id="doc_pseudolocalization"></span>
...
![](img/pseudolocalization_settings.webp)

Pseudolocalization can also be [toggled at runtime from a script](pseudolocalization.md#doc_pseudolocalization_runtime).
...
<span id="doc_pseudolocalization_runtime"></span>

### Configuring pseudolocalization at runtime

Pseudolocalization can be toggled at runtime using the
[pseudolocalization_enabled](../../classes/class_translationserver.md#class_TranslationServer_property_pseudolocalization_enabled) property
...
[ProjectSettings.set_setting(property, value)](../../classes/class_projectsettings.md#class_ProjectSettings_method_set_setting)
and then calling
[TranslationServer.reload_pseudolocalization()](../../classes/class_translationserver.md#class_TranslationServer_method_reload_pseudolocalization)
