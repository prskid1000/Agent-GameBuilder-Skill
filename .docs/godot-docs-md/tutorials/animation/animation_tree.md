<span id="doc_animation_tree"></span>

## Using AnimationTree

### Introduction

With [AnimationPlayer](../../classes/class_animationplayer.md#class_AnimationPlayer), Godot has one of the most flexible animation systems that you can find in any game engine.
...
[AnimationTree](../../classes/class_animationtree.md#class_AnimationTree) is a node designed to deal with advanced transitions.
...
![](img/animtree_treeandplayersetup.png)
...
![](img/animtree_emptyblendtree.webp)
...
![](img/animtree_emptystatemachine.webp)
...
![](img/animtree_connections.gif)

There are 3 types of transitions:

![](img/animtree_transitiontypes.png)
...
![](img/animtree_statemachinetransitionproperties.webp)
...
![](img/animtree_goodanimcondition.webp)
![](img/animtree_goodanimcondition.gif)
...
![](img/animtree_goodanimexpression.webp)
![](img/animtree_goodanimexpression2.webp)
![](img/animtree_goodanimexpression.gif)
...
.. seealso::
   ...
   The Advance Expression is evaluated using Godot's [class_expression](../../classes/class_expression.md#class_expression) class.
   See [doc_evaluating_expressions](../scripting/evaluating_expressions.md#doc_evaluating_expressions) for more information on writing expressions.
...
To use the travel ability, you should first retrieve the [AnimationNodeStateMachinePlayback](../../classes/class_animationnodestatemachineplayback.md#class_AnimationNodeStateMachinePlayback)
...
![](img/animtree_blendspacepoints.gif)
...
> **Note:** It is assumed to have only one frame and is not expected to be played back using the timeline.
...
![](img/animtree_rootmotiontrack.webp)

Afterwards, the actual motion can be retrieved via the [AnimationTree](../../classes/class_animationtree.md#class_AnimationTree) API as a transform:
...
This can be fed to functions such as [CharacterBody3D.move_and_slide](../../classes/class_characterbody3d.md#class_CharacterBody3D_method_move_and_slide) to control the character movement.
...
![](img/animtree_propertypath.webp)
...
> **Note:** AnimationTree itself. Advance `Conditions` will be found under parameters.
