<span id="doc_playing_videos"></span>

## Playing videos

Godot supports video playback with the [class_VideoStreamPlayer](../../classes/class_videostreamplayer.md#class_VideoStreamPlayer) node.
...
> **Note:** You may find videos with a ``.ogg`` or ``.ogx`` extensions, which are generic extensions for data within an Ogg container. Renaming these file extensions to ``.ogv`` *may* allow the videos to be imported in Godot. However, not all files with ``.ogg`` or ``.ogx`` extensions are videos - some of them may only contain audio.
...
2. Select the VideoStreamPlayer node in the scene tree dock, go to the inspector
   ...
   - If you don't have your video in Ogg Theora format yet, jump to
     [doc_playing_videos_recommended_theora_encoding_settings](playing_videos.md#doc_playing_videos_recommended_theora_encoding_settings).
...
the video's resolution. You can make it follow usual [class_Control](../../classes/class_control.md#class_Control) sizing
...
[class_AspectRatioContainer](../../classes/class_aspectratiocontainer.md#class_AspectRatioContainer) node, which is designed to handle this kind of
use case:
...
.. seealso::
    ...
    See [doc_multiple_resolutions](../rendering/multiple_resolutions.md#doc_multiple_resolutions) for more tips on supporting multiple
    aspect ratios in your project.

Displaying a video on a 3D surface
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Using a VideoStreamPlayer node as a child of a [class_SubViewport](../../classes/class_subviewport.md#class_SubViewport) node,
...
1. Create a [class_SubViewport](../../classes/class_subviewport.md#class_SubViewport) node. Set its size to match your video's size
   in pixels.
...
See [doc_viewports](../rendering/viewports.md#doc_viewports) and the
GUI in 3D demo
...
<span id="doc_playing_videos_recommended_theora_encoding_settings"></span>
