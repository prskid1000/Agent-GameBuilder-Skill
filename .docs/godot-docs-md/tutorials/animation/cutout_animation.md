...
<span id="doc_cutout_animation"></span>
...
-  **Custom Shaped Elements**: Custom shapes can be created with
   [Polygon2D](../../classes/class_polygon2d.md#class_Polygon2D)
...
This small cross in the middle of the [Sprite2D](../../classes/class_sprite2d.md#class_Sprite2D) is
the rotation pivot:
...
The [RemoteTransform2D](../../classes/class_remotetransform2d.md#class_RemoteTransform2D) node transforms nodes
...
but [Marker2D](../../classes/class_marker2d.md#class_Marker2D) is preferred because it's
...
works, see [doc_introduction_animation](introduction.md#doc_introduction_animation).
...
This process is described in a [separate tutorial](2d_skeletons.md#doc_2d_skeletons).
