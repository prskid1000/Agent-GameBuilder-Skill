<span id="doc_introduction_animation"></span>

## Introduction to the animation features

The [class_AnimationPlayer](../../classes/class_animationplayer.md#class_AnimationPlayer) node allows you to create anything
...
![](img/animation_marker_click_area.webp)
...
To play the part of the animation between two markers use the [play_section_with_markers()](../../classes/class_animationplayer.md#class_AnimationPlayer_method_play_section_with_markers)
and [play_section_with_markers_backwards()](../../classes/class_animationplayer.md#class_AnimationPlayer_method_play_section_with_markers_backwards)
...
![](img/animation_marker_selected.webp)
