<span id="doc_using_jolt_physics"></span>
...
can be found here on GitHub and in
...
to ([node_a](../../classes/class_joint3d.md#class_Joint3D_property_node_a) vs [node_b](../../classes/class_joint3d.md#class_Joint3D_property_node_b))
...
[class_ConcavePolygonShape3D](../../classes/class_concavepolygonshape3d.md#class_ConcavePolygonShape3D) or [class_HeightMapShape3D](../../classes/class_heightmapshape3d.md#class_HeightMapShape3D) as either "active" or "inactive", based on
...
[class_ConcavePolygonShape3D](../../classes/class_concavepolygonshape3d.md#class_ConcavePolygonShape3D) and [class_HeightMapShape3D](../../classes/class_heightmapshape3d.md#class_HeightMapShape3D), but also edges between any shapes within
the same body.
...
The `face_index` property returned in the results of [intersect_ray()](../../classes/class_physicsdirectspacestate3d.md#class_PhysicsDirectSpaceState3D_method_intersect_ray)
...
Note that enabling this setting will increase the memory requirement of [class_ConcavePolygonShape3D](../../classes/class_concavepolygonshape3d.md#class_ConcavePolygonShape3D)
with about 25%.

Kinematic RigidBody3D contacts
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

When using Jolt, a [class_RigidBody3D](../../classes/class_rigidbody3d.md#class_RigidBody3D) frozen with [FREEZE_MODE_KINEMATIC](../../classes/class_rigidbody3d.md#class_RigidBody3D_constant_FREEZE_MODE_KINEMATIC)
will by default not report contacts from collisions with other static/kinematic
bodies, for performance reasons, even when setting a non-zero [max_contacts_reported](../../classes/class_rigidbody3d.md#class_RigidBody3D_property_max_contacts_reported).
If you have many/large kinematic bodies overlapping with complex static geometry,
such as [class_ConcavePolygonShape3D](../../classes/class_concavepolygonshape3d.md#class_ConcavePolygonShape3D) or [class_HeightMapShape3D](../../classes/class_heightmapshape3d.md#class_HeightMapShape3D), you can
...
Due to limitations internal to Jolt, the contact impulses provided by [PhysicsDirectBodyState3D.get_contact_impulse()](../../classes/class_physicsdirectbodystate3d.md#class_physicsdirectbodystate3d_method_get_contact_impulse)
...
Jolt does not currently support any interactions between [class_SoftBody3D](../../classes/class_softbody3d.md#class_SoftBody3D)
and [class_Area3D](../../classes/class_area3d.md#class_Area3D), such as the wind and gravity properties found on
[class_Area3D](../../classes/class_area3d.md#class_Area3D).

WorldBoundaryShape3D
~~~~~~~~~~~~~~~~~~~~

[class_WorldBoundaryShape3D](../../classes/class_worldboundaryshape3d.md#class_WorldBoundaryShape3D), which is meant to represent an infinite plane, is
