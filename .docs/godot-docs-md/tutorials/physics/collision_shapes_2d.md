<span id="doc_collision_shapes_2d"></span>
...
You can define the shape of a [class_PhysicsBody2D](../../classes/class_physicsbody2d.md#class_PhysicsBody2D) by adding one or more
[CollisionShape2Ds](../../classes/class_collisionshape2d.md#class_CollisionShape2D) or
[CollisionPolygon2Ds](../../classes/class_collisionpolygon2d.md#class_CollisionPolygon2D) as *direct* child nodes.
Indirect child nodes (i.e. children of child nodes) will be ignored and won't be
used as collision shapes. Also, note that you must add a [class_Shape2D](../../classes/class_shape2d.md#class_Shape2D)
...
- [class_RectangleShape2D](../../classes/class_rectangleshape2d.md#class_RectangleShape2D)
- [class_CircleShape2D](../../classes/class_circleshape2d.md#class_CircleShape2D)
- [class_CapsuleShape2D](../../classes/class_capsuleshape2d.md#class_CapsuleShape2D)
- [class_SegmentShape2D](../../classes/class_segmentshape2d.md#class_SegmentShape2D)
- [class_SeparationRayShape2D](../../classes/class_separationrayshape2d.md#class_SeparationRayShape2D) (designed for characters)
- [class_WorldBoundaryShape2D](../../classes/class_worldboundaryshape2d.md#class_WorldBoundaryShape2D) (infinite plane)
...
[Convex collision shapes](../../classes/class_convexpolygonshape2d.md#class_ConvexPolygonShape2D) are a compromise
...
[Concave collision shapes](../../classes/class_concavepolygonshape2d.md#class_ConcavePolygonShape2D), also called trimesh
