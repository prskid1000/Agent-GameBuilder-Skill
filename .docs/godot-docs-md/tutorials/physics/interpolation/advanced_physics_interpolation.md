<span id="doc_advanced_physics_interpolation"></span>
...
[Node](../../../classes/class_node.md#class_Node) (or branch of the [SceneTree](../../../classes/class_scenetree.md#class_SceneTree)), and
have the finer control of performing interpolation manually.

This is possible using the [Node.physics_interpolation_mode](../../../classes/class_node.md#class_Node_property_physics_interpolation_mode)
...
In many cases, a [Camera3D](../../../classes/class_camera3d.md#class_Camera3D) can use automatic interpolation
...
![](img/fti_camera_worldspace.webp)

2) Call [Node3D.top_level](../../../classes/class_node3d.md#class_Node3D_property_top_level) and set this to `true`, which will make the Camera ignore the transform of its parent.
...
We can do this using the [Node3D.get_global_transform_interpolated](../../../classes/class_node3d.md#class_Node3D_method_get_global_transform_interpolated)
function. This acts exactly like getting [Node3D.global_transform](../../../classes/class_node3d.md#class_Node3D_property_global_transform)
...
> **Note:** should be in ``_physics_process()``. In game logic you should be calling ``get_global_transform()`` or ``get_transform()``, which will give the current physics transform (in global or local space respectively), which is usually what you will want for gameplay code.
...
node (using [Node.physics_interpolation_mode](../../../classes/class_node.md#class_Node_property_physics_interpolation_mode))
...
- A first person camera may position the camera at a player location (perhaps using
  [Node3D.get_global_transform_interpolated](../../../classes/class_node3d.md#class_Node3D_method_get_global_transform_interpolated)),
...
- [MultiMesh.reset_instance_physics_interpolation](../../../classes/class_multimesh.md#class_MultiMesh_method_reset_instance_physics_interpolation)
- [MultiMesh.set_buffer_interpolated](../../../classes/class_multimesh.md#class_MultiMesh_method_set_buffer_interpolated)

Full details are in the [MultiMesh](../../../classes/class_multimesh.md#class_MultiMesh) documentation.
