<span id="doc_physics_interpolation_introduction"></span>
...
![](img/fti_graph_fixed_ticks.webp)
...
![](img/fti_graph_interpolated.webp)
...
> **Note:** details, as this step will be performed for you. Under the hood, Godot may use more complex forms of interpolation, but linear interpolation is the easiest in terms of explanation.
...
for you by Godot. It can be retrieved on any frame by calling [Engine.get_physics_interpolation_fraction](../../../classes/class_engine.md#class_Engine_method_get_physics_interpolation_fraction).
...
> **Note:** done with the rotation and scale of objects. It is not necessary to know the details as Godot will do all this for you.
