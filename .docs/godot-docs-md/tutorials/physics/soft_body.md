...
Additionally, [physics interpolation](interpolation/index.md#doc_physics_interpolation) currently
...
A [SoftBody3D](../../classes/class_softbody3d.md#class_SoftBody3D) node is used for soft body simulations.
Unlike other physics body nodes like [RigidBody3D](../../classes/class_rigidbody3d.md#class_RigidBody3D)
or [StaticBody3D](../../classes/class_staticbody3d.md#class_StaticBody3D), it does **not** have a
[CollisionShape3D](../../classes/class_collisionshape3d.md#class_CollisionShape3D) or a [MeshInstance3D](../../classes/class_meshinstance3d.md#class_MeshInstance3D)
...
> **Note:** You can download the Platformer 3D demo on `GitHub <https://github.com/godotengine/godot-demo-projects/tree/master/3d/platformer>`_ or `the Asset Library <https://godotengine.org/asset-library/asset/2748>`_.
...
See [doc_importing_3d_scenes_import_configuration](../assets_pipeline/importing_3d_scenes/import_configuration.md#doc_importing_3d_scenes_import_configuration) and [doc_mesh_lod](../3d/mesh_lod.md#doc_mesh_lod)
for more details.
