<span id="doc_large_world_coordinates"></span>
...
By default, [class_float](../../classes/class_float.md#class_float) is 64-bit in GDScript, but [class_Vector2](../../classes/class_vector2.md#class_Vector2),
[class_Vector3](../../classes/class_vector3.md#class_Vector3) and [class_Vector4](../../classes/class_vector4.md#class_Vector4) are 32-bit. This means that the
...
When saving a *binary* resource using the [class_ResourceSaver](../../classes/class_resourcesaver.md#class_ResourceSaver) singleton,
...
[class_ResourceLoader](../../classes/class_resourceloader.md#class_ResourceLoader) singleton on resources that use this special flag.
...
- [Triplanar mapping](../3d/standard_material_3d.md#doc_standard_material_3d_triplanar_mapping) doesn't
...
- [class_GPUParticles3D](../../classes/class_gpuparticles3d.md#class_GPUParticles3D) nodes with **Local Coords** disabled will not benefit
  ...
  as well as [class_CPUParticles3D](../../classes/class_cpuparticles3d.md#class_CPUParticles3D) nodes, will still benefit from increased precision.
...
```
  ...
  pass them using a [varying](../shaders/shader_reference/shading_language.md#doc_shading_language_varyings), for example:
