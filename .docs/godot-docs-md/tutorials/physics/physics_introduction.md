<span id="doc_physics_introduction"></span>
...
> **Note:** and collision shape has a direct equivalent in 3D and in most cases they work in much the same way.
### Collision objects

Godot offers four kinds of collision objects which all extend [CollisionObject2D](../../classes/class_collisionobject2d.md#class_CollisionObject2D).
The last three listed below are physics bodies and additionally extend [PhysicsBody2D](../../classes/class_physicsbody2d.md#class_PhysicsBody2D).

- [Area2D](../../classes/class_area2d.md#class_Area2D)
...
- [StaticBody2D](../../classes/class_staticbody2d.md#class_StaticBody2D)
...
- [RigidBody2D](../../classes/class_rigidbody2d.md#class_RigidBody2D)
    ...
    [Read more about using rigid bodies.](rigid_body.md#doc_rigid_body)

- [CharacterBody2D](../../classes/class_characterbody2d.md#class_CharacterBody2D)
...
A physics body can hold any number of [Shape2D](../../classes/class_shape2d.md#class_Shape2D) objects
as children. These shapes are used to define the object's collision bounds
and to detect contact with other objects.

> **Note:** assigned to the object.
The most common way to assign a shape is by adding a [CollisionShape2D](../../classes/class_collisionshape2d.md#class_CollisionShape2D)
or [CollisionPolygon2D](../../classes/class_collisionpolygon2d.md#class_CollisionPolygon2D) as a child of the object.
...
differentiates [between physics and idle processing](../scripting/idle_and_physics_processing.md#doc_idle_and_physics_processing).
...
The physics callback, [Node._physics_process()](../../classes/class_node.md#class_Node_private_method__physics_process),
...
<span id="doc_physics_introduction_collision_layers_and_masks"></span>
...
![](img/player_collision_layers.webp)
![](img/player_collision_mask.webp)

<span id="doc_physics_introduction_collision_layer_code_example"></span>
...
or `set_collision_mask_value(layer_number, value)` on any given [CollisionObject2D](../../classes/class_collisionobject2d.md#class_CollisionObject2D) as follows:
...
Additional export annotations are available for render and navigation layers, in both 2D and 3D. See [doc_gdscript_exports_exporting_bit_flags](../scripting/gdscript/gdscript_exports.md#doc_gdscript_exports_exporting_bit_flags).
...
There are three main uses for [Area2D](../../classes/class_area2d.md#class_Area2D):
...
This is the node that implements simulated 2D physics. You do not control a
[RigidBody2D](../../classes/class_rigidbody2d.md#class_RigidBody2D) directly. Instead, you apply forces
...
**Project Settings > Physics**, or by entering an [Area2D](../../classes/class_area2d.md#class_Area2D)
...
of the physics-related properties, you should use the [_integrate_forces()](../../classes/class_rigidbody2d.md#class_RigidBody2D_private_method__integrate_forces)
callback instead of `_physics_process()`. In this callback, you have access
to the body's [PhysicsDirectBodyState2D](../../classes/class_physicsdirectbodystate2d.md#class_PhysicsDirectBodyState2D),
...
> **Note:** function will not be called. To override this behavior, you will need to keep the body awake by creating a collision, applying a force to it, or by disabling the :ref:`can_sleep <class_RigidBody2D_property_can_sleep>` property. Be aware that this can have a negative effect on performance.
Contact reporting
~~~~~~~~~~~~~~~~~

By default, rigid bodies do not keep track of contacts, because this can
require a huge amount of memory if many bodies are in the scene. To enable
contact reporting, set the [max_contacts_reported](../../classes/class_rigidbody2d.md#class_RigidBody2D_property_max_contacts_reported)
property to a non-zero value. The contacts can then be obtained via
[PhysicsDirectBodyState2D.get_contact_count()](../../classes/class_physicsdirectbodystate2d.md#class_PhysicsDirectBodyState2D_method_get_contact_count)
and related functions.

Contact monitoring via signals can be enabled via the [contact_monitor](../../classes/class_rigidbody2d.md#class_RigidBody2D_property_contact_monitor)
property. See [RigidBody2D](../../classes/class_rigidbody2d.md#class_RigidBody2D) for the list of available
signals.

### CharacterBody2D

[CharacterBody2D](../../classes/class_characterbody2d.md#class_CharacterBody2D) bodies detect collisions with
...
[KinematicCollision2D](../../classes/class_kinematiccollision2d.md#class_KinematicCollision2D) object, which contains
...
> **Warning:** calculation, so you should **not** multiply the velocity vector by ``delta``. This does **not** apply to ``gravity`` as it is an acceleration and is time dependent, and needs to be scaled by ``delta``.
...
See [doc_kinematic_character_2d](kinematic_character_2d.md#doc_kinematic_character_2d) for more details on using `move_and_slide()`,
