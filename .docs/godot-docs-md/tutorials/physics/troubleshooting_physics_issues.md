<span id="doc_troubleshooting_physics_issues"></span>
...
can also improve stability. See [doc_using_jolt_physics](using_jolt_physics.md#doc_using_jolt_physics) for more information.
...
See [doc_using_jolt_physics](using_jolt_physics.md#doc_using_jolt_physics) for more information.
...
In 3D, switching the physics engine from the default GodotPhysics to Jolt
can also improve performance. See [doc_using_jolt_physics](using_jolt_physics.md#doc_using_jolt_physics) for more information.
...
from the world origin. See [doc_large_world_coordinates](large_world_coordinates.md#doc_large_world_coordinates) for more
information.
