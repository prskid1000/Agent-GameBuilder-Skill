<span id="doc_using_area_2d"></span>
...
[Area2D](../../classes/class_area2d.md#class_Area2D) node and show some examples of how it can be used.

> **Note:** bodies. Please read :ref:`doc_physics_introduction` first.
### What is an area?

An Area2D defines a region of 2D space. In this space you can detect other
[CollisionObject2D](../../classes/class_collisionobject2d.md#class_CollisionObject2D) nodes overlapping, entering,
...
Note that Area2D extends [CollisionObject2D](../../classes/class_collisionobject2d.md#class_CollisionObject2D), so it
...
See the [doc_your_first_2d_game](../../getting_started/first_2d_game/index.md#doc_your_first_2d_game) for an example of using Area2D in a game.
