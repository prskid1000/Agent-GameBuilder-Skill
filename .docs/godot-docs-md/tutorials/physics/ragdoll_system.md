<span id="doc_ragdoll_system"></span>
...
- A [PhysicalBoneSimulator3D](../../classes/class_physicalbonesimulator3d.md#class_PhysicalBoneSimulator3D) node.
  This node is the parent of all physical bones and is responsible
  for controlling the simulation.
- One or more [PhysicalBone3D](../../classes/class_physicalbone3d.md#class_PhysicalBone3D) children.
...
[PhysicalBoneSimulator3D.physical_bones_start_simulation()](../../classes/class_physicalbonesimulator3d.md#class_PhysicalBoneSimulator3D_method_physical_bones_start_simulation)
method. Attach a script to the [PhysicalBoneSimulator3D](../../classes/class_physicalbonesimulator3d.md#class_PhysicalBoneSimulator3D) node
...
[PhysicalBoneSimulator3D.physical_bones_stop_simulation()](../../classes/class_physicalbonesimulator3d.md#class_PhysicalBoneSimulator3D_method_physical_bones_stop_simulation)
method.
...
.. tip::
    ...
    [PhysicalBoneSimulator3D](../../classes/class_physicalbonesimulator3d.md#class_PhysicalBoneSimulator3D) node that is the
...
using the [physical_bones_add_collision_exception()](../../classes/class_physicalbonesimulator3d.md#class_PhysicalBoneSimulator3D_method_physical_bones_add_collision_exception)
and [physical_bones_remove_collision_exception()](../../classes/class_physicalbonesimulator3d.md#class_PhysicalBoneSimulator3D_method_physical_bones_remove_collision_exception)
methods. This can be used to prevent collisions with a specific object
without relying on layers and masks.

.. seealso::

    For more information, see [doc_physics_introduction_collision_layers_and_masks](physics_introduction.md#doc_physics_introduction_collision_layers_and_masks).
