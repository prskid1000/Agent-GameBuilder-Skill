<span id="doc_using_character_body_2d"></span>
...
[CharacterBody2D](../../classes/class_characterbody2d.md#class_CharacterBody2D) node and show some examples
of how to use it.

> **Note:** concepts apply in 3D as well.
...
> **Note:** bodies. Please read :ref:`doc_physics_introduction` first, for an overview of the physics options.
...
This method takes one required parameter: a [Vector2](../../classes/class_vector2.md#class_Vector2) indicating
...
method will return a [KinematicCollision2D](../../classes/class_kinematiccollision2d.md#class_KinematicCollision2D) object.
...
specific circumstances. See the [CharacterBody2D](../../classes/class_characterbody2d.md#class_CharacterBody2D) docs
for full details.
...
> **Note:** 
See [KinematicCollision2D](../../classes/class_kinematiccollision2d.md#class_KinematicCollision2D) for details on what
...
some obstacles. Add a [StaticBody2D](../../classes/class_staticbody2d.md#class_StaticBody2D) with a
...
[Polygon2D](../../classes/class_polygon2d.md#class_Polygon2D) to create the platform shapes.
