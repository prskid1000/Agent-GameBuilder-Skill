...
In order to define the shape of the body, it must have one or more [Shape3D](../../classes/class_shape3d.md#class_Shape3D) objects assigned. Note that setting the position of these shapes will affect the body's center of mass.
...
See [RigidBody3D](../../classes/class_rigidbody3d.md#class_RigidBody3D) and [PhysicsMaterial](../../classes/class_physicsmaterial.md#class_PhysicsMaterial) for
...
This method can be used with `axis_lock_angular_*` as well. If more precise control is needed, solutions such as ones relying on [class_Quaternion](../../classes/class_quaternion.md#class_Quaternion) may be required,
as discussed in [doc_using_transforms](../3d/using_transforms.md#doc_using_transforms).
