...
[RayCast3D](../../classes/class_raycast3d.md#class_RayCast3D) and [RayCast2D](../../classes/class_raycast2d.md#class_RayCast2D)
...
[CanvasItem.get_world_2d().space](../../classes/class_canvasitem.md#class_CanvasItem_method_get_world_2d).
For 3D, it's [Node3D.get_world_3d().space](../../classes/class_node3d.md#class_Node3D_method_get_world_3d).

The resulting space [RID](../../classes/class_rid.md#class_RID) can be used in
[PhysicsServer3D](../../classes/class_physicsserver3d.md#class_PhysicsServer3D) and
[PhysicsServer2D](../../classes/class_physicsserver2d.md#class_PhysicsServer2D) respectively for 3D and 2D.
...
[Node._physics_process()](../../classes/class_node.md#class_Node_private_method__physics_process)
callback. Accessing it from outside this function may result in an error
due to space being *locked*.

To perform queries into physics space, the
[PhysicsDirectSpaceState2D](../../classes/class_physicsdirectspacestate2d.md#class_PhysicsDirectSpaceState2D)
and [PhysicsDirectSpaceState3D](../../classes/class_physicsdirectspacestate3d.md#class_PhysicsDirectSpaceState3D)
must be used.
...
[PhysicsDirectSpaceState2D.intersect_ray()](../../classes/class_physicsdirectspacestate2d.md#class_PhysicsDirectSpaceState2D_method_intersect_ray)
...
![](img/raycast_falsepositive.webp)
...
See [doc_physics_introduction_collision_layer_code_example](physics_introduction.md#doc_physics_introduction_collision_layer_code_example) for details on how to set the collision mask.

### 3D ray casting from screen

Casting a ray from screen to 3D physics space is useful for object
picking. There is not much need to do this because
[CollisionObject3D](../../classes/class_collisionobject3d.md#class_CollisionObject3D)
has an "input_event" signal that will let you know when it was clicked,
but in case there is any desire to do it manually, here's how.

To cast a ray from the screen, you need a [Camera3D](../../classes/class_camera3d.md#class_Camera3D)
