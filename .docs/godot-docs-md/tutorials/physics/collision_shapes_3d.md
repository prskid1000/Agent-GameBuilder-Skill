<span id="doc_collision_shapes_3d"></span>
...
You can define the shape of a [class_PhysicsBody3D](../../classes/class_physicsbody3d.md#class_PhysicsBody3D) by adding one or more
[CollisionShape3Ds](../../classes/class_collisionshape3d.md#class_CollisionShape3D) as *direct* child nodes.
Indirect child nodes (i.e. children of child nodes) will be ignored and won't be
used as collision shapes. Also, note that you must add a [class_Shape3D](../../classes/class_shape3d.md#class_Shape3D)
...
- [class_BoxShape3D](../../classes/class_boxshape3d.md#class_BoxShape3D)
- [class_SphereShape3D](../../classes/class_sphereshape3d.md#class_SphereShape3D)
- [class_CapsuleShape3D](../../classes/class_capsuleshape3d.md#class_CapsuleShape3D)
- [class_CylinderShape3D](../../classes/class_cylindershape3d.md#class_CylinderShape3D)
...
[Convex collision shapes](../../classes/class_convexpolygonshape3d.md#class_ConvexPolygonShape3D) are a compromise
...
[Concave collision shapes](../../classes/class_concavepolygonshape3d.md#class_ConcavePolygonShape3D), also called trimesh
...
.. seealso::
    ...
    See [doc_importing_3d_scenes](../assets_pipeline/importing_3d_scenes/index.md#doc_importing_3d_scenes) for information on how to export models
