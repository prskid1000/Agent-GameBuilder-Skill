<span id="doc_custom_mouse_cursor"></span>
...
![](img/cursor_project_settings.webp)
...
.. seealso::
    ...
    Check [Input.set_custom_mouse_cursor()](../../classes/class_input.md#class_Input_method_set_custom_mouse_cursor)'s
...
[Input.CursorShape](../../classes/class_input.md#enum_Input_CursorShape) enum. Which ones you want to use
