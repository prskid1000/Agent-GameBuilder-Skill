<span id="doc_controller_features"></span>
...
Use the method [Input.set_joy_light()](../../classes/class_input.md#class_Input_method_set_joy_light) to set the color
of a given controller's LEDs.

To determine if a given controller supports setting LED lights, use the [Input.has_joy_light()](../../classes/class_input.md#class_Input_method_has_joy_light)
