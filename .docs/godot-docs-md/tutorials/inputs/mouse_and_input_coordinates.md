<span id="doc_mouse_and_input_coordinates"></span>
...
several options (see [doc_multiple_resolutions](../rendering/multiple_resolutions.md#doc_multiple_resolutions) tutorial). Use, then, the
