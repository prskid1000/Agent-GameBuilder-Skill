<span id="doc_handling_quit_requests"></span>
...
On desktop and web platforms, [Node](../../classes/class_node.md#class_Node) receives a special
...
[SceneTree.quit](../../classes/class_scenetree.md#class_SceneTree_method_quit), doing so will not send
the `NOTIFICATION_WM_CLOSE_REQUEST` to the nodes in the scene tree.
Quitting by calling [SceneTree.quit](../../classes/class_scenetree.md#class_SceneTree_method_quit) will
...
the previous behavior, [SceneTree.quit](../../classes/class_scenetree.md#class_SceneTree_method_quit) should
