<span id="doc_navigation_overview_2d"></span>
...
- [Astar2D](../../classes/class_astar2d.md#class_Astar2D)
...
- [AstarGrid2D](../../classes/class_astargrid2d.md#class_AstarGrid2D)
...
- [NavigationServer2D](../../classes/class_navigationserver2d.md#class_NavigationServer2D)
...
- [NavigationRegion2D](../../classes/class_navigationregion2d.md#class_NavigationRegion2D) Node
...
- [NavigationLink2D](../../classes/class_navigationlink2d.md#class_NavigationLink2D) Node
...
-  [NavigationAgent2D](../../classes/class_navigationagent2d.md#class_NavigationAgent2D) Node
...
-  [NavigationObstacle2D](../../classes/class_navigationobstacle2d.md#class_NavigationObstacle2D) Node
...
- [NavigationPolygon](../../classes/class_navigationpolygon.md#class_NavigationPolygon) Resource
...
> **Note:** The navigation mesh defines the area where an actor can stand and move with its center. Leave enough margin between the navigation polygon edges and collision objects to not get path following actors repeatedly stuck on collision.
