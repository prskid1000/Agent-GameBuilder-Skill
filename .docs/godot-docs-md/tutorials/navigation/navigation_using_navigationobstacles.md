<span id="doc_navigation_using_navigationobstacles"></span>

## Using NavigationObstacles

2D and 3D versions of NavigationObstacles nodes are available as
[NavigationObstacle2D](../../classes/class_navigationobstacle2d.md#class_NavigationObstacle2D) and
[NavigationObstacle3D](../../classes/class_navigationobstacle3d.md#class_NavigationObstacle3D)  respectively.
...
For more details on the navigation mesh baking see [doc_navigation_using_navigationmeshes](navigation_using_navigationmeshes.md#doc_navigation_using_navigationmeshes).

![](img/nav_mesh_obstacles_properties.webp)
