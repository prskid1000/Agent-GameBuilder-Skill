<span id="doc_navigation_different_actor_area_access"></span>
...
See [doc_navigation_advanced_using_navigationlayers](navigation_using_navigationlayers.md#doc_navigation_advanced_using_navigationlayers) for more information on how to work with navigation layers and the bitmask.
