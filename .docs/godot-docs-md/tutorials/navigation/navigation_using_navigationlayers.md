<span id="doc_navigation_advanced_using_navigationlayers"></span>
...
See [doc_navigation_using_navigationpaths](navigation_using_navigationpaths.md#doc_navigation_using_navigationpaths) for more information on querying the NavigationServer for paths.
