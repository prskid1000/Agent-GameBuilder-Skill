<span id="doc_navigation_using_navigationpaths"></span>
...
For more customizable navigation path queries that require additional setup see [doc_navigation_using_navigationpathqueryobjects](navigation_using_navigationpathqueryobjects.md#doc_navigation_using_navigationpathqueryobjects).
