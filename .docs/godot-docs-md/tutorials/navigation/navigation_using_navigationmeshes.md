<span id="doc_navigation_using_navigationmeshes"></span>
...
[NavigationPolygon](../../classes/class_navigationpolygon.md#class_NavigationPolygon) and
[NavigationMesh](../../classes/class_navigationmesh.md#class_NavigationMesh)  respectively.
...
<span id="doc_navigation_navmesh_baking"></span>

Navigation mesh baking can be done either by using a [NavigationRegion2D](../../classes/class_navigationregion2d.md#class_NavigationRegion2D) or [NavigationRegion3D](../../classes/class_navigationregion3d.md#class_NavigationRegion3D), or by using the
[NavigationServer2D](../../classes/class_navigationserver2d.md#class_NavigationServer2D) and [NavigationServer3D](../../classes/class_navigationserver3d.md#class_NavigationServer3D) API directly.

<span id="doc_navigation_using_navigationmeshes_baking_navigation_mesh_with_navigationregion"></span>
...
The nodes are available in 2D and 3D as [NavigationRegion2D](../../classes/class_navigationregion2d.md#class_NavigationRegion2D) and [NavigationRegion3D](../../classes/class_navigationregion3d.md#class_NavigationRegion3D) respectively.
...
![](img/nav_region_baking_01.webp)

        In order for the region to work a [NavigationPolygon](../../classes/class_navigationpolygon.md#class_NavigationPolygon) resource needs to be added.
...
![](img/nav_region_baking_02.webp)

        The result of the source geometry parsing can be influenced with the following properties.

        - The `parsed_geometry_type` that filters if visual objects or physics objects or both should be parsed from the [SceneTree](../../classes/class_scenetree.md#class_SceneTree).
        ...
        - The `source_geometry_mode` that defines on which node(s) to start the parsing, and how to traverse the [SceneTree](../../classes/class_scenetree.md#class_SceneTree).
...
```
        ...
        - Add a [NavigationRegion2D](../../classes/class_navigationregion2d.md#class_NavigationRegion2D).
        - Add a [NavigationPolygon](../../classes/class_navigationpolygon.md#class_NavigationPolygon) resource to the NavigationRegion2D.
        - Add a [Polygon2D](../../classes/class_polygon2d.md#class_Polygon2D) below the NavigationRegion2D.
...
![](img/nav_mesh_bake_toolbar.webp)

        In order for the region to work a [NavigationMesh](../../classes/class_navigationmesh.md#class_NavigationMesh) resource needs to be added.

        The properties to parse and bake a navigation mesh are then part of the used resource and can be found in the resource Inspector.

![](img/nav_region3d_baking_01.webp)
...
> **Warning:** A too small ``cell_size`` or ``cell_height`` can create so many voxels that it has the potential to freeze the game or even crash. The NavigationRegion3D baking can also be used at runtime with scripts. .. tabs:: .. code-tab:: gdscript GDScript var on_thread: bool = true bake_navigation_mesh(on_thread) .. code-tab:: csharp bool onThread = true; BakeNavigationMesh(onThread); To quickly test the 3D baking with default settings: - Add a :ref:`NavigationRegion3D<class_NavigationRegion3D>`. - Add a :ref:`NavigationMesh<class_NavigationMesh>` resource to the NavigationRegion3D. - Add a :ref:`MeshInstance3D<class_MeshInstance3D>` below the NavigationRegion3D. - Add a :ref:`PlaneMesh<class_PlaneMesh>` to the MeshInstance3D. - Hit the Editor bake button and a navigation mesh should appear. .. image:: img/nav_mesh_bake_toolbar.webp .. image:: img/nav_mesh_mini_3d.webp
<span id="doc_navigation_using_navigationmeshes_baking_navigation_mesh_with_navigationserver"></span>

### Baking a navigation mesh with the NavigationServer

The [NavigationServer2D](../../classes/class_navigationserver2d.md#class_NavigationServer2D) and [NavigationServer3D](../../classes/class_navigationserver3d.md#class_NavigationServer3D) have API functions to call each step of the navigation mesh baking process individually.
...
[NavigationMeshSourceGeometryData2D](../../classes/class_navigationmeshsourcegeometrydata2d.md#class_NavigationMeshSourceGeometryData2D) and
[NavigationMeshSourceGeometryData3D](../../classes/class_navigationmeshsourcegeometrydata3d.md#class_NavigationMeshSourceGeometryData3D)  respectively.
...
The baking bound, which is an axis-aligned [Rect2](../../classes/class_rect2.md#class_Rect2) for 2D and [AABB](../../classes/class_aabb.md#class_AABB) for 3D,
limits the used source geometry by discarding all the geometry that is outside of the bounds.

The [NavigationPolygon](../../classes/class_navigationpolygon.md#class_NavigationPolygon) properties `baking_rect` and `baking_rect_offset`
can be used to create and place the 2D baking bound.

The [NavigationMesh](../../classes/class_navigationmesh.md#class_NavigationMesh) properties `filter_baking_aabb` and `filter_baking_aabb_offset`
...
- Navigation mesh appears inside geometry in 3D.
    ...
    A [NavigationObstacle3D](../../classes/class_navigationobstacle3d.md#class_NavigationObstacle3D) shape set to bake with navigation mesh can be used to discard geometry as well.
