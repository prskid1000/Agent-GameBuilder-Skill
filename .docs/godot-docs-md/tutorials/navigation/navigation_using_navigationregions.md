<span id="doc_navigation_using_navigationregions"></span>
...
Both 2D and 3D version are available as [NavigationRegion2D](../../classes/class_navigationregion2d.md#class_NavigationRegion2D)
and [NavigationRegion3D](../../classes/class_navigationregion3d.md#class_NavigationRegion3D) respectively.
...
All regions require a navigation mesh resource to function. See [doc_navigation_using_navigationmeshes](navigation_using_navigationmeshes.md#doc_navigation_using_navigationmeshes) to learn how to create and apply navigation meshes.
...
The NavigationServer will attempt to connect the navigation meshes of individual regions when they are close enough. For more details see [doc_navigation_connecting_navmesh](navigation_connecting_navmesh.md#doc_navigation_connecting_navmesh).
To connect NavigationRegions over arbitrary distances see [doc_navigation_using_navigationlinks](navigation_using_navigationlinks.md#doc_navigation_using_navigationlinks) to learn how to create and use `NavigationLinks`.
