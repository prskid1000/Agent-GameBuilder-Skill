<span id="doc_navigation_using_navigationlinks"></span>

## Using NavigationLinks

![](img/nav_navmesh_links.png)

NavigationLinks are used to connect navigation mesh polygons from [NavigationRegion2D](../../classes/class_navigationregion2d.md#class_NavigationRegion2D)
and [NavigationRegion3D](../../classes/class_navigationregion3d.md#class_NavigationRegion3D) over arbitrary distances for pathfinding.
...
[NavigationLink2D](../../classes/class_navigationlink2d.md#class_NavigationLink2D) and
[NavigationLink3D](../../classes/class_navigationlink3d.md#class_NavigationLink3D) respectively.
...
See [doc_navigation_using_navigationregions](navigation_using_navigationregions.md#doc_navigation_using_navigationregions) to learn more about the use of navigation regions.
See [doc_navigation_connecting_navmesh](navigation_connecting_navmesh.md#doc_navigation_connecting_navmesh) to learn more about how to connect navigation meshes.
...
![](img/nav_link_debug_visuals.webp)

The link debug visuals can be changed in the Editor [ProjectSettings](../../classes/class_projectsettings.md#class_ProjectSettings) under `debug/shapes/navigation`.
