<span id="doc_navigation_using_navigationagents"></span>
...
[NavigationAgent2D](../../classes/class_navigationagent2d.md#class_NavigationAgent2D) and
[NavigationAgent3D](../../classes/class_navigationagent3d.md#class_NavigationAgent3D) respectively.

New NavigationAgent nodes will automatically join the default navigation map on the [World2D](../../classes/class_world2d.md#class_World2D)/[World3D](../../classes/class_world3d.md#class_World3D).
...
.. tip::
    ...
    For more advanced uses consider [doc_navigation_using_navigationpathqueryobjects](navigation_using_navigationpathqueryobjects.md#doc_navigation_using_navigationpathqueryobjects) over NavigationAgent nodes.
...
NavigationObstacles can be used to add some environment constrains to the avoidance simulation, see [doc_navigation_using_navigationobstacles](navigation_using_navigationobstacles.md#doc_navigation_using_navigationobstacles).
