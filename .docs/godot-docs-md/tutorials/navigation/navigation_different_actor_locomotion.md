<span id="doc_navigation_different_actor_locomotion"></span>
...
map setup as supporting [doc_navigation_different_actor_types](navigation_different_actor_types.md#doc_navigation_different_actor_types) is required.
