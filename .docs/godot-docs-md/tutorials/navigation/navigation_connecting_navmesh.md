<span id="doc_navigation_connecting_navmesh"></span>
...
To connect over arbitrary distances see [doc_navigation_using_navigationlinks](navigation_using_navigationlinks.md#doc_navigation_using_navigationlinks).
...
See [doc_navigation_debug_tools](navigation_debug_tools.md#doc_navigation_debug_tools) for more info about navigation debug options.
