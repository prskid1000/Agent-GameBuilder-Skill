<span id="doc_navigation_using_navigationpathqueryobjects"></span>
...
[NavigationPathQueryParameters2D](../../classes/class_navigationpathqueryparameters2d.md#class_NavigationPathQueryParameters2D) and
[NavigationPathQueryParameters3D](../../classes/class_navigationpathqueryparameters3d.md#class_NavigationPathQueryParameters3D) respectively.

2D and 3D versions of `NavigationPathQueryResult` are available as
[NavigationPathQueryResult2D](../../classes/class_navigationpathqueryresult2d.md#class_NavigationPathQueryResult2D) and
[NavigationPathQueryResult3D](../../classes/class_navigationpathqueryresult3d.md#class_NavigationPathQueryResult3D) respectively.
...
- The `PATH_METADATA_INCLUDE_RIDS` flag collects an array with the [RIDs](../../classes/class_rid.md#class_RID) of the point owners. Depending on point owner primitive, these RIDs can be used with the various NavigationServer functions related to regions or links.
...
- If a region [RID](../../classes/class_rid.md#class_RID) is added to the `excluded_regions` array the region's navigation mesh will be ignored in the path search.
- If a region [RID](../../classes/class_rid.md#class_RID) is added to the `included_regions` array the region's navigation mesh will be considered in the path search and also all other regions not included will be ignored as well.
