<span id="doc_external_editor"></span>

## Using an external text editor

This page explains how to code using an external text editor.

> **Note:** To code C# in an external editor, see :ref:`the C# guide to configure an external editor <doc_c_sharp_setup_external_editor>`.
...
For details, see [Script editor debug tools and options](../scripting/debug/overview_of_debugging_tools.md#doc_debugger_tools_and_options).
