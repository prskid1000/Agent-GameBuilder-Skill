...
<span id="doc_managing_editor_features"></span>
...
information on how to optimize Godot see [doc_performance](../performance/index.md#doc_performance).
...
See [doc_data_paths_self_contained_mode](../io/data_paths.md#doc_data_paths_self_contained_mode) for details.
