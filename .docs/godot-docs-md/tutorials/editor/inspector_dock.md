<span id="doc_editor_inspector_dock"></span>
...
![](img/inspector_top_buttons.webp)
...
![](img/inspector_dock_overlay.webp)
...
![](img/inspector_dock_subresource.webp)
...
.. tip:: If a node has exported variables in its attached script, you will also see these
  ...
  `Action Suffix`. See [doc_gdscript_exports](../scripting/gdscript/gdscript_exports.md#doc_gdscript_exports) for more on this topic.

.. seealso:: Refer to [doc_customizing_editor](customizing_editor.md#doc_customizing_editor) for dock customization options.
