<span id="doc_engine_compilation_configuration_editor"></span>
...
with certain features disabled. This is described in detail in [doc_optimizing_for_size](../../engine_details/development/compiling/optimizing_for_size.md#doc_optimizing_for_size).
...
This file can be passed as a SCons option when [compiling](../../engine_details/development/compiling/index.md#doc_compiling_index)
export templates:
...
- Features that are used in [expressions](../scripting/evaluating_expressions.md#doc_evaluating_expressions).
- Features that are used in [GDExtensions](../scripting/gdextension/index.md#doc_gdextension), unless the language binding
  allows for defining used classes and the extension makes use of the functionality.
  See GH-104129 for details.
- Features that are used in [external PCKs loaded at runtime](../export/exporting_pcks.md#doc_exporting_pcks).
...
.. seealso::
    ...
    See [doc_optimizing_for_size](../../engine_details/development/compiling/optimizing_for_size.md#doc_optimizing_for_size) for more information.
