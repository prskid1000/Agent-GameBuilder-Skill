...
<span id="doc_using_the_web_editor"></span>
...
> **Note:** The web editor is in a preliminary stage. While its feature set may be sufficient for educational purposes, it is currently **not recommended for production work**. See :ref:`doc_using_the_web_editor_limitations` below.
### Browser support
...
See [doc_system_requirements](../../about/system_requirements.md#doc_system_requirements) for a list of supported web browsers.
...
<span id="doc_using_the_web_editor_limitations"></span>
