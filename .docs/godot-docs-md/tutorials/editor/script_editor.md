<span id="doc_script_editor"></span>

## Script Editor

<span id="doc_script_editor_introduction"></span>
...
[doc_intro_to_the_editor_interface_integrated_class_reference](../../getting_started/introduction/first_look_at_the_editor.md#doc_intro_to_the_editor_interface_integrated_class_reference).

![](img/script_editor_icons/text_editor.webp)

<span id="doc_script_editor_features"></span>
...
<span id="doc_script_editor_usage"></span>
...
> **Note:** 
  in your project, see [doc_external_editor](external_editor.md#doc_external_editor) and
  [doc_c_sharp_setup_external_editor](../scripting/c_sharp/c_sharp_basics.md#doc_c_sharp_setup_external_editor).
...
![](img/editor_ui_script_editor_open.webp)
...
![](img/editor_ui_script_editor_menu.webp)
...
For a complete shortcut list, see the [text editor shortcuts](default_key_mapping.md#doc_default_key_mapping_shortcuts_text_editor).
...
<span id="doc_script_editor_script_panel"></span>
...
![](img/editor_ui_script_editor_script_panel.webp)
...
script (See [tool annotation](../plugins/running_code_in_the_editor.md#doc_running_code_in_the_editor) for more on this).
...
<span id="doc_script_editor_menus"></span>
...
![](img/script_editor_icons/text_editor_menu.webp)

The **File** menu provides the following options:

![](img/script_editor_icons/text_editor_file_menu.webp)
...
- **Soft Reload Tool Script**: If the selected script is a
  [tool](../plugins/running_code_in_the_editor.md#doc_running_code_in_the_editor), reloads the script to execute it again.
...
- **Close Docs**: Closes the class reference documentation pages, leaving only the
  scripts.
- **Run**: If the script extends [EditorScript](../../classes/class_editorscript.md#class_EditorScript) and
  intended to be executed without running the project, this option runs the script.
  See [doc_running_code_in_the_editor_editorscript](../plugins/running_code_in_the_editor.md#doc_running_code_in_the_editor_editorscript) for more.
- **Toggle Scripts Panel**: Shows or hides the script panel located on the left side
  ...
  `Scripts Panel` is explained [above](script_editor.md#doc_script_editor_script_panel).

The **Edit** menu provides several options for line operations:

![](img/script_editor_icons/text_editor_edit_menu.webp)
...
- **Folding**: Provides a set of folding options for the selected text. Depending on the
  ...
  - **Create Code Region***: Wraps the selected text in a foldable code region to improve
    the readability of larger scripts. See [doc_gdscript_builtin_types](../scripting/gdscript/gdscript_basics.md#doc_gdscript_builtin_types) for more.
...
![](img/script_editor_icons/text_editor_search_menu.webp)
...
![](img/editor_ui_script_editor_replaceinfiles.webp)
...
![](img/editor_ui_script_editor_replace_all.webp)
...
![](img/script_editor_icons/text_editor_goto_menu.webp)
...
[doc_debugger_tools_and_options](../scripting/debug/overview_of_debugging_tools.md#doc_debugger_tools_and_options) for more.

<span id="doc_script_editor_coding_area"></span>

Coding area
~~~~~~~~~~~

> **Note:** 
  interface. To learn more about scripting in Godot, refer to the [doc_gdscript](../scripting/gdscript/index.md#doc_gdscript) or
  Scripting documentation.

![](img/editor_ui_script_editor_coding_area.webp)
...
icon indicates that this function is an [override](../scripting/overridable_functions.md#doc_overridable_functions) of an existing
...
Line 55 is a breakpoint that can be used in [debugging](../scripting/debug/overview_of_debugging_tools.md#doc_overview_of_debugging_tools).

![](img/script_editor_icons/text_editor_coding_area_indicators.webp)
