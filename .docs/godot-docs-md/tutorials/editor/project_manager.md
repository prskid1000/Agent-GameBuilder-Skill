<span id="doc_project_manager"></span>
...
![](img/editor_ui_intro_project_manager_01.webp)

To change the editors language click on the **Settings** Button in the top right
corner:

![](img/editor_ui_intro_project_manager_02.webp)
...
![](img/editor_ui_intro_project_manager_10.webp)

<span id="doc_creating_and_importing_projects"></span>
...
![](img/editor_ui_intro_project_manager_04.webp)

> **Note:** `git <https://git-scm.com>`__ is supported and it needs the Godot Git Plugin to be installed, either manually or using the :ref:`Asset Library <doc_using_assetlib>`. To learn more about the Godot Git Plugin, see its `wiki <https://github.com/godotengine/godot-git-plugin/wiki>`__.
...
![](img/editor_ui_intro_project_manager_05.webp)
...
![](img/editor_ui_intro_project_manager_06.webp)
...
![](img/editor_ui_intro_project_manager_08.webp)

Alternatively, it is possible to choose a zip file to be automatically extracted by Godot.

When the folder path is correct, you'll see a green checkmark.

![](img/editor_ui_intro_project_manager_09.webp)

<span id="doc_project_manager_downloading_demos"></span>
...
![](img/editor_ui_intro_project_manager_03.webp)
...
![](img/editor_ui_intro_project_manager_11.webp)

This will open up the manage project tags window. To add a tag click the plus button.

![](img/editor_ui_intro_project_manager_12.webp)
...
![](img/editor_ui_intro_project_manager_13.webp)
