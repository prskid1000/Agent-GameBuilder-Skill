<span id="doc_customizing_editor"></span>
...
<span id="doc_customizing_editor_moving_docks"></span>
...
the configuration path of the [doc_data_paths_editor_data_paths](../io/data_paths.md#doc_data_paths_editor_data_paths).
...
See the [class_EditorSettings](../../classes/class_editorsettings.md#class_EditorSettings) class reference for a complete description
