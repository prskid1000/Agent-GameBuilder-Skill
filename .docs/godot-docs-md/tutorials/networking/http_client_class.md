...
<span id="doc_http_client_class"></span>

## HTTP client class

[HTTPClient](../../classes/class_httpclient.md#class_HTTPClient) provides low-level access to HTTP communication.
For a higher-level interface, you may want to take a look at [HTTPRequest](../../classes/class_httprequest.md#class_HTTPRequest) first,
which has a tutorial available [here](http_request_class.md#doc_http_request_class).
...
Here's an example of using the [HTTPClient](../../classes/class_httpclient.md#class_HTTPClient)
