<span id="doc_ssl_certificates"></span>
...
[StreamPeerTLS](../../classes/class_streampeertls.md#class_StreamPeerTLS), which can take a regular connection
and add security around it. The [HTTPClient](../../classes/class_httpclient.md#class_HTTPClient) and
[HTTPRequest](../../classes/class_httprequest.md#class_HTTPRequest) classes also support HTTPS using
this same wrapper.
...
> **Warning:** When specifying a self-signed certificate as TLS bundle in the project settings, normal domain name validation is enforced via the certificate :abbr:`CN (common name)` and alternative names. See :ref:`TLSOptions <class_TLSOptions>` to customize domain name validation.
