...
WebRTC is implemented in Godot via two main classes [WebRTCPeerConnection](../../classes/class_webrtcpeerconnection.md#class_WebRTCPeerConnection) and [WebRTCDataChannel](../../classes/class_webrtcdatachannel.md#class_WebRTCDataChannel), plus the multiplayer API implementation [WebRTCMultiplayerPeer](../../classes/class_webrtcmultiplayerpeer.md#class_WebRTCMultiplayerPeer). See section on [high-level multiplayer](high_level_multiplayer.md#doc_high_level_multiplayer) for more details.
...
This example expands on the previous one, separating the peers in two different scenes, and using a [singleton](../scripting/singletons_autoload.md#doc_singletons_autoload) as a signaling server.
...
A more advanced demo using WebSocket for signaling peers and [WebRTCMultiplayerPeer](../../classes/class_webrtcmultiplayerpeer.md#class_WebRTCMultiplayerPeer) is available in the godot demo projects under `networking/webrtc_signaling`.
