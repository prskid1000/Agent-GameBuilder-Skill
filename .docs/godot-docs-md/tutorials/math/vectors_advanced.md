<span id="doc_vectors_advanced"></span>
...
For 3D math, Godot provides a [Plane](../../classes/class_plane.md#class_Plane)
...
Godot also implements this operator in [Plane](../../classes/class_plane.md#class_Plane).
