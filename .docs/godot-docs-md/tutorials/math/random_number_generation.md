<span id="doc_random_number_generation"></span>
...
> **Note:** Computers cannot generate "true" random numbers. Instead, they rely on `pseudorandom number generators <https://en.wikipedia.org/wiki/Pseudorandom_number_generator>`__ (PRNGs). Godot internally uses the `PCG Family <https://www.pcg-random.org/>`__ of pseudorandom number generators.
### Global scope versus RandomNumberGenerator class

Godot exposes two ways to generate random numbers: via *global scope* methods or
using the [class_RandomNumberGenerator](../../classes/class_randomnumbergenerator.md#class_RandomNumberGenerator) class.
...
[doc_random_number_generation_weighted_random_probability](random_number_generation.md#doc_random_number_generation_weighted_random_probability) system, among
other things.
...
or use the [Array.pick_random](../../classes/class_array.md#class_Array_method_pick_random) method
to do it for us:
...
[Array.pick_random](../../classes/class_array.md#class_Array_method_pick_random) since it lacks a way to
prevent repetition:
...
<span id="doc_random_number_generation_weighted_random_probability"></span>
...
[rand_weighted()](../../classes/class_randomnumbergenerator.md#class_RandomNumberGenerator_method_rand_weighted) method
...
<span id="doc_random_number_generation_shuffle_bags"></span>
...
terrain. Godot provides [class_fastnoiselite](../../classes/class_fastnoiselite.md#class_fastnoiselite) for this, which supports
...
Godot offers a [class_Crypto](../../classes/class_crypto.md#class_Crypto) class for this. This class can perform
...
self-signed [class_X509Certificate](../../classes/class_x509certificate.md#class_X509Certificate) s.
...
.. seealso::
    ...
    See [class_PackedByteArray](../../classes/class_packedbytearray.md#class_PackedByteArray)'s documentation for other methods you can
