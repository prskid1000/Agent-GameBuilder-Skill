<span id="doc_standard_material_3d"></span>
...
does not include light surrounding geometry unless [VoxelGI](global_illumination/using_voxel_gi.md#doc_using_voxel_gi)
or [SDFGI](global_illumination/using_sdfgi.md#doc_using_sdfgi) are used). This value is added to the resulting
...
![](img/spatial_material_bentnormals.webp)
...
for physics collision (such as terrain), see [class_HeightMapShape3D](../../classes/class_heightmapshape3d.md#class_HeightMapShape3D). It
...
> **Note:** Refraction is implemented as a screen-space effect and forces the material to be transparent. This makes the effect relatively fast, but this results in some limitations: - :ref:`Transparency sorting <doc_3d_rendering_limitations_transparency_sorting>` issues may occur. - The refractive material cannot refract onto itself, or onto other transparent materials. A refractive material behind another transparent material will be invisible. - Off-screen objects cannot appear in the refraction. This is most noticeable with high refraction strength values. - Opaque materials in front of the refractive material will appear to have "refracted" edges, even though they shouldn't.
### Detail
...
<span id="doc_standard_material_3d_triplanar_mapping"></span>
...
<span id="doc_standard_material_3d_sampling"></span>
...
The filtering method for the textures used by the material. See [this page](../../classes/class_basematerial3d.md#class_BaseMaterial3D_property_texture_filter)
for a full list of options and their description.

Repeat
~~~~~~

if the textures used by the material repeat, and how they repeat. See [this page](../../classes/class_basematerial3d.md#class_BaseMaterial3D_property_texture_repeat)
for a full list of options and their description.
...
* **Particle Billboard:** Most suited for particle systems, because it allows
  specifying [flipbook animation](particles/process_material_properties.md#doc_process_material_properties_animation).

![](img/spatial_material9.webp)
...
<span id="ref_standard_material_3d_grow"></span>
...
using the **Outline** [stencil mode](standard_material_3d.md#doc_standard_material_3d_stencil).
...
Objects are sorted by an opaque/transparent queue, then [render_priority](../../classes/class_material.md#class_Material_property_render_priority),
...
Setting [next_pass](../../classes/class_material.md#class_Material_property_next_pass) on a material
will cause an object to be rendered again with that next material.

Materials are sorted by an opaque/transparent queue, then [render_priority](../../classes/class_material.md#class_Material_property_render_priority),
...
Multiple transparent passes should use [render_priority](../../classes/class_material.md#class_Material_property_render_priority) to ensure correct ordering.
