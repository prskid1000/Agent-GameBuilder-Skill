<span id="doc_reflection_probes"></span>

## Reflection probes

As stated in the [doc_standard_material_3d](../standard_material_3d.md#doc_standard_material_3d), objects can show reflected and/or
...
more accurate reflections than [VoxelGI](using_voxel_gi.md#doc_using_voxel_gi) and
[SDFGI](using_sdfgi.md#doc_using_sdfgi) while being fairly cheap on system resources.
...
- Add a [class_ReflectionProbe](../../../classes/class_reflectionprobe.md#class_ReflectionProbe) node.
...
- **Enable Shadows:** Controls whether real-time light shadows should be
  ...
  reflections with shadows every frame. Fully [baked light](using_lightmap_gi.md#doc_using_lightmap_gi)
...
[reflection probe](reflection_probes.md#doc_reflection_probes). This limit can be increased by adjusting
