<span id="doc_introduction_to_global_illumination"></span>
...
![](img/global_illumination_example.webp)
...
can be enabled in the [environment](../environment_and_post_processing.md#doc_environment_and_post_processing) settings.
SSR has a significant performance cost (even more so than SSAO), so make sure to disable
it when targeting low-end hardware.

<span id="doc_introduction_to_global_illumination_comparison"></span>
...
- **LightmapGI:** |bad| Baked, and therefore not real-time.
  ...
  - Both indirect lighting and SH reflections are baked and can't be changed at
    ...
    [simulated via other means](faking_global_illumination.md#doc_faking_global_illumination),
...
- For desktop games, it's a good idea to start with [SDFGI](using_sdfgi.md#doc_using_sdfgi)
...
- For mobile games, [LightmapGI](using_lightmap_gi.md#doc_using_lightmap_gi) and
  [ReflectionProbes](reflection_probes.md#doc_reflection_probes) are the only supported options.
  See also [doc_introduction_to_global_illumination_alternatives](introduction_to_global_illumination.md#doc_introduction_to_global_illumination_alternatives).
...
<span id="doc_introduction_to_global_illumination_gi_mode_recommendations"></span>
...
<span id="doc_introduction_to_global_illumination_alternatives"></span>

### Alternatives to GI techniques

If none of the GI techniques mentioned above fits, it's still possible to
[simulate GI by placing additional lights manually](faking_global_illumination.md#doc_faking_global_illumination).
