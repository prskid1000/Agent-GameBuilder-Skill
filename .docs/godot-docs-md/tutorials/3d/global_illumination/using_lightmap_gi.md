<span id="doc_using_lightmap_gi"></span>

## Using Lightmap global illumination

Baked lightmaps are a workflow for adding indirect (or fully baked)
lighting to a scene. Unlike the [VoxelGI](using_voxel_gi.md#doc_using_voxel_gi) and
[SDFGI](using_sdfgi.md#doc_using_sdfgi) approaches, baked lightmaps work fine on low-end PCs
...
using [doc_reflection_probes](reflection_probes.md#doc_reflection_probes) together with it on interiors (or using a Sky
...
[doc_standard_material_3d](../standard_material_3d.md#doc_standard_material_3d) or in custom shaders).
...
.. seealso::
    ...
    See [doc_introduction_to_global_illumination_comparison](introduction_to_global_illumination.md#doc_introduction_to_global_illumination_comparison)
...
![](img/lightmap_gi_comparison.png)
...
> **Warning:** Baking lightmaps in the web editors is not supported due to graphics API limitations. On the web platform, only *rendering* lightmaps that were baked on a different platform is supported.
...
![](img/lightmap_gi_mesh_menu.webp)
...
> **Note:** This option is only available for primitive meshes such as :ref:`class_BoxMesh`, :ref:`class_CylinderMesh`, :ref:`class_PlaneMesh`, etc.
...
[convert a CSG node and its children to a MeshInstance3D](../csg_tools.md#doc_csg_tools_converting_to_mesh_instance_3d).
...
![](img/lightmap_gi_uvchannel.webp)
...
![](img/lightmap_gi_bake_mode.webp)
...
![](img/lightmap_gi_omnilight_size.png)
...
- **Shadowmask Mode:** If set to a mode other than **None**, the first DirectionalLight3D
  ...
  from the camera. See the [section on shadowmasking](using_lightmap_gi.md#doc_using_lightmap_gi_shadowmask)
  for further details.
...
- **Use Denoiser:** If enabled, uses a denoising algorithm to make the lightmap
  ...
  [doc_using_lightmap_gi_denoising](using_lightmap_gi.md#doc_using_lightmap_gi_denoising) for more information.
...
- **Gen Probes > Subdiv:** See [doc_using_lightmap_gi_dynamic_objects](using_lightmap_gi.md#doc_using_lightmap_gi_dynamic_objects).
- **Data > Light Data:** See [doc_using_lightmap_gi_data](using_lightmap_gi.md#doc_using_lightmap_gi_data).

<span id="doc_using_lightmap_gi_shadowmask"></span>
...
<span id="doc_using_lightmap_gi_denoising"></span>
...
<span id="doc_using_lightmap_gi_dynamic_objects"></span>
...
- **Manual:** In addition or as an alternative to generating probes
  automatically, you can add light probes manually by adding [class_LightmapProbe](../../../classes/class_lightmapprobe.md#class_LightmapProbe)
...
<span id="doc_using_lightmap_gi_data"></span>
