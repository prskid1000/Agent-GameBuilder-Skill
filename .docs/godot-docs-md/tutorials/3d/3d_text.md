...
.. seealso::
    ...
    See [doc_gui_using_fonts](../ui/gui_using_fonts.md#doc_gui_using_fonts) for guidelines on configuring font imports.
...
See [Transparency sorting](3d_rendering_limitations.md#doc_3d_rendering_limitations_transparency_sorting)
...
text rendering quality, [enable mipmaps on the font](../ui/gui_using_fonts.md#doc_using_fonts_mipmaps) or
[switch the font to use MSDF rendering](../ui/gui_using_fonts.md#doc_using_fonts_msdf).
...
- Antialiasing the text rendering requires a full-scene antialiasing method to
  ...
  distance. See [doc_3d_antialiasing](3d_antialiasing.md#doc_3d_antialiasing) for more information.
...
return value of [unproject_position](../../classes/class_camera3d.md#class_Camera3D_method_unproject_position)
