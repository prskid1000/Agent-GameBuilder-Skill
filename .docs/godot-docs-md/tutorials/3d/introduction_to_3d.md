<span id="doc_introduction_to_3d"></span>
...
.. figure:: img/godot-tps-demo.webp
   ...
   [Asset Library](../editor/project_manager.md#doc_project_manager_downloading_demos).
...
check out [doc_vector_math](../math/vector_math.md#doc_vector_math) and [doc_using_transforms](using_transforms.md#doc_using_transforms).
...
right docks should be familiar from [editor introduction](../editor/index.md#doc_editor_introduction).
...
- **Move Mode** (:kbd:`W`): Enables move (or translate) mode for the selected nodes.
  See [doc_introduction_to_3d_space_and_manipulation](introduction_to_3d.md#doc_introduction_to_3d_space_and_manipulation) for more details.
- **Rotate Mode** (:kbd:`E`): Enables rotation mode for the selected nodes. See
  [doc_introduction_to_3d_space_and_manipulation](introduction_to_3d.md#doc_introduction_to_3d_space_and_manipulation) for more details.
- **Scale Mode** (:kbd:`R`): Enables scaling and displays scaling gizmos in different
  axes for the selected nodes. See [doc_introduction_to_3d_space_and_manipulation](introduction_to_3d.md#doc_introduction_to_3d_space_and_manipulation)
  for more details.
...
- **Use Local Space** (:kbd:`T`): If enabled, gizmos of a node are drawn using the current node's
  rotation angle instead of the [global viewport axes](introduction_to_3d.md#doc_introduction_to_3d_coordinate_system).
...
- **Toggle preview sunlight**: If no DirectionalLight3D exist in the scene, a preview
  ...
  [doc_introduction_to_3d_preview_environment_light](introduction_to_3d.md#doc_introduction_to_3d_preview_environment_light) for more details.
...
- **Edit Sun and Environment Settings (three dots)**: Opens the menu to configure preview
  sunlight and environment settings. See [doc_introduction_to_3d_preview_environment_light](introduction_to_3d.md#doc_introduction_to_3d_preview_environment_light)
  for more details.
...
<span id="doc_introduction_to_3d_coordinate_system"></span>
...
<span id="doc_introduction_to_3d_space_and_manipulation"></span>
...
![](img/tuto_3d_updated_view_menu.webp)
...
.. tip:: More shortcuts can be found on the
  [doc_default_key_mapping_shortcuts_spatial_editor](../editor/default_key_mapping.md#doc_default_key_mapping_shortcuts_spatial_editor) page.

### Node3D node

[Node2D](../../classes/class_node2d.md#class_Node2D) is the base node for 2D.
[Control](../../classes/class_control.md#class_Control) is the base node for everything GUI.
Following this reasoning, the 3D engine uses the [Node3D](../../classes/class_node3d.md#class_Node3D)
...
[Transform3D](../../classes/class_transform3d.md#class_Transform3D), or as 3 [Vector3](../../classes/class_vector3.md#class_Vector3)
...
.. seealso:: See [doc_importing_3d_scenes](../assets_pipeline/importing_3d_scenes/index.md#doc_importing_3d_scenes) for more on importing.

Generated geometry
~~~~~~~~~~~~~~~~~~

It is possible to create custom geometry by using the
[ArrayMesh](../../classes/class_arraymesh.md#class_ArrayMesh) resource directly. Simply create your arrays
and use the [ArrayMesh.add_surface_from_arrays()](../../classes/class_arraymesh.md#class_ArrayMesh_method_add_surface_from_arrays)
function. A helper class is also available, [SurfaceTool](../../classes/class_surfacetool.md#class_SurfaceTool),
...
> **Note:** 
   [doc_csg_tools](csg_tools.md#doc_csg_tools).

Immediate geometry
~~~~~~~~~~~~~~~~~~

If, instead, you need to generate simple geometry that will be updated often,
Godot provides a special [ImmediateMesh](../../classes/class_immediatemesh.md#class_ImmediateMesh) resource
that can be used in a [MeshInstance3D](../../classes/class_meshinstance3d.md#class_MeshInstance3D) node.
...
[Sprite3D](../../classes/class_sprite3d.md#class_Sprite3D) and
[AnimatedSprite3D](../../classes/class_animatedsprite3d.md#class_AnimatedSprite3D)
...
Godot provides a [WorldEnvironment](../../classes/class_worldenvironment.md#class_WorldEnvironment)
...
<span id="doc_introduction_to_3d_preview_environment_light"></span>

Preview environment and light
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

By default, any 3D scene that doesn't have a [WorldEnvironment](../../classes/class_worldenvironment.md#class_WorldEnvironment)
node, or a [DirectionalLight3D](../../classes/class_directionallight3d.md#class_DirectionalLight3D), will have
...
displayed unless a [Camera3D](../../classes/class_camera3d.md#class_Camera3D) is
...
See [doc_lights_and_shadows](lights_and_shadows.md#doc_lights_and_shadows) for more information on setting up lights in Godot.
