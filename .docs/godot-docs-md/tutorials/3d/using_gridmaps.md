<span id="doc_using_gridmaps"></span>

## Using GridMaps

### Introduction

[Gridmaps](../../classes/class_gridmap.md#class_GridMap) are a tool for creating 3D
game levels, similar to the way [TileMap](../2d/using_tilemaps.md#doc_using_tilemaps)
works in 2D. You start with a predefined collection of 3D meshes (a
[class_MeshLibrary](../../classes/class_meshlibrary.md#class_MeshLibrary)) that can be placed on a grid,
...
To begin, you need a [class_MeshLibrary](../../classes/class_meshlibrary.md#class_MeshLibrary), which is a collection
...
![](img/gridmap_meshlibrary1.webp)

As you can see, this scene has a [class_Node3D](../../classes/class_node3d.md#class_Node3D) node as its root, and
a number of [class_MeshInstance3D](../../classes/class_meshinstance3d.md#class_MeshInstance3D) node children.
...
You can manually assign a [class_StaticBody3D](../../classes/class_staticbody3d.md#class_StaticBody3D) and
[class_CollisionShape3D](../../classes/class_collisionshape3d.md#class_CollisionShape3D) to each mesh. Alternatively, you can use the "Mesh" menu
to automatically create the collision body based on the mesh data.

![](img/gridmap_create_body.webp)
...
Like all mesh instances, MeshLibrary items can be assigned a [class_NavigationMesh](../../classes/class_navigationmesh.md#class_NavigationMesh)
...
[class_NavigationRegion3D](../../classes/class_navigationregion3d.md#class_NavigationRegion3D) child node below the main MeshInstance3D for the GridMap
...
See [doc_using_lightmap_gi](global_illumination/using_lightmap_gi.md#doc_using_lightmap_gi) for more information about lightmap baking.
...
- Be a [class_MeshInstance3D](../../classes/class_meshinstance3d.md#class_MeshInstance3D), which will become the MeshLibrary item. Only
  this visual mesh will be exported.
- Have a material, in the mesh's material slot, *not* the MeshInstance3D's
  material slots.
- Have up to one [class_StaticBody3D](../../classes/class_staticbody3d.md#class_StaticBody3D) child, for collision. The
  StaticBody3D should have one or more [class_CollisionShape3D](../../classes/class_collisionshape3d.md#class_CollisionShape3D) children.
- Have up to one [class_NavigationRegion3D](../../classes/class_navigationregion3d.md#class_NavigationRegion3D) child, for navigation. The
  NavigationRegion3D can have one or more additional [class_MeshInstance3D](../../classes/class_meshinstance3d.md#class_MeshInstance3D)
...
![](img/gridmap_mesh_library_inspector.webp)
...
[doc_physics_index](../physics/index.md#doc_physics_index) section.
...
![](img/gridmap_mesh_library_settings.webp)
...
See [class_GridMap](../../classes/class_gridmap.md#class_GridMap) for details on the node's methods and member variables.
