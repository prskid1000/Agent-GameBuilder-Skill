<span id="doc_physical_light_and_camera_units"></span>
...
> **Warning:** When physical light units are enabled and if you have a WorldEnvironment node in your scene (i.e. the editor Environment is disabled), you **must** have a :ref:`class_CameraAttributes` resource assigned to the WorldEnvironment node. Otherwise, the 3D editor viewport will appear extremely bright if you have a visible DirectionalLight3D node.
On the Camera3D node, you can add a [class_CameraAttributes](../../classes/class_cameraattributes.md#class_CameraAttributes)
resource to its **Attributes** property. This resource is used to control the
camera's depth of field and exposure. When using
[class_CameraAttributesPhysical](../../classes/class_cameraattributesphysical.md#class_CameraAttributesPhysical), its focal length property is also used to
...
See [doc_physical_light_and_camera_units_setting_up_physical_camera_units](physical_light_and_camera_units.md#doc_physical_light_and_camera_units_setting_up_physical_camera_units)
...
If you haven't added a [class_WorldEnvironment](../../classes/class_worldenvironment.md#class_WorldEnvironment) and [class_Camera3D](../../classes/class_camera3d.md#class_Camera3D)
...
the [class_Environment](../../classes/class_environment.md#class_Environment) resource:
...
<span id="doc_physical_light_and_camera_units_setting_up_physical_camera_units"></span>

### Setting up physical camera units

Physical camera units can be enabled separately from physical light units.

After adding a [class_CameraAttributesPhysical](../../classes/class_cameraattributesphysical.md#class_CameraAttributesPhysical) resource to the **Camera
