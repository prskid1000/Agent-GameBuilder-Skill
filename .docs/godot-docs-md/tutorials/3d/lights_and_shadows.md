<span id="doc_lights_and_shadows"></span>
...
- Ambient light in the [Environment](../../classes/class_environment.md#class_Environment) or
  [doc_reflection_probes](global_illumination/reflection_probes.md#doc_reflection_probes).
- Global illumination ([LightmapGI](global_illumination/using_lightmap_gi.md#doc_using_lightmap_gi),
  [VoxelGI](global_illumination/using_voxel_gi.md#doc_using_voxel_gi) or [SDFGI](global_illumination/using_sdfgi.md#doc_using_sdfgi)).

The emission color is a material property. You can read more about it
in the [doc_standard_material_3d](standard_material_3d.md#doc_standard_material_3d) tutorial.
...
There are three types of light nodes: [class_DirectionalLight3D](../../classes/class_directionallight3d.md#class_DirectionalLight3D),
[class_OmniLight3D](../../classes/class_omnilight3d.md#class_OmniLight3D) and [class_SpotLight3D](../../classes/class_spotlight3d.md#class_SpotLight3D). Let's take a look at the common
...
- **Energy:** Energy multiplier. This is useful for saturating lights or working with [doc_high_dynamic_range](high_dynamic_range.md#doc_high_dynamic_range).
- **Indirect Energy:** Secondary multiplier used with indirect light (light bounces). This works with [doc_using_lightmap_gi](global_illumination/using_lightmap_gi.md#doc_using_lightmap_gi), VoxelGI or SDFGI.
...
- **Bake Mode:** Sets the bake mode for the light. See [doc_using_lightmap_gi](global_illumination/using_lightmap_gi.md#doc_using_lightmap_gi).
...
an omni light, a spot light, a [decal](using_decals.md#doc_using_decals) or a
[reflection probe](global_illumination/reflection_probes.md#doc_reflection_probes). This limit can be increased by adjusting
...
consider using [baked lightmaps](global_illumination/using_lightmap_gi.md#doc_using_lightmap_gi) with lights' bake
...
[global illumination](global_illumination/introduction_to_global_illumination.md#doc_introduction_to_global_illumination) technique
...
- **Blur:** Multiplies the shadow blur radius for this light. This works with
  ...
  **Angular Distance** or **Size** greater than `0.0`). Higher values result
  ...
  See also [doc_lights_and_shadows_shadow_filter_mode](lights_and_shadows.md#doc_lights_and_shadows_shadow_filter_mode).
...
![](img/lights_and_shadows_blur.webp)
...
![](img/lights_and_shadows_acne.webp)
...
![](img/lights_and_shadows_peter_panning.webp)
...
[increasing the shadow map resolution](lights_and_shadows.md#doc_lights_and_shadows_balancing_performance_and_quality),
...
recommendations in [doc_lights_and_shadows_pcss_recommendations](lights_and_shadows.md#doc_lights_and_shadows_pcss_recommendations) if setting
...
![](img/lights_and_shadows_pssm_explained.webp)

With this, shadows become more detailed:

![](img/lights_and_shadows_directional_mode.webp)

To control PSSM, a number of parameters are exposed:

![](img/lights_and_shadows_directional_shadow_params.webp)
...
[doc_lights_and_shadows_pcss_recommendations](lights_and_shadows.md#doc_lights_and_shadows_pcss_recommendations) if setting this value above
`0.0` on lights with shadows enabled.

![](img/lights_and_shadows_pcss.webp)
...
![](img/lights_and_shadows_dual_parabolid_vs_cubemap.webp)
...
to [class_PanoramaSkyMaterial](../../classes/class_panoramaskymaterial.md#class_PanoramaSkyMaterial) textures.

With the projector texture below, the following result is obtained:

![](img/lights_and_shadows_omni_projector_example.webp)

![](img/lights_and_shadows_omni_projector.webp)
...
[decal](using_decals.md#doc_using_decals).

With the projector texture below, the following result is obtained:

![](img/lights_and_shadows_spot_projector_example.webp)

![](img/lights_and_shadows_spot_projector.webp)
...
<span id="doc_lights_and_shadows_shadow_atlas"></span>
...
<span id="doc_lights_and_shadows_balancing_performance_and_quality"></span>
...
appropriate [class_RenderingServer](../../classes/class_renderingserver.md#class_RenderingServer) methods.

Positional (omni/spot) shadow quality settings can be changed at runtime on the
root [class_Viewport](../../classes/class_viewport.md#class_Viewport).
...
[shadow atlas](lights_and_shadows.md#doc_lights_and_shadows_shadow_atlas) quadrants to contain
fewer shadows. This will allow each shadow to be rendered at a higher resolution.

<span id="doc_lights_and_shadows_shadow_filter_mode"></span>
...
[doc_3d_antialiasing_taa](3d_antialiasing.md#doc_3d_antialiasing_taa), [doc_3d_antialiasing_fsr2](3d_antialiasing.md#doc_3d_antialiasing_fsr2),
[doc_3d_antialiasing_fxaa](3d_antialiasing.md#doc_3d_antialiasing_fxaa), or increase the shadow filter quality to
...
![](img/lights_and_shadows_filter_quality.webp)
...
<span id="doc_lights_and_shadows_pcss_recommendations"></span>
