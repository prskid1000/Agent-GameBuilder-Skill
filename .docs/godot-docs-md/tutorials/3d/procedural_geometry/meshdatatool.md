<span id="doc_meshdatatool"></span>

## Using the MeshDataTool

The [MeshDataTool](../../../classes/class_meshdatatool.md#class_meshdatatool) is not used to generate geometry. But it is helpful for dynamically altering geometry, for example
if you want to write a script to tessellate, simplify, or deform meshes.

The MeshDataTool is not as fast as altering arrays directly using [ArrayMesh](../../../classes/class_arraymesh.md#class_arraymesh). However, it provides more information
...
> **Note:** 
We initialize the MeshDataTool from an ArrayMesh by calling [create_from_surface()](../../../classes/class_meshdatatool.md#class_meshdatatool_method_create_from_surface). If there is already data initialized in the MeshDataTool,
calling `create_from_surface()` will clear it for you. Alternatively, you can call [clear()](../../../classes/class_meshdatatool.md#class_meshdatatool_method_clear) yourself before re-using the MeshDataTool.

In the examples below, assume an ArrayMesh called `mesh` has already been created. See [ArrayMesh tutorial](arraymesh.md#doc_arraymesh) for an example of mesh generation.
...
first delete the existing surface before adding a new one using [commit_to_surface()](../../../classes/class_meshdatatool.md#class_meshdatatool_method_commit_to_surface):
...
See [ArrayMesh tutorial](arraymesh.md#doc_arraymesh) for how to generate the base mesh.
