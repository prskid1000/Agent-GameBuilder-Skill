<span id="doc_surfacetool"></span>

## Using the SurfaceTool

The [SurfaceTool](../../../classes/class_surfacetool.md#class_surfacetool) provides a useful interface for constructing geometry.
The interface is similar to the [ImmediateMesh](../../../classes/class_immediatemesh.md#class_ImmediateMesh) class. You
...
When finished generating your geometry with the [SurfaceTool](../../../classes/class_surfacetool.md#class_surfacetool),
call `commit()` to finish generating the mesh. If an [ArrayMesh](../../../classes/class_arraymesh.md#class_ArrayMesh) is passed
