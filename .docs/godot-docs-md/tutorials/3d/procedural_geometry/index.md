<span id="doc_procedural_geometry"></span>
...
> **Note:** All the procedural geometry generation methods described here run on the CPU. Godot doesn't support generating geometry on the GPU yet.
### What is geometry?
...
Many things in Godot have mesh in their name: the [Mesh](../../../classes/class_mesh.md#class_Mesh), the
[ArrayMesh](../../../classes/class_arraymesh.md#class_ArrayMesh), the :ref:`ImmediateMesh
<class_ImmediateMesh>`, the [MeshInstance3D](../../../classes/class_meshinstance3d.md#class_MeshInstance3D), the
[MultiMesh](../../../classes/class_multimesh.md#class_MultiMesh), and the :ref:`MultiMeshInstance3D
...
hidden from the user in the [RenderingServer](../../../classes/class_renderingserver.md#class_RenderingServer), but with ArrayMeshes, the user can construct a Mesh
...
in the Mesh when you use a MeshInstance3D using the [material_override](../../../classes/class_geometryinstance3d.md#class_GeometryInstance3D_property_material_override) property.
...
`ArrayMesh.ARRAY_NORMAL` is a [PackedVector3Array](../../../classes/class_packedvector3array.md#class_PackedVector3Array) of vertex normals.
See [Mesh.ArrayType](../../../classes/class_mesh.md#enum_Mesh_ArrayType) for more information.
...
For more information about the ArrayMesh, please see the [ArrayMesh tutorial](arraymesh.md#doc_arraymesh).
...
For more information about the MeshDataTool, please see the [MeshDataTool tutorial](meshdatatool.md#doc_meshdatatool).
...
For more information about the SurfaceTool, please see the [SurfaceTool tutorial](surfacetool.md#doc_surfacetool).
...
For more information about ImmediateMesh, please see the [ImmediateMesh tutorial](immediatemesh.md#doc_immediatemesh).
