...
<span id="doc_using_multi_mesh_instance"></span>

## Using MultiMeshInstance3D

### Introduction

In a normal scenario, you would use a [MeshInstance3D](../../classes/class_meshinstance3d.md#class_MeshInstance3D)
...
[MultiMeshInstance3D](../../classes/class_multimeshinstance3d.md#class_MultiMeshInstance3D) is one of the possible
...
In our example, we would use a [Node3D](../../classes/class_node3d.md#class_Node3D) node as the root node of
