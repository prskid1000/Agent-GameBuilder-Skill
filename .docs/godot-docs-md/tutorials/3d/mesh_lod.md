<span id="doc_mesh_lod"></span>

## Mesh level of detail (LOD)

Level of detail (LOD) is one of the most important ways to optimize rendering
performance in a 3D project, along with [doc_occlusion_culling](occlusion_culling.md#doc_occlusion_culling).
...
.. seealso::
    ...
    use [doc_visibility_ranges](visibility_ranges.md#doc_visibility_ranges) instead of automatic mesh LOD.
...
> **Note:** 
   ...
   See [Importing 3D scenes](../assets_pipeline/importing_3d_scenes/import_configuration.md#doc_importing_3d_scenes_using_the_import_dock)
