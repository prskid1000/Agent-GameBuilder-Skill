<span id="doc_3d_antialiasing"></span>
...
.. seealso::
    ...
    [doc_2d_antialiasing](../2d/2d_antialiasing.md#doc_2d_antialiasing) page.
...
[alpha antialiasing](standard_material_3d.md#doc_standard_material_3d_alpha_antialiasing)
...
![](img/antialiasing_msaa_2x.webp)

![](img/antialiasing_msaa_4x.webp)

![](img/antialiasing_msaa_8x.webp)

<span id="doc_3d_antialiasing_taa"></span>
...
![](img/antialiasing_taa.webp)

<span id="doc_3d_antialiasing_fsr2"></span>
...
2.2. This is an [upscaling method](resolution_scaling.md#doc_resolution_scaling)
...
![](img/antialiasing_fsr2_native.webp)
...
<span id="doc_3d_antialiasing_fxaa"></span>
...
useful for [offline rendering](../animation/creating_movies.md#doc_creating_movies).
...
[non-real-time rendering](../animation/creating_movies.md#doc_creating_movies). For example, to make
