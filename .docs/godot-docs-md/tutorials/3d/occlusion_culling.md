<span id="doc_occlusion_culling"></span>
...
<span id="doc_occlusion_culling_preview"></span>
...
[doc_occlusion_culling_troubleshooting_false_negative](occlusion_culling.md#doc_occlusion_culling_troubleshooting_false_negative).
...
<span id="doc_occlusion_culling_troubleshooting_false_negative"></span>
...
[occlusion culling debug draw mode](occlusion_culling.md#doc_occlusion_culling_preview) to look
for occluder shapes that shouldn't be present, then
[adjust the bake cull mask accordingly](occlusion_culling.md#doc_occlusion_culling_baking).
