<span id="doc_creating_3d_particle_system"></span>
...
[class_ParticleProcessMaterial](../../../classes/class_particleprocessmaterial.md#class_ParticleProcessMaterial) is a special kind of material. We don't use it to draw any objects.
...
particle effects. Take a look at the documentation for [particle](properties.md#doc_3d_particles_properties) and
[particle material](process_material_properties.md#doc_process_material_properties) properties to
