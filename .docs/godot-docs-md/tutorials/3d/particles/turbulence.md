<span id="doc_3d_particles_turbulence"></span>
...
It can be combined with [particle attractors](attractors.md#doc_3d_particles_attractors) and
[collision](collision.md#doc_3d_particles_collision) nodes to create even more complex looking behavior.
...
to follow a more complex movement path. Second, you need to [enable turbulence in the particle process material](process_material_properties.md#doc_process_material_properties_turbulence).
...
the turbulence's effect on the particle system [as described before](process_material_properties.md#doc_process_material_properties).
