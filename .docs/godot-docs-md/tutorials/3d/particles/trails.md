<span id="doc_3d_particles_trails"></span>
...
system and assign a process material [as described before](creating_a_3d_particle_system.md#doc_creating_3d_particle_system).
...
[RibbonTrailMesh](../../../classes/class_ribbontrailmesh.md#class_RibbonTrailMesh) is a simple quad that is divided into
sections and then stretched and repeated along those sections.

Assign a new [Standard Material](../standard_material_3d.md#doc_standard_material_3d) to the `Material`
...
from the options for `Pass 1`. A [TubeTrailMesh](../../../classes/class_tubetrailmesh.md#class_TubeTrailMesh) is a cylinder
that is divided into sections and then stretched and repeated along those sections. Assign a
new [Standard Material](../standard_material_3d.md#doc_standard_material_3d) to the `Material` property and enable
