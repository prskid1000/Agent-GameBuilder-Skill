<span id="doc_3d_particles_subemitters"></span>
...
of the [ParticleProcessMaterial](process_material_properties.md#doc_process_material_properties_subemitter) to something other than `Disabled`.
