<span id="doc_3d_particles_complex_shapes"></span>
...
in the [process material](process_material_properties.md#doc_process_material_properties_shapes), Godot provides
