<span id="doc_process_material_properties"></span>
...
> **Note:** 
  ...
  For information on how to use it in a 2D Scene see [doc_particle_process_material_2d](../../2d/particle_process_material_2d.md#doc_particle_process_material_2d).
...
the same amount of time, set by the [Lifetime](properties.md#doc_3d_particles_properties_time) property. A value of `1` means
...
property is the same as setting the [Transform Align](properties.md#doc_3d_particles_properties_draw) property to
`Y to Velocity`.
...
is any particle that uses the [Standard Material](../standard_material_3d.md#doc_standard_material_3d)
...
determined by the [Local Coords](properties.md#doc_3d_particles_properties_draw) property.
...
<span id="doc_process_material_properties_shapes"></span>
...
[Complex emission shapes](complex_shapes.md#doc_3d_particles_complex_shapes) section for a detailed
...
the [Standard Material](../standard_material_3d.md#doc_standard_material_3d), if it is set to `Particle Billboard`, rotates
...
or the `Particle Billboard` mode is selected in the [Standard Material](../standard_material_3d.md#doc_standard_material_3d).
...
If you want the particle system to interact with [particle attractors](attractors.md#doc_3d_particles_attractors),
...
billboards, the `Keep Size` property on the [Standard Material](../standard_material_3d.md#doc_standard_material_3d)
...
`Use As Albedo` property in the `Vertex Color` group of the [Standard Material](../standard_material_3d.md#doc_standard_material_3d)
...
<span id="doc_process_material_properties_animation"></span>

Animation
~~~~~~~~~

The `Animation` property group controls the behavior of sprite
sheet animations in the particle's [Standard Material](../standard_material_3d.md#doc_standard_material_3d).
...
<span id="doc_process_material_properties_turbulence"></span>
...
[particle turbulence](turbulence.md#doc_3d_particles_turbulence).

<span id="doc_process_material_properties_subemitter"></span>
...
If the `Use Scale` property is enabled, the [collision base size](properties.md#doc_3d_particles_properties_collision)
...
You can learn more about particle collisions in the [Collisions](collision.md#doc_3d_particles_collision)
...
See the [Sub-emitters](subemitters.md#doc_3d_particles_subemitters) section in this manual for a detailed explanation of how
...
the current ParticleProcessMaterial to a [class_ShaderMaterial](../../../classes/class_shadermaterial.md#class_ShaderMaterial). Existing properties
