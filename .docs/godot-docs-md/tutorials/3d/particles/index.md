...
There are two types of 3D particle systems in Godot: [class_GPUParticles3D](../../../classes/class_gpuparticles3d.md#class_GPUParticles3D), which are processed on the GPU,
and [class_CPUParticles3D](../../../classes/class_cpuparticles3d.md#class_CPUParticles3D), which are processed on the CPU.
...
There are three particle attractor nodes: [class_GPUParticlesAttractorBox3D](../../../classes/class_gpuparticlesattractorbox3d.md#class_GPUParticlesAttractorBox3D), [class_GPUParticlesAttractorSphere3D](../../../classes/class_gpuparticlesattractorsphere3d.md#class_GPUParticlesAttractorSphere3D),
and [class_GPUParticlesAttractorVectorField3D](../../../classes/class_gpuparticlesattractorvectorfield3d.md#class_GPUParticlesAttractorVectorField3D). An attractor node applies a force to all particles
in its reach and pulls them closer or pushes them away based on the direction of that force.

There are several particle collision nodes. [class_GPUParticlesCollisionBox3D](../../../classes/class_gpuparticlescollisionbox3d.md#class_GPUParticlesCollisionBox3D) and
[class_GPUParticlesCollisionSphere3D](../../../classes/class_gpuparticlescollisionsphere3d.md#class_GPUParticlesCollisionSphere3D) are the simple ones. You can use them to create basic
shapes like boxes, a floor, or a wall that particles collide with. The other two nodes provide
more complex collision behavior. The [class_GPUParticlesCollisionSDF3D](../../../classes/class_gpuparticlescollisionsdf3d.md#class_GPUParticlesCollisionSDF3D) is useful when you want
...
[class_GPUParticlesCollisionHeightField3D](../../../classes/class_gpuparticlescollisionheightfield3d.md#class_GPUParticlesCollisionHeightField3D) node. It creates a heightmap of your world and the
