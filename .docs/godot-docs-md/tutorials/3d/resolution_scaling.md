<span id="doc_resolution_scaling"></span>
...
> **Note:** Resolution scaling is currently not available for 2D rendering, but it can be simulated using the ``viewport`` stretch mode. See :ref:`doc_multiple_resolutions` for more information.
...
![](img/resolution_scaling_bilinear_0.5.png)

![](img/resolution_scaling_fsr1_0.5.png)

![](img/resolution_scaling_fsr2_0.5.webp)
...
![](img/resolution_scaling_bilinear_msaa_4x_0.5.png)

![](img/resolution_scaling_fsr1_msaa_4x_0.5.png)

![](img/resolution_scaling_fsr2_msaa_4x_0.5.webp)
...
property on a [class_Viewport](../../classes/class_viewport.md#class_Viewport) node.
...
**not recommended** for most use cases. See [doc_3d_antialiasing](3d_antialiasing.md#doc_3d_antialiasing) for more
information.
...
<span id="doc_resolution_scaling_mipmap_bias"></span>
...
can also be changed at runtime on [Viewports](../../classes/class_viewport.md#class_Viewport) by
...
![](img/resolution_scaling_texture_mipmap_bias_comparison.png)
...
See the [doc_performance](../performance/index.md#doc_performance) tutorials for more information.
