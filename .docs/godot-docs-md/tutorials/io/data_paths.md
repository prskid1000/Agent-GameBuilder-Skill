...
.. tip::
    ...
    - [String.filecasecmp_to()](../../classes/class_string.md#class_String_method_filecasecmp_to)
    - [String.filenocasecmp_to()](../../classes/class_string.md#class_String_method_filenocasecmp_to)
    - [String.get_base_dir()](../../classes/class_string.md#class_String_method_get_base_dir)
    - [String.get_basename()](../../classes/class_string.md#class_String_method_get_basename)
    - [String.get_extension()](../../classes/class_string.md#class_String_method_get_extension)
    - [String.get_file()](../../classes/class_string.md#class_String_method_get_file)
    - [String.is_absolute_path()](../../classes/class_string.md#class_String_method_is_absolute_path)
    - [String.is_relative_path()](../../classes/class_string.md#class_String_method_is_relative_path)
    - [String.is_valid_filename()](../../classes/class_string.md#class_String_method_is_valid_filename)
    - [String.path_join()](../../classes/class_string.md#class_String_method_path_join)
    - [String.simplify_path()](../../classes/class_string.md#class_String_method_simplify_path)
    - [String.validate_filename()](../../classes/class_string.md#class_String_method_validate_filename)
...
<span id="doc_data_paths_accessing_persistent_user_data"></span>
...
- By default, the `user://` folder is created within Godot's
  [editor data path](data_paths.md#doc_data_paths_editor_data_paths) in the
...
you can override it on a per-platform basis using [feature tags](../export/feature_tags.md#doc_feature_tags).
...
through the [JavaScriptBridge](../../classes/class_javascriptbridge.md#class_JavaScriptBridge) singleton.)

### File logging

.. seealso::

    Documentation on file logging has been moved to [doc_logging](../scripting/logging.md#doc_logging).

### Converting paths to absolute paths or "local" paths

You can use [ProjectSettings.globalize_path()](../../classes/class_projectsettings.md#class_ProjectSettings_method_globalize_path)
to convert a "local" path like `res://path/to/file.txt` to an absolute OS path.
For example, [ProjectSettings.globalize_path()](../../classes/class_projectsettings.md#class_ProjectSettings_method_globalize_path)
can be used to open "local" paths in the OS file manager
using [OS.shell_open()](../../classes/class_os.md#class_OS_method_shell_open) since it only accepts
native OS paths.

To convert an absolute OS path to a "local" path starting with `res://`
or `user://`, use [ProjectSettings.localize_path()](../../classes/class_projectsettings.md#class_ProjectSettings_method_localize_path).
This only works for absolute paths that point to files or folders in your
project's root or `user://` folders.

<span id="doc_data_paths_editor_data_paths"></span>
...
> **Note:** <https://flathub.org/apps/details/org.godotengine.Godot>`__, the editor data paths will be located in subfolders in ``~/.var/app/org.godotengine.Godot/``.
<span id="doc_data_paths_self_contained_mode"></span>
