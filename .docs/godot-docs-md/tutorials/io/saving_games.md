...
> **Note:** If you're looking to save user configuration, you can use the :ref:`class_ConfigFile` class for this purpose.
.. seealso::
...
has the helper class [JSON](../../classes/class_json.md#class_json) to convert between dictionary and string.
...
As covered in the [doc_filesystem](../scripting/filesystem.md#doc_filesystem) tutorial, we'll need to open a file
so we can write to it or read from it. Now that we have a way to
call our groups and get their relevant data, let's use the class [JSON](../../classes/class_json.md#class_json) to
...
line. Use the [parse](../../classes/class_json.md#class_JSON_method_parse) method to read the
...
a lot of it, [binary serialization](binary_serialization_api.md#doc_binary_serialization_api)
...
[Binary serialization](binary_serialization_api.md#doc_binary_serialization_api) is an alternative
approach for storing game state, and you can use it with the functions
`get_var` and `store_var` of [class_FileAccess](../../classes/class_fileaccess.md#class_FileAccess).
