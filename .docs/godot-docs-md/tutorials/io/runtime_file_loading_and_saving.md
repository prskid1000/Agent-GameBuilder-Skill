<span id="doc_runtime_loading_and_saving"></span>

## Runtime file loading and saving

.. seealso::

    See [doc_saving_games](saving_games.md#doc_saving_games) for information on saving and loading game progression.

Sometimes, [exporting packs, patches, and mods](../export/exporting_pcks.md#doc_exporting_pcks) is not
...
Runtime file loading can be combined with [HTTP requests](../networking/http_request_class.md#doc_http_request_class)
to load resources from the Internet directly.

> **Warning:** Do **not** use this runtime loading approach to load resources that are part of the project, as it's less efficient and doesn't allow benefiting from Godot's resource handling functionality (such as translation remaps). See :ref:`doc_import_process` for details.
.. seealso::
...
Godot's [class_FileAccess](../../classes/class_fileaccess.md#class_FileAccess) class provides methods to access files on the
...
Godot), [class_FileAccess](../../classes/class_fileaccess.md#class_FileAccess) provides several methods to read/write integers,
...
streams that are not part of a file, [class_PackedByteArray](../../classes/class_packedbytearray.md#class_PackedByteArray) provides
...
`decode_` and `encode_`. See also [doc_binary_serialization_api](binary_serialization_api.md#doc_binary_serialization_api).

<span id="doc_runtime_file_loading_and_saving_images"></span>

### Images

Image's [Image.load_from_file](../../classes/class_image.md#class_Image_method_load_from_file) static method
...
- [Image.load_jpg_from_buffer](../../classes/class_image.md#class_Image_method_load_jpg_from_buffer)
- [Image.load_ktx_from_buffer](../../classes/class_image.md#class_Image_method_load_ktx_from_buffer)
- [Image.load_png_from_buffer](../../classes/class_image.md#class_Image_method_load_png_from_buffer)
- [Image.load_svg_from_buffer](../../classes/class_image.md#class_Image_method_load_svg_from_buffer)
  or [Image.load_svg_from_string](../../classes/class_image.md#class_Image_method_load_svg_from_string)
- [Image.load_tga_from_buffer](../../classes/class_image.md#class_Image_method_load_tga_from_buffer)
- [Image.load_webp_from_buffer](../../classes/class_image.md#class_Image_method_load_webp_from_buffer)

Several image formats can also be saved by Godot at runtime using the following
methods:

- [Image.save_png](../../classes/class_image.md#class_Image_method_save_png)
  or [Image.save_png_to_buffer](../../classes/class_image.md#class_Image_method_save_png_to_buffer)
- [Image.save_webp](../../classes/class_image.md#class_Image_method_save_webp)
  or [Image.save_webp_to_buffer](../../classes/class_image.md#class_Image_method_save_webp_to_buffer)
- [Image.save_jpg](../../classes/class_image.md#class_Image_method_save_jpg)
  or [Image.save_jpg_to_buffer](../../classes/class_image.md#class_Image_method_save_jpg_to_buffer)
- [Image.save_exr](../../classes/class_image.md#class_Image_method_save_exr)
  or [Image.save_exr_to_buffer](../../classes/class_image.md#class_Image_method_save_exr_to_buffer)
...
<span id="doc_runtime_file_loading_and_saving_audio_video_files"></span>
...
Example of loading an Ogg Vorbis audio file in an [class_AudioStreamPlayer](../../classes/class_audiostreamplayer.md#class_AudioStreamPlayer) node:
...
Example of loading an Ogg Theora video file in a [class_VideoStreamPlayer](../../classes/class_videostreamplayer.md#class_VideoStreamPlayer) node:
...
<span id="doc_runtime_file_loading_and_saving_3d_scenes"></span>

### 3D scenes

Godot has first-class support for glTF 2.0, both in the editor and exported
projects. Using [class_gltfdocument](../../classes/class_gltfdocument.md#class_gltfdocument) and [class_gltfstate](../../classes/class_gltfstate.md#class_gltfstate) together,
...
[class_fbxdocument](../../classes/class_fbxdocument.md#class_fbxdocument) and [class_fbxstate](../../classes/class_fbxstate.md#class_fbxstate) classes. The code to do so
...
> **Note:** When loading a glTF scene, a *base path* must be set so that external resources like textures can be loaded correctly. When loading from a file, the base path is automatically set to the folder containing the file. When loading from a buffer, this base path must be manually set as there is no way for Godot to infer this path. To set the base path, set :ref:`GLTFState.base_path <class_GLTFState_property_base_path>` on your GLTFState instance *before* calling :ref:`GLTFDocument.append_from_buffer <class_GLTFDocument_method_append_from_buffer>` or :ref:`GLTFDocument.append_from_file <class_GLTFDocument_method_append_from_file>`.
<span id="doc_runtime_file_loading_and_saving_fonts"></span>

### Fonts

[FontFile.load_dynamic_font](../../classes/class_fontfile.md#class_FontFile_method_load_bitmap_font) supports the following
font file formats: TTF, OTF, WOFF, WOFF2, PFB, PFM

On the other hand, [FontFile.load_bitmap_font](../../classes/class_fontfile.md#class_FontFile_method_load_bitmap_font) supports
the BMFont format (`.fnt` or `.font`).

Additionally, it is possible to load any font that is installed on the system using
Godot's support for [doc_using_fonts_system_fonts](../ui/gui_using_fonts.md#doc_using_fonts_system_fonts).

Example of loading a font file automatically according to its file extension,
then adding it as a theme override to a [class_Label](../../classes/class_label.md#class_Label) node:
...
Godot supports reading and writing ZIP archives using the [class_zipreader](../../classes/class_zipreader.md#class_zipreader)
and [class_zippacker](../../classes/class_zippacker.md#class_zippacker) classes. This supports any ZIP file, including files
...
Example that lists files in a ZIP archive in an [class_ItemList](../../classes/class_itemlist.md#class_ItemList) node,
