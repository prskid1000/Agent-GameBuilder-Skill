<span id="doc_audio_effects"></span>
...
<span id="doc_audio_buses_limiter"></span>
...
from [Area3Ds](../../classes/class_area3d.md#class_Area3D)
(see [Reverb buses](audio_streams.md#doc_audio_streams_reverb_buses)), or to apply
