...
<span id="doc_audio_streams"></span>

## Audio streams

### Introduction

As you might have already read in [doc_audio_buses](audio_buses.md#doc_audio_buses), sound is sent to
...
information on supported formats and differences in [doc_importing_audio_samples](../assets_pipeline/importing_audio_samples.md#doc_importing_audio_samples).

There are other types of AudioStreams, such as [AudioStreamRandomizer](../../classes/class_audiostreamrandomizer.md#class_AudioStreamRandomizer).
...
![](img/audio_stream_2d_area.webp)

### AudioStreamPlayer3D

![](img/audio_stream_3d.webp)
...
![](img/audio_stream_reverb_bus.webp)
...
![](img/audio_stream_reverb_bus2.webp)
