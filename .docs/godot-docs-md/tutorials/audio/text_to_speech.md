<span id="doc_text_to_speech"></span>
...
Godot includes text-to-speech functionality. You can find these under the [DisplayServer class](../../classes/class_displayserver.md#class_DisplayServer).
