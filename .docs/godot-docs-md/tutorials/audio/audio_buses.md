...
![](img/audio_buses3.webp)

Finally, toggle the **Playing** property to **On** and sound will flow.

.. seealso::

    You may also be interested in reading about [doc_audio_streams](audio_streams.md#doc_audio_streams) now.
...
![](img/audio_buses4.webp)

For information on what each effect does, see [doc_audio_effects](audio_effects.md#doc_audio_effects).
