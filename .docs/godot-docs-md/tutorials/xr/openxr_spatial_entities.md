<span id="doc_openxr_spatial_entities"></span>
...
![](img/openxr_spatial_entities_project_settings.webp)
...
[OpenXRSpatialEntityTracker](../../classes/class_openxrspatialentitytracker.md#class_OpenXRSpatialEntityTracker)
object is instantiated and registered with the [XRServer](../../classes/class_xrserver.md#class_XRServer).
...
As the tracker objects can be used with [XRAnchor3D](../../classes/class_xranchor3d.md#class_XRAnchor3D) nodes, these subscenes
...
object. As all locations are local to the [XROrigin3D](../../classes/class_xrorigin3d.md#class_XROrigin3D) node, we should create
...
Spatial anchors are tracked using [OpenXRAnchorTracker](../../classes/class_openxranchortracker.md#class_OpenXRAnchorTracker) objects
registered with the XRServer.

When needed, the location of the spatial anchor will be updated automatically; the pose on the
related tracker will be updated and thus the [XRAnchor3D](../../classes/class_xranchor3d.md#class_XRAnchor3D) node will
reposition.
...
This scene should have an [XRAnchor3D](../../classes/class_xranchor3d.md#class_XRAnchor3D) node as the root but nothing
...
The root node for this scene must be an [XRAnchor3D](../../classes/class_xranchor3d.md#class_XRAnchor3D) node.
We'll add a [StaticBody3D](../../classes/class_staticbody3d.md#class_StaticBody3D) node as a child and add a
[CollisionShape3D](../../classes/class_collisionshape3d.md#class_CollisionShape3D) and [MeshInstance3D](../../classes/class_meshinstance3d.md#class_MeshInstance3D)
node as children of the static body.

![](img/openxr_plane_anchor.webp)
...
For our "hole punch" material, create a [ShaderMaterial](../../classes/class_shadermaterial.md#class_ShaderMaterial)
...
Please consult the [OpenXRPlaneTracker](../../classes/class_openxrplanetracker.md#class_OpenXRPlaneTracker) class documentation for
further information.
...
When markers are detected, [OpenXRMarkerTracker](../../classes/class_openxrmarkertracker.md#class_OpenXRMarkerTracker) objects are
...
with an [XRAnchor3D](../../classes/class_xranchor3d.md#class_XRAnchor3D) node at the root, save this, and assign it to the
...
[OpenXRSpatialEntityExtension](../../classes/class_openxrspatialentityextension.md#class_OpenXRSpatialEntityExtension) singleton.
...
entry and that is [OpenXRSpatialQueryResultData](../../classes/class_openxrspatialqueryresultdata.md#class_OpenXRSpatialQueryResultData).
...
[OpenXRSpatialEntityTracker](../../classes/class_openxrspatialentitytracker.md#class_OpenXRSpatialEntityTracker) instance is destroyed.

Spatial anchor capability
~~~~~~~~~~~~~~~~~~~~~~~~~

Spatial anchors are managed by our [OpenXRSpatialAnchorCapability](../../classes/class_openxrspatialanchorcapability.md#class_OpenXRSpatialAnchorCapability)
singleton object.
...
[OpenXRSpatialCapabilityConfigurationAnchor](../../classes/class_openxrspatialcapabilityconfigurationanchor.md#class_OpenXRSpatialCapabilityConfigurationAnchor)
...
.. list-table:: Anchor components
   ...
   * - COMPONENT_TYPE_ANCHOR
     - [OpenXRSpatialComponentAnchorList](../../classes/class_openxrspatialcomponentanchorlist.md#class_OpenXRSpatialComponentAnchorList)
     - Provides us with the pose (location + orientation) of each anchor
   * - COMPONENT_TYPE_PERSISTENCE
     - [OpenXRSpatialComponentPersistenceList](../../classes/class_openxrspatialcomponentpersistencelist.md#class_OpenXRSpatialComponentPersistenceList)
...
Finally we can process our snapshot. Note that we are using [OpenXRAnchorTracker](../../classes/class_openxranchortracker.md#class_OpenXRAnchorTracker)
...
[OpenXRSpatialPlaneTrackingCapability](../../classes/class_openxrspatialplanetrackingcapability.md#class_OpenXRSpatialPlaneTrackingCapability)
singleton class.
...
.. list-table:: Plane tracking components
   ...
   * - COMPONENT_TYPE_BOUNDED_2D
     - [OpenXRSpatialComponentBounded2DList](../../classes/class_openxrspatialcomponentbounded2dlist.md#class_OpenXRSpatialComponentBounded2DList)
     - Provides us with the center pose and bounding rectangle for each plane.
   * - COMPONENT_TYPE_PLANE_ALIGNMENT
     - [OpenXRSpatialComponentPlaneAlignmentList](../../classes/class_openxrspatialcomponentplanealignmentlist.md#class_OpenXRSpatialComponentPlaneAlignmentList)
     - Provides us with the alignment of each plane
   * - COMPONENT_TYPE_MESH_2D
     - [OpenXRSpatialComponentMesh2DList](../../classes/class_openxrspatialcomponentmesh2dlist.md#class_OpenXRSpatialComponentMesh2DList)
     - Provides us with a 2D mesh that shapes each plane
   * - COMPONENT_TYPE_POLYGON_2D
     - [OpenXRSpatialComponentPolygon2DList](../../classes/class_openxrspatialcomponentpolygon2dlist.md#class_OpenXRSpatialComponentPolygon2DList)
     - Provides us with a 2D polygon that shapes each plane
   * - COMPONENT_TYPE_PLANE_SEMANTIC_LABEL
     - [OpenXRSpatialComponentPlaneSemanticLabelList](../../classes/class_openxrspatialcomponentplanesemanticlabellist.md#class_OpenXRSpatialComponentPlaneSemanticLabelList)
...
We can use our [OpenXRPlaneTracker](../../classes/class_openxrplanetracker.md#class_OpenXRPlaneTracker) tracker object to store our component data.
...
[OpenXRSpatialMarkerTrackingCapability](../../classes/class_openxrspatialmarkertrackingcapability.md#class_OpenXRSpatialMarkerTrackingCapability)
singleton class.
...
.. list-table:: Marker tracking options
   ...
   * - April tag
     ...
     - [OpenXRSpatialCapabilityConfigurationAprilTag](../../classes/class_openxrspatialcapabilityconfigurationapriltag.md#class_OpenXRSpatialCapabilityConfigurationAprilTag)
   * - Aruco
     - `aruco_is_supported`
     - [OpenXRSpatialCapabilityConfigurationAruco](../../classes/class_openxrspatialcapabilityconfigurationaruco.md#class_OpenXRSpatialCapabilityConfigurationAruco)
   * - QR code
     - `qrcode_is_supported`
     - [OpenXRSpatialCapabilityConfigurationQrCode](../../classes/class_openxrspatialcapabilityconfigurationqrcode.md#class_OpenXRSpatialCapabilityConfigurationQrCode)
   * - Micro QR code
     - `micro_qrcode_is_supported`
     - [OpenXRSpatialCapabilityConfigurationMicroQrCode](../../classes/class_openxrspatialcapabilityconfigurationmicroqrcode.md#class_OpenXRSpatialCapabilityConfigurationMicroQrCode)
...
.. list-table:: Marker tracking components
   ...
   * - COMPONENT_TYPE_MARKER
     - [OpenXRSpatialComponentMarkerList](../../classes/class_openxrspatialcomponentmarkerlist.md#class_OpenXRSpatialComponentMarkerList)
