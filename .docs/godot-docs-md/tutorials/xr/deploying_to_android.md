<span id="doc_deploying_to_android"></span>
...
See [doc_exporting_for_android](../export/exporting_for_android.md#doc_exporting_for_android) for the full details, and return here when you've finished these steps.
...
You can read more about gradle builds here: [doc_android_gradle_build](../export/android_gradle_build.md#doc_android_gradle_build).
...
![](img/openxr_loader_asset_lib.webp)
...
![](img/android_one_click_deploy.webp)
