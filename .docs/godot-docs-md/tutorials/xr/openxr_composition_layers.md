<span id="doc_openxr_composition_layers"></span>
...
The solution then is to render the UI to a [SubViewport](../../classes/class_subviewport.md#class_subviewport)
and display the result of this using a [ViewportTexture](../../classes/class_viewporttexture.md#class_viewporttexture) on a 3D mesh.
The [QuadMesh](../../classes/class_quadmesh.md#class_quadmesh) is a suitable option for this.

> **Note:** See the `GUI in 3D <https://github.com/godotengine/godot-demo-projects/tree/master/viewport/gui_in_3d>`_ example project for an example of this approach.
...
- [OpenXRCompositionLayerCylinder](../../classes/class_openxrcompositionlayercylinder.md#class_OpenXRCompositionLayerCylinder) shows the contents of the SubViewport on the inside of a cylinder (or "slice" of a cylinder).
- [OpenXRCompositionLayerEquirect](../../classes/class_openxrcompositionlayerequirect.md#class_OpenXRCompositionLayerEquirect) shows the contents of the SubViewport on the interior of a sphere (or "slice" of a sphere).
- [OpenXRCompositionLayerQuad](../../classes/class_openxrcompositionlayerquad.md#class_OpenXRCompositionLayerQuad) shows the contents of the SubViewport on a flat rectangle.
...
![](img/openxr_composition_layer_subviewport.webp)
...
our [XROrigin3D](../../classes/class_xrorigin3d.md#class_xrorigin3d) node.
...
![](img/openxr_composition_layer_quad.webp)
...
we prepare an [InputEventMouseMotion](../../classes/class_inputeventmousemotion.md#class_InputEventMouseMotion) object
...
an [InputEventMouseButton](../../classes/class_inputeventmousebutton.md#class_InputEventMouseButton) object
