<span id="doc_xr_room_scale"></span>
...
In traditional first person games a player is represented by a [CharacterBody3D](../../classes/class_characterbody3d.md#class_characterbody3d) node.
...
Applying this model to the XR setup, we add an [XROrigin3D](../../classes/class_xrorigin3d.md#class_xrorigin3d) node as a child of the character body,
and add an [XRCamera3D](../../classes/class_xrcamera3d.md#class_xrcamera3d) as a child of the origin node. At face value this seems to work.
...
![](img/xr_room_scale_origin_body.webp)
...
![](img/xr_room_scale_character_body.webp)
