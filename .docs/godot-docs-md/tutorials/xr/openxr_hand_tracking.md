<span id="doc_openxr_hand_tracking"></span>
...
![](img/xr_enable_handtracking.webp)
...
![](img/openxr_enable_hand_tracking_meta.webp)
...
![](img/openxr_hand_tracking_nodes.webp)
 ...
 *  Tracking happens in the local space of the [XROrigin3D](../../classes/class_xrorigin3d.md#class_xrorigin3d) node.
...
For this you need to add an [XRNode3D](../../classes/class_xrnode3d.md#class_xrnode3d) node to your `XROrigin3D` node.
...
For this Godot uses the hand bone structure as defined for the [Godot Humanoid](../../classes/class_skeletonprofilehumanoid.md#class_skeletonprofilehumanoid)
...
We also need to enable editable children to gain access to our [Skeleton3D](../../classes/class_skeleton3d.md#class_skeleton3d) node.

The hand skeleton modifier
~~~~~~~~~~~~~~~~~~~~~~~~~~

Finally we need to add an [XRHandModifier3D](../../classes/class_xrhandmodifier3d.md#class_xrhandmodifier3d) node as a child to our `Skeleton3D` node.
...
Reacting to actions performed by the user is handled through [doc_xr_action_map](xr_action_map.md#doc_xr_action_map)
...
![](img/openxr_hand_interaction_profile.webp)
...
![](img/openxr_msft_hand_interaction_profile.webp)
...
![](img/openxr_htc_hand_interaction_profile.webp)
...
![](img/openxr_simple_controller_hand.webp)
...
You can obtain the full hand tracking data through the [XRHandTracker](../../classes/class_xrhandtracker.md#class_xrhandtracker)
