<span id="doc_xr_full_screen_effects"></span>
...
Add a [MeshInstance3D](../../classes/class_meshinstance3d.md#class_MeshInstance3D) node
to your scene as a child of your [XRCamera3D](../../classes/class_xrcamera3d.md#class_XRCamera3D),
and set the `mesh` property to a [QuadMesh](../../classes/class_quadmesh.md#class_QuadMesh).
Set the width and height of the quad to `2`.

![](img/xr_full_screen_effects_starting_quad.webp)
...
![](img/xr_full_screen_effects_vignette_before_after.webp)
...
![](img/xr_full_screen_effects_ending_quad.webp)
...
> **Note:** `Meta Asymmetric Field of View FAQ <https://developers.meta.com/horizon/documentation/unity/unity-asymmetric-fov-faq/>`_.
### Limitations
