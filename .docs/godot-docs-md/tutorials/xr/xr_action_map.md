<span id="doc_xr_action_map"></span>
...
![](img/xr_my_first_action_set.webp)
...
trigger the `button_pressed` signal on the relevant [XRController3D](../../classes/class_xrcontroller3d.md#class_xrcontroller3d)
node in your scene with `Shoot` as the `name` parameter of the signal.

You can also poll the current state of an action.
[XRController3D](../../classes/class_xrcontroller3d.md#class_xrcontroller3d) for instance has
...
your [XRController3D](../../classes/class_xrcontroller3d.md#class_xrcontroller3d) node.
...
on your [XRController3D](../../classes/class_xrcontroller3d.md#class_xrcontroller3d) node.
...
Your [XRController3D](../../classes/class_xrcontroller3d.md#class_xrcontroller3d) node is automatically positioned based
...
to both hands.
The appropriate [XRController3D](../../classes/class_xrcontroller3d.md#class_xrcontroller3d) node will emit the signal.
...
If all else fails, it will check the generic ["Simple controller"](xr_action_map.md#doc_xr_action_map_simple).
...
![](img/xr_add_touch_controller.webp)
...
![](img/xr_select_action.webp)

Let's finish our configuration:

![](img/xr_touch_completed.webp)
...
<span id="doc_xr_action_map_simple"></span>
...
<span id="doc_binding_modifiers"></span>
...
for each runtime and using a custom [feature tag](../export/feature_tags.md#doc_feature_tags)
...
![](img/openxr_ip_binding_modifier.webp)
...
![](img/openxr_thumbstick_dpad.webp)
...
![](img/openxr_project_settings_dpad_modifier.webp)
...
![](img/openxr_action_binding_modifier.webp)
...
![](img/openxr_project_settings_analog_threshold_modifier.webp)

The analog threshold modifier has the following settings:

![](img/openxr_analog_threshold_modifier.webp)
...
![](img/openxr_haptic_vibration.webp)
