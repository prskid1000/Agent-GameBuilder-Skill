<span id="doc_introducing_xr_tools"></span>
...
Continuing on from our project we started in [doc_setting_up_xr](setting_up_xr.md#doc_setting_up_xr) we want to add in the Godot XR Tools library.
...
![](img/godot_xr_tools_root_folder.webp)
...
![](img/godot_xr_tools_enable.webp)
...
In your scene tree select your left hand [XRController3D](../../classes/class_xrcontroller3d.md#class_xrcontroller3d) node.
