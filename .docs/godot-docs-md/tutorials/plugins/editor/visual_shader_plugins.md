<span id="doc_visual_shader_plugins"></span>

## Visual Shader plugins

Visual Shader plugins are used to create custom [class_VisualShader](../../../classes/class_visualshader.md#class_VisualShader) nodes
in GDScript.
...
Create a Sprite2D and assign a [class_ShaderMaterial](../../../classes/class_shadermaterial.md#class_ShaderMaterial) to its material slot:

![](img/visual_shader_plugins_start.png)

Assign [class_VisualShader](../../../classes/class_visualshader.md#class_VisualShader) to the shader slot of the material:
...
Create a script which derives from [class_VisualShaderNodeCustom](../../../classes/class_visualshadernodecustom.md#class_VisualShaderNodeCustom). This is
