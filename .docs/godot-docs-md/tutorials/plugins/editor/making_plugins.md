<span id="doc_making_plugins"></span>
...
![](img/making_plugins-create_plugin_dialog.webp)
...
![](img/making_plugins-my_custom_mode_folder.webp)
...
editor, and it must inherit from [class_EditorPlugin](../../../classes/class_editorplugin.md#class_EditorPlugin).

> **Warning:** In addition to the EditorPlugin script, any other GDScript that your plugin uses must *also* be a tool. Any GDScript without ``@tool`` used by the editor will act like an empty file!
It's important to deal with initialization and clean-up of resources.
A good practice is to use the virtual function
[_enter_tree()](../../../classes/class_node.md#class_Node_private_method__enter_tree) to initialize your plugin and
[_exit_tree()](../../../classes/class_node.md#class_Node_private_method__exit_tree) to clean it up. Thankfully,
the dialog generates these callbacks for you. Your script should look something
like this:

<span id="doc_making_plugins_template_code"></span>
.. tabs::
```
```
...
[class_Button](../../../classes/class_button.md#class_Button). It could also extend
[class_BaseButton](../../../classes/class_basebutton.md#class_BaseButton) if you prefer:
...
![](img/making_plugins-custom_node_create.webp)
...
![](img/making_plugins-custom_node_console.webp)
...
[template we've seen before](making_plugins.md#doc_making_plugins_template_code) to get a
good start.
...
For an editor dock, the root node **must** be a [Control](../../../classes/class_control.md#class_Control)
or one of its child classes. For this tutorial, you can create a single button.
Don't forget to add some text to your button.

![](img/making_plugins-my_custom_dock_scene.webp)
...
[add_dock()](../../../classes/class_editorplugin.md#class_EditorPlugin_method_add_dock) from the
[EditorPlugin](../../../classes/class_editorplugin.md#class_EditorPlugin) class.
...
![](img/making_plugins-project_settings.webp)
...
![](img/making_plugins-custom_dock.webp)

<span id="doc_making_plugins_autoload"></span>

### Registering autoloads/singletons in plugins

It is possible for editor plugins to automatically register
[autoloads](../../scripting/singletons_autoload.md#doc_singletons_autoload) when the plugin is enabled.
...
![](img/sub_plugin_creation.webp)

Then move the sub plugins into the main plugin folder:

![](img/sub_plugin_moved.webp)
