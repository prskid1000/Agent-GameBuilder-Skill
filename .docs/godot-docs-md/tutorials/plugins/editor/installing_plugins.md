<span id="doc_installing_plugins"></span>
...
<span id="doc_installing_plugins_enabling_a_plugin"></span>
...
![](img/installing_plugins_project_settings.webp)
