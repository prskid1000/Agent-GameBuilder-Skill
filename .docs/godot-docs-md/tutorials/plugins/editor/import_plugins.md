...
<span id="doc_import_plugins"></span>

## Import plugins

> **Note:** in doubt, refer to the :ref:`doc_making_plugins` page. This also assumes you are acquainted with Godot's import system.
### Introduction
...
[add_import_plugin()](../../../classes/class_editorplugin.md#class_EditorPlugin_method_add_import_plugin) method. We store
a reference to it in a class member `import_plugin` so we can refer to it
later when removing it. The
[remove_import_plugin()](../../../classes/class_editorplugin.md#class_EditorPlugin_method_remove_import_plugin) method is
...
[EditorImportPlugin class](../../../classes/class_editorimportplugin.md#class_EditorImportPlugin). It is responsible for
...
[_get_importer_name()](../../../classes/class_editorimportplugin.md#class_EditorImportPlugin_private_method__get_importer_name). This is a
...
The [_get_visible_name()](../../../classes/class_editorimportplugin.md#class_EditorImportPlugin_private_method__get_visible_name) method is
...
[_get_recognized_extensions()](../../../classes/class_editorimportplugin.md#class_EditorImportPlugin_private_method__get_recognized_extensions)
...
In our case it's a [class_StandardMaterial3D](../../../classes/class_standardmaterial3d.md#class_StandardMaterial3D), which can be applied to 3D
objects.

> **Note:** have to create multiple import plugins. You can abstract the import code on another file to avoid duplication in this regard.
### Options and presets
...
The [_get_preset_count()](../../../classes/class_editorimportplugin.md#class_EditorImportPlugin_private_method__get_preset_count) method
...
Here we have the
[_get_preset_name()](../../../classes/class_editorimportplugin.md#class_EditorImportPlugin_private_method__get_preset_name) method, which
...
[_get_import_options()](../../../classes/class_editorimportplugin.md#class_EditorImportPlugin_private_method__get_import_options) returns
...
> **Warning:** define presets (by making ``_get_preset_count`` return zero). You have to return an array even it's empty, otherwise you can get errors.
::
...
For the
[_get_option_visibility()](../../../classes/class_editorimportplugin.md#class_EditorImportPlugin_private_method__get_option_visibility)
...
resources, is covered by the [_import()](../../../classes/class_editorimportplugin.md#class_EditorImportPlugin_private_method__import)
...
[FileAccess](../../../classes/class_fileaccess.md#class_FileAccess) class to do that, passing the `source_file`
...
Then it creates a new [Color](../../../classes/class_color.md#class_Color) variable and sets its values
...
This part makes a new [StandardMaterial3D](../../../classes/class_standardmaterial3d.md#class_StandardMaterial3D) that is the
...
extension, so we add it using [string formatting](../../scripting/gdscript/gdscript_format_string.md#doc_gdscript_printf). For
...
[ResourceSaver.save()](../../../classes/class_resourcesaver.md#class_ResourceSaver_method_save) method, so if there's an
...
variants, it is based on the presence of [feature tags](../../export/feature_tags.md#doc_feature_tags),
