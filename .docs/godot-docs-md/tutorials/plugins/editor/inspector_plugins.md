<span id="doc_inspector_plugins"></span>
...
This guide explains how to use the [class_EditorInspectorPlugin](../../../classes/class_editorinspectorplugin.md#class_EditorInspectorPlugin) and
[class_EditorProperty](../../../classes/class_editorproperty.md#class_EditorProperty) classes to create a custom interface for integers,
...
.. seealso:: See [doc_making_plugins](making_plugins.md#doc_making_plugins) guide to set up your new plugin.
...
As before, `plugin.gd` is a script extending [class_EditorPlugin](../../../classes/class_editorplugin.md#class_EditorPlugin) and you
...
> **Note:** should use ``new()`` instead of ``instantiate()``.
.. tabs::
```
```
...
extend the [class_EditorInspectorPlugin](../../../classes/class_editorinspectorplugin.md#class_EditorInspectorPlugin) class. This class provides several
...
method. This function is called for each edited [class_Object](../../../classes/class_object.md#class_Object) and must
...
specifically add [class_EditorProperty](../../../classes/class_editorproperty.md#class_EditorProperty)-based controls.
...
The [class_EditorProperty](../../../classes/class_editorproperty.md#class_EditorProperty) class is a special type of [class_Control](../../../classes/class_control.md#class_Control)
...
[class_EditorProperty](../../../classes/class_editorproperty.md#class_EditorProperty):
...
replaces the default [class_SpinBox](../../../classes/class_spinbox.md#class_SpinBox) control for integers with a
[class_Button](../../../classes/class_button.md#class_Button) that generates random values.
