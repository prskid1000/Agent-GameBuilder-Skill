<span id="doc_running_code_in_the_editor"></span>
...
.. danger::
    ...
    [Node.queue_free](../../classes/class_node.md#class_Node_method_queue_free), as it can cause
...
<span id="doc_running_code_in_the_editor_important_information"></span>
...
this are [static variables](../scripting/gdscript/gdscript_basics.md#doc_gdscript_basics_static_variables).
...
[version control](../best_practices/version_control_systems.md#doc_version_control_systems) to avoid losing work in
...
See [doc_overview_of_debugging_tools](../scripting/debug/overview_of_debugging_tools.md#doc_overview_of_debugging_tools) for more information.
...
> **Warning:** You may need to restart the editor. This is a known bug found in all Godot 4 versions: `GH-66381 <https://github.com/godotengine/godot/issues/66381>`_.
...
[update_configuration_warnings](../../classes/class_node.md#class_Node_method_update_configuration_warnings) .
...
<span id="doc_running_code_in_the_editor_editorscript"></span>
...
This is available in Godot by extending [class_EditorScript](../../classes/class_editorscript.md#class_EditorScript) in a script.
...
[EditorInterface.get_edited_scene_root()](../../classes/class_editorinterface.md#class_EditorInterface_method_get_edited_scene_root)
...
[EditorScript.mark_scene_as_unsaved()](../../classes/class_editorinterface.md#class_EditorInterface_method_mark_scene_as_unsaved)
...
[Node.add_child(node)](../../classes/class_node.md#class_Node_method_add_child) are **not** visible
...
the scene, you need to set the child node's [owner](../../classes/class_node.md#class_Node_property_owner)
...
If you are using [EditorScript](../../classes/class_editorscript.md#class_EditorScript):
