<span id="doc_scenes_versus_scripts"></span>
...
- [Custom Types](../plugins/editor/making_plugins.md#doc_making_plugins)
   ...
   - Set up using [EditorPlugin.add_custom_type](../../classes/class_editorplugin.md#class_EditorPlugin_method_add_custom_type).

- [Script Classes](../scripting/gdscript/gdscript_basics.md#doc_gdscript_basics_class_name)
