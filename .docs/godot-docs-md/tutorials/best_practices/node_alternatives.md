<span id="doc_node_alternatives"></span>
...
1. [Object](../../classes/class_object.md#class_Object): The ultimate lightweight object, the original
   Object must use manual memory management. With that said, it isn't too
   difficult to create one's own custom data structures, even node structures,
   that are also lighter than the [Node](../../classes/class_node.md#class_Node) class.

   - **Example:** See the [Tree](../../classes/class_tree.md#class_Tree) node. It supports a high level
     ...
     though is actually a tree of [TreeItem](../../classes/class_treeitem.md#class_TreeItem) Objects.
...
2. [RefCounted](../../classes/class_refcounted.md#class_RefCounted): Only a little more complex than Object.
   ...
   - **Example:** See the [FileAccess](../../classes/class_fileaccess.md#class_FileAccess) object. It functions
     just like a regular Object except that one need not delete it themselves.

   - **Advantages:** same as the Object.

3. [Resource](../../classes/class_resource.md#class_Resource): Only slightly more complex than RefCounted.
   ...
   - **Example:** Scripts, PackedScene (for scene files), and other types like
     each of the [AudioEffect](../../classes/class_audioeffect.md#class_AudioEffect) classes. Each of these
     can be saved and loaded, therefore they extend from Resource.

   - **Advantages:** Much has
     [already been said](../scripting/resources.md#doc_resources)
     on [Resource](../../classes/class_resource.md#class_Resource)'s advantages over traditional data
