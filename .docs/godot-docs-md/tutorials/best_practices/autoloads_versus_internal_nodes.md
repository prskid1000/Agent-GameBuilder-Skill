<span id="doc_autoloads_versus_internal_nodes"></span>
...
[doc_singletons_autoload](../scripting/singletons_autoload.md#doc_singletons_autoload). These autoloaded nodes are not freed when you
change the scene from code with [SceneTree.change_scene_to_file](../../classes/class_scenetree.md#class_SceneTree_method_change_scene_to_file).
...
1. Create a new type of [Resource](../../classes/class_resource.md#class_Resource) to share the data.
