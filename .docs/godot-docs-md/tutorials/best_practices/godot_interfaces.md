<span id="doc_godot_interfaces"></span>
...
For all [Object](../../classes/class_object.md#class_Object)\s, the most basic way of referencing them
...
The same principle applies for [RefCounted](../../classes/class_refcounted.md#class_RefCounted) objects.
While users often access [Node](../../classes/class_node.md#class_Node) and
[Resource](../../classes/class_resource.md#class_Resource) this way, alternative measures are available.
...
3. Keep in mind that loading a resource fetches the cached resource
   ...
   [duplicate](../../classes/class_resource.md#class_Resource_method_duplicate) an existing reference
...
<span id="doc_accessing_data_or_logic_from_object"></span>
...
For example, the [CanvasItem](../../classes/class_canvasitem.md#class_CanvasItem) class has a `visible`
...
[CanvasItem.visible](../../classes/class_canvasitem.md#class_CanvasItem_property_visible), then Godot would do the
...
- If the script does not have the property, it performs a HashMap lookup in
  ...
  [data preferences](data_preferences.md#doc_data_preferences) docs.
...
- A method check. In the case of
  [CanvasItem.visible](../../classes/class_canvasitem.md#class_CanvasItem_property_visible), one can
...
- Outsource the access to a [Callable](../../classes/class_callable.md#class_Callable). These may be useful
