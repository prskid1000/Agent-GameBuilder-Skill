...
<span id="doc_data_preferences"></span>
...
its [script](../../classes/class_script.md#class_Script) or the [ClassDB](../../classes/class_classdb.md#class_ClassDB).
One can find more information about what objects are and how they work in
the [doc_what_are_godot_classes](what_are_godot_classes.md#doc_what_are_godot_classes) article.
...
[AnimatedTexture](../../classes/class_animatedtexture.md#class_AnimatedTexture) is a texture that
...
Godot's [RenderingServer](../../classes/class_renderingserver.md#class_RenderingServer) then draws
...
Also note that AnimatedTexture is a [Resource](../../classes/class_resource.md#class_Resource) unlike
the other [Node](../../classes/class_node.md#class_Node) objects discussed here. One might create
a [Sprite2D](../../classes/class_sprite2d.md#class_Sprite2D) node that uses AnimatedTexture as its texture.
Or (something the others can't do) one could add AnimatedTextures as tiles
in a [TileSet](../../classes/class_tileset.md#class_TileSet) and integrate it with a
[TileMapLayer](../../classes/class_tilemaplayer.md#class_TileMapLayer) for many auto-animating backgrounds that
all render in a single batched draw call.

The [AnimatedSprite2D](../../classes/class_animatedsprite2d.md#class_AnimatedSprite2D) node, in combination with the
[SpriteFrames](../../classes/class_spriteframes.md#class_SpriteFrames) resource, allows one to create a
...
an [AnimationPlayer](../../classes/class_animationplayer.md#class_AnimationPlayer) node in conjunction with
...
their object. These are the cases where the [AnimationTree](../../classes/class_animationtree.md#class_AnimationTree)
shines. One can find an in-depth guide on using the AnimationTree
[here](../animation/animation_tree.md#doc_animation_tree).
