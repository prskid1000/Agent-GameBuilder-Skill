<span id="doc_introduction_best_practices"></span>
...
You should start by reading [doc_what_are_godot_classes](what_are_godot_classes.md#doc_what_are_godot_classes). It explains how
