<span id="doc_godot_notifications"></span>

## Godot notifications

Every Object in Godot implements a
[_notification](../../classes/class_object.md#class_Object_private_method__notification) method. Its purpose is to
...
[CanvasItem](../../classes/class_canvasitem.md#class_CanvasItem) to "draw", it will call
...
- [Object::NOTIFICATION_POSTINITIALIZE](../../classes/class_object.md#class_Object_constant_NOTIFICATION_POSTINITIALIZE):
  a callback that triggers during object initialization. Not accessible to scripts.

- [Object::NOTIFICATION_PREDELETE](../../classes/class_object.md#class_Object_constant_NOTIFICATION_PREDELETE):
...
- [Node::NOTIFICATION_PARENTED](../../classes/class_node.md#class_Node_constant_NOTIFICATION_PARENTED):
  a callback that triggers anytime one adds a child node to another node.

- [Node::NOTIFICATION_UNPARENTED](../../classes/class_node.md#class_Node_constant_NOTIFICATION_UNPARENTED):
...
> **Note:** 
  ...
  [_init](../../classes/class_object.md#class_Object_private_method__init) method in Object. While it has no
...
can use the [PARENTED](../../classes/class_node.md#class_Node_constant_NOTIFICATION_PARENTED) notification.
