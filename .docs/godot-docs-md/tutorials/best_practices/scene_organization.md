<span id="doc_scene_organization"></span>
...
3. Initialize a [Callable](../../classes/class_callable.md#class_Callable) property. Safer than a method
...
> **Warning:** 
  ...
  [Area2D](../../classes/class_area2d.md#class_Area2D) node when it has no child
  [CollisionShape2D](../../classes/class_collisionshape2d.md#class_CollisionShape2D) nodes defined. The editor
...
[Changing scenes manually](../scripting/change_scenes_manually.md#doc_change_scenes_manually) gives you full
...
... then you should create an [autoload 'singleton' node](../scripting/singletons_autoload.md#doc_singletons_autoload).

> **Note:** 
  For smaller games, a simpler alternative with less control would be to have
  a "Game" singleton that simply calls the
  [SceneTree.change_scene_to_file()](../../classes/class_scenetree.md#class_SceneTree_method_change_scene_to_file) method
...
[Autoloads versus regular nodes](autoloads_versus_internal_nodes.md#doc_autoloads_versus_internal_nodes).
...
> **Note:** 
  ...
  [RemoteTransform](../../classes/class_remotetransform3d.md#class_RemoteTransform3D) /
  [RemoteTransform2D](../../classes/class_remotetransform2d.md#class_RemoteTransform2D) nodes for this purpose.
  ...
  [NodePath](../../classes/class_nodepath.md#class_NodePath), use one of the following:
  ...
  1. The **declarative** solution: place a [Node](../../classes/class_node.md#class_Node) in between
  ...
  2. The **imperative** solution: Use the `top_level` property for the
     [CanvasItem](../../classes/class_canvasitem.md#class_CanvasItem_property_top_level) or
     [Node3D](../../classes/class_node3d.md#class_Node3D_property_top_level) node. This will make
