<span id="doc_multiple_resolutions"></span>
...
> **Note:** 
   ...
   This viewport is a [Window](../../classes/class_window.md#class_Window) instance. Recall from the
   [introduction](viewports.md#doc_viewports) that *all* Window objects are viewports.

To configure the stretch base size at runtime from a script, use the
`get_tree().root.content_scale_size` property (see
[Window.content_scale_size](../../classes/class_window.md#class_Window_property_content_scale_size)).
...
[doc_multiple_resolutions_stretch_scale](multiple_resolutions.md#doc_multiple_resolutions_stretch_scale) is recommended as it's easier to
adjust.
...
little easier. The [Viewport](../../classes/class_viewport.md#class_Viewport)
...
.. tip::
    ...
    [resolution scaling](../3d/resolution_scaling.md#doc_resolution_scaling) support. This is a good way
...
and a diagonal [Line2D](../../classes/class_line2d.md#class_Line2D) is added on top of it:
...
-  **Stretch Mode = Viewport**: Viewport scaling means that the size of
   the root [Viewport](../../classes/class_viewport.md#class_Viewport) is set precisely to the
...
[Window.content_scale_mode](../../classes/class_window.md#class_Window_property_content_scale_mode)
and the [ContentScaleMode](../../classes/class_window.md#enum_Window_ContentScaleMode) enum).
...
-  **Stretch Aspect = Keep Width**: Keep aspect ratio when stretching the
   ...
   ([doc_size_and_anchors](../ui/size_and_anchors.md#doc_size_and_anchors)).
...
[Window.content_scale_aspect](../../classes/class_window.md#class_Window_property_content_scale_aspect)
and the [ContentScaleAspect](../../classes/class_window.md#enum_Window_ContentScaleAspect) enum).

<span id="doc_multiple_resolutions_stretch_scale"></span>
...
[Window.content_scale_factor](../../classes/class_window.md#class_Window_property_content_scale_factor)).
...
<span id="doc_multiple_resolutions_stretch_scale_mode"></span>
...
- Alternatively, if you're targeting high-end devices primarily, set the base
  ...
  - Note that this will make non-mipmapped textures grainy on low resolution devices,
    ...
    [doc_multiple_resolutions_reducing_aliasing_on_downsampling](multiple_resolutions.md#doc_multiple_resolutions_reducing_aliasing_on_downsampling).
...
- For 3D games, consider exposing [doc_resolution_scaling](../3d/resolution_scaling.md#doc_resolution_scaling) in the game's options menu
...
<span id="doc_multiple_resolutions_non_game_application"></span>
...
- Add a setting in the application's settings to change the root viewport's
  [stretch scale](multiple_resolutions.md#doc_multiple_resolutions_stretch_scale),
...
[autoload](../scripting/singletons_autoload.md#doc_singletons_autoload)'s `_ready()` function according to
the screen size.
...
- For non-game applications, use the `disabled` stretch mode and set the
  ...
  [autoload](../scripting/singletons_autoload.md#doc_singletons_autoload)'s `_ready()` function.
  The display scale factor is set in the operating system's settings and can be queried
  using [screen_get_scale](../../classes/class_displayserver.md#class_DisplayServer_method_screen_get_scale). This
...
<span id="doc_multiple_resolutions_reducing_aliasing_on_downsampling"></span>
...
To resolve this, you can [enable mipmaps](../assets_pipeline/importing_images.md#doc_importing_images_mipmaps) on
...
done using [anchors](../ui/size_and_anchors.md#doc_size_and_anchors) and/or :ref:`containers
<doc_gui_containers>`.
...
[resolution scaling](../3d/resolution_scaling.md#doc_resolution_scaling) functionality. This allows you to
