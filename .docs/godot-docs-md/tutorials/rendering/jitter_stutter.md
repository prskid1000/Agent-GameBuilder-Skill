<span id="doc_jitter_stutter"></span>
...
[physics interpolation](../physics/interpolation/physics_interpolation_quick_start_guide.md#doc_physics_interpolation_quick_start_guide)
...
[doc_physics_interpolation](../physics/interpolation/index.md#doc_physics_interpolation) documentation for details.
...
[optimization](../performance/general_optimization.md#doc_general_optimization).
...
for the first time. See [doc_pipeline_compilations](../performance/pipeline_compilations.md#doc_pipeline_compilations) for more information.
...
[class_ColorRect](../../classes/class_colorrect.md#class_ColorRect) node) so that it's not visible to the player.
...
<span id="doc_jitter_stutter_input_lag"></span>
...
.. tip::
    ...
    [command line argument](../editor/command_line_tutorial.md#doc_command_line_tutorial) to forcibly disable V-Sync.
