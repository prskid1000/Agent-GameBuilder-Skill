<span id="doc_exporting_for_linux"></span>
...
.. seealso::
    ...
    read [doc_compiling_for_linuxbsd](../../engine_details/development/compiling/compiling_for_linuxbsd.md#doc_compiling_for_linuxbsd).
...
RISC-V and creating export templates can be found on the [doc_compiling_for_linuxbsd](../../engine_details/development/compiling/compiling_for_linuxbsd.md#doc_compiling_for_linuxbsd)
page.
...
[class_EditorExportPlatformLinuxBSD](../../classes/class_editorexportplatformlinuxbsd.md#class_EditorExportPlatformLinuxBSD) class reference.
