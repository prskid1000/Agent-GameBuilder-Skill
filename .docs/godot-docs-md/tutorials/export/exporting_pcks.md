<span id="doc_exporting_pcks"></span>
...
See [doc_exporting_projects_pck_versus_zip](exporting_projects.md#doc_exporting_projects_pck_versus_zip) for a comparison of the two formats.

.. seealso::

    If you want to load loose files at runtime (not packed in a PCK or ZIP by Godot),
    consider using [doc_runtime_loading_and_saving](../io/runtime_file_loading_and_saving.md#doc_runtime_loading_and_saving) instead.
...
Another method would be to [export from the command line](../editor/command_line_tutorial.md#doc_command_line_tutorial_exporting)
...
To do so, create a new [autoload](../scripting/singletons_autoload.md#doc_singletons_autoload) script and
call [ProjectSettings.load_resource_pack()](../../classes/class_projectsettings.md#class_ProjectSettings_method_load_resource_pack)
