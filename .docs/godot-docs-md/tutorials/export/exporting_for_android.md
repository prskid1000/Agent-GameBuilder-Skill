<span id="doc_exporting_for_android"></span>
...
.. seealso::
    ...
    read [doc_compiling_for_android](../../engine_details/development/compiling/compiling_for_android.md#doc_compiling_for_android).
...
![](img/android_editor_settings.webp)
...
only the features you need. See [doc_optimizing_for_size](../../engine_details/development/compiling/optimizing_for_size.md#doc_optimizing_for_size) for more
information.
...
[class_EditorExportPlatformAndroid](../../classes/class_editorexportplatformandroid.md#class_EditorExportPlatformAndroid) class reference.
