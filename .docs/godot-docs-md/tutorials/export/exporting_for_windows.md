<span id="doc_exporting_for_windows"></span>
...
.. seealso::
    ...
    read [doc_compiling_for_windows](../../engine_details/development/compiling/compiling_for_windows.md#doc_compiling_for_windows).
...
resolutions then see the [doc_changing_application_icon_for_windows](changing_application_icon_for_windows.md#doc_changing_application_icon_for_windows) page.

<span id="doc_exporting_for_windows_code_signing"></span>
...
![](img/windows_editor_settings.webp)
...
![](img/windows_export_codesign.webp)
...
[class_EditorExportPlatformWindows](../../classes/class_editorexportplatformwindows.md#class_EditorExportPlatformWindows) class reference.
