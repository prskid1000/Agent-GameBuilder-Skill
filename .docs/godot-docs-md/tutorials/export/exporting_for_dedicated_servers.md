<span id="doc_exporting_for_dedicated_servers"></span>
...
See [doc_exporting_projects](exporting_projects.md#doc_exporting_projects) for more information.

<span id="doc_exporting_for_dedicated_servers_exporting_project"></span>
...
If you [exported the project](exporting_for_dedicated_servers.md#doc_exporting_for_dedicated_servers_exporting_project)
