...
- **Android:** Exports the project with debugging enabled and runs it on the
  connected device.
   ...
   - Make sure to follow the steps described in [doc_exporting_for_android](exporting_for_android.md#doc_exporting_for_android).
...
- **iOS:** Exports the project with debugging enabled and runs it on the
  connected device.
   ...
   - Make sure to follow the steps described in [doc_exporting_for_ios](exporting_for_ios.md#doc_exporting_for_ios).
     Otherwise, the one-click deploy button won't appear.
