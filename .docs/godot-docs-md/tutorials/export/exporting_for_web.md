<span id="doc_exporting_for_web"></span>
...
.. seealso::
    ...
    read [doc_compiling_for_web](../../engine_details/development/compiling/compiling_for_web.md#doc_compiling_for_web).

HTML5 export allows publishing games made in Godot Engine to the browser.
This requires support for `WebAssembly
<https://webassembly.org/>`__ and WebGL 2.0
...
[Android](exporting_for_android.md#doc_exporting_for_android) and [iOS](exporting_for_ios.md#doc_exporting_for_ios)
...
WebAssembly instead of native code). See [doc_performance](../performance/index.md#doc_performance) section of the
documentation for advice on optimizing your project. If your project runs on
platforms other than Web, you can use [doc_feature_tags](feature_tags.md#doc_feature_tags) to apply
...
[compile an optimized export template](../../engine_details/development/compiling/optimizing_for_size.md#doc_optimizing_for_size)
...
<span id="doc_exporting_for_web_audio_playback"></span>
...
- [Reverberation and doppler](../audio/audio_streams.md#doc_audio_streams_reverb_buses) effects are not supported.
...
[class_AudioStreamPlayer](../../classes/class_audiostreamplayer.md#class_AudioStreamPlayer), [class_AudioStreamPlayer2D](../../classes/class_audiostreamplayer2d.md#class_AudioStreamPlayer2D) or
[class_AudioStreamPlayer3D](../../classes/class_audiostreamplayer3d.md#class_AudioStreamPlayer3D) node. This leads to increased latency
(especially when thread support is disabled), but it allows the full suite
of Godot's audio features to work.

<span id="doc_javascript_export_options"></span>
...
If you plan to use [VRAM compression](../assets_pipeline/importing_images.md#doc_importing_images) make sure that
...
the default HTML page. See [doc_customizing_html5_shell](../platform/web/customizing_html5_shell.md#doc_customizing_html5_shell).
...
[project settings](../rendering/multiple_resolutions.md#doc_multiple_resolutions).
...
<span id="doc_exporting_for_web_thread_extension_support"></span>

Thread and extension support
~~~~~~~~~~~~~~~~~~~~~~~~~~~~

If **Thread Support** is enabled, the exported project will be able to
[make use of multithreading](../performance/using_multiple_threads.md#doc_using_multiple_threads) to improve
...
[doc_exporting_for_web_serving_the_files](exporting_for_web.md#doc_exporting_for_web_serving_the_files) section below.

If **Extensions Support** is enabled, [GDExtensions](../scripting/gdextension/what_is_gdextension.md#doc_what_is_gdextension)
...
<span id="doc_javascript_secure_contexts"></span>
...
Querying the [class_Input](../../classes/class_input.md#class_Input) singleton is not sufficient, the relevant
...
[customization of the HTML page](../platform/web/customizing_html5_shell.md#doc_customizing_html5_shell).
...
> **Warning:** :ref:`secure context <doc_javascript_secure_contexts>`.
...
Currently, only [HTTP client](../networking/http_client_class.md#doc_http_client_class),
[HTTP requests](../networking/http_request_class.md#doc_http_request_class),
[WebSocket (client)](../networking/websocket.md#doc_websocket) and [WebRTC](../networking/webrtc.md#doc_webrtc) are
supported.
...
> **Warning:** 
<span id="doc_exporting_for_web_serving_the_files"></span>
...
used, see [doc_customizing_html5_shell](../platform/web/customizing_html5_shell.md#doc_customizing_html5_shell).
...
> **Warning:** Delivering the WebAssembly module (``.wasm``) with a MIME-type other than :mimetype:`application/wasm` can prevent some start-up optimizations.
...
See the [dedicated page](../platform/web/javascript_bridge.md#doc_web_javascript_bridge) on how to interact
...
<span id="doc_exporting_for_web_troubleshooting"></span>
...
[class_EditorExportPlatformWeb](../../classes/class_editorexportplatformweb.md#class_EditorExportPlatformWeb) class reference.
