<span id="doc_android_gradle_build"></span>
...
you need to follow the steps in [exporting for android](exporting_for_android.md#doc_exporting_for_android)
...
![](img/gradle_build_install_template.webp)
