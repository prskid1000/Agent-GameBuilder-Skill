<span id="doc_exporting_projects"></span>
...
[creating DLCs as extra package files](exporting_pcks.md#doc_exporting_pcks).
...
![](img/export_templates.webp)

<span id="doc_exporting_projects_export_mode"></span>
...
.. seealso::
    ...
    See [doc_command_line_tutorial](../editor/command_line_tutorial.md#doc_command_line_tutorial) for more information about using Godot
    from the command line.

<span id="doc_exporting_projects_pck_versus_zip"></span>
