<span id="doc_bbcode_in_richtextlabel"></span>

## BBCode in RichTextLabel

### Introduction

[class_Label](../../classes/class_label.md#class_Label) nodes are great for displaying basic text, but they have limitations.
...
of the text centered. To get around these limitations, you would use a [class_RichTextLabel](../../classes/class_richtextlabel.md#class_RichTextLabel).

[class_RichTextLabel](../../classes/class_richtextlabel.md#class_RichTextLabel) allows for complex formatting of text using a markup syntax or
...
- BBCode can be used to [format comments in the XML source of the class reference](../../engine_details/class_reference/index.md#doc_class_reference_bbcode).
- BBCode can be used in [GDScript documentation comments](../scripting/gdscript/gdscript_documentation_comments.md#doc_gdscript_documentation_comments_bbcode_and_class_reference).
- BBCode can be used when [printing rich text to the Output bottom panel](../scripting/debug/output_panel.md#doc_output_panel_printing_rich_text).
...
By default, [class_RichTextLabel](../../classes/class_richtextlabel.md#class_RichTextLabel) functions like a normal [class_Label](../../classes/class_label.md#class_Label).
It has the [property_text](../../classes/class_richtextlabel.md#class_RichTextLabel_property_text) property, which you can
edit to have uniformly formatted text. To be able to use BBCode for rich text formatting,
you need to turn on the BBCode mode by setting [bbcode_enabled](../../classes/class_richtextlabel.md#class_RichTextLabel_property_bbcode_enabled).
After that, you can edit the [text](../../classes/class_richtextlabel.md#class_RichTextLabel_property_text)
...
![](img/bbcode_in_richtextlabel_inspector.webp)

For example, `BBCode [color=green]test[/color]` would render the word "test" with
a green color.

![](img/bbcode_in_richtextlabel_basic_example.webp)
...
<span id="doc_bbcode_in_richtextlabel_handling_user_input_safely"></span>
...
> **Note:** Removing BBCode tags entirely isn't advised for user input, as it can modify the displayed text without users understanding why part of their message was removed. :ref:`Escaping user input <doc_bbcode_in_richtextlabel_handling_user_input_safely>` should be preferred instead.
### Performance
...
<span id="doc_bbcode_in_richtextlabel_use_functions"></span>
...
[RichTextLabel class reference](../../classes/class_richtextlabel.md#class_RichTextLabel) for a complete list of
`push_[tag]()` functions.
...
.. seealso::
    ...
    *Some* of these BBCode tags can be used in tooltips for `@export` script
    ...
    information, see [Class reference BBCode](../../engine_details/class_reference/index.md#doc_class_reference_bbcode).
...
.. list-table::
  ...
  * - | **p**
      | Adds new paragraph with `{text}`. Supports configuration options,
        see [doc_bbcode_in_richtextlabel_paragraph_options](bbcode_in_richtextlabel.md#doc_bbcode_in_richtextlabel_paragraph_options).
  ...
  * - | **hr**
      | Adds new a horizontal rule to separate content. Supports configuration options,
        see [doc_bbcode_in_richtextlabel_hr_options](bbcode_in_richtextlabel.md#doc_bbcode_in_richtextlabel_hr_options).
  ...
  * - | **url**
      | Creates a hyperlink (underlined and clickable text). Can contain optional
        ...
        see [doc_bbcode_in_richtextlabel_url_options](bbcode_in_richtextlabel.md#doc_bbcode_in_richtextlabel_url_options).
      | **Must be handled with the "meta_clicked" signal to have an effect,** see [doc_bbcode_in_richtextlabel_handling_url_tag_clicks](bbcode_in_richtextlabel.md#doc_bbcode_in_richtextlabel_handling_url_tag_clicks).
  ...
  * - | **img**
      | Inserts an image from the `{path}` (can be any valid [class_Texture2D](../../classes/class_texture2d.md#class_Texture2D) resource).
      ...
      | If `{valign}` configuration is provided, the image will try to align to the
        surrounding text, see [doc_bbcode_in_richtextlabel_image_and_table_alignment](bbcode_in_richtextlabel.md#doc_bbcode_in_richtextlabel_image_and_table_alignment).
      | Supports configuration options, see [doc_bbcode_in_richtextlabel_image_options](bbcode_in_richtextlabel.md#doc_bbcode_in_richtextlabel_image_options).
  ...
  * - | **font**
      ...
      | Supports configuration options, see [doc_bbcode_in_richtextlabel_font_options](bbcode_in_richtextlabel.md#doc_bbcode_in_richtextlabel_font_options).
  ...
  * - | **lang**
      | Overrides the language for `{text}` that is set by the **BiDi > Language** property
        in [class_RichTextLabel](../../classes/class_richtextlabel.md#class_RichTextLabel). `{code}` must be an ISO [language code](../i18n/locales.md#doc_locales).
  ...
  * - | **color**
      | Changes the color of `{text}`. Color must be provided by a common name (see
        [doc_bbcode_in_richtextlabel_named_colors](bbcode_in_richtextlabel.md#doc_bbcode_in_richtextlabel_named_colors)) or using the HEX format (e.g.
        `#ff00ff`, see [doc_bbcode_in_richtextlabel_hex_colors](bbcode_in_richtextlabel.md#doc_bbcode_in_richtextlabel_hex_colors)).
  ...
  * - | **cell**
      ...
      | Supports configuration options, see [doc_bbcode_in_richtextlabel_cell_options](bbcode_in_richtextlabel.md#doc_bbcode_in_richtextlabel_cell_options).
  ...
  * - | **ul**
      ...
      | The bullet point can be customized using the `{bullet}` parameter,
        see [doc_bbcode_in_richtextlabel_unordered_list_bullet](bbcode_in_richtextlabel.md#doc_bbcode_in_richtextlabel_unordered_list_bullet).

    - | `[ul]{items}[/ul]`
      | `[ul bullet={bullet}]{items}[/ul]`

  * - | **ol**
      | Adds an ordered (numbered) list of the given `{type}` (see [doc_bbcode_in_richtextlabel_list_types](bbcode_in_richtextlabel.md#doc_bbcode_in_richtextlabel_list_types)).
...
<span id="doc_bbcode_in_richtextlabel_paragraph_options"></span>
...
- **justification_flags**, **jst**
  ...
  Justification (fill alignment) option. See [class_TextServer](../../classes/class_textserver.md#class_TextServer) for more details.
...
- **language**, **lang**
  ...
  +-----------+--------------------------------------------+
  | `Values`  | ISO language codes. See [doc_locales](../i18n/locales.md#doc_locales) |
  +-----------+--------------------------------------------+
  | `Default` | Inherit                                    |
  +-----------+--------------------------------------------+
...
<span id="doc_bbcode_in_richtextlabel_handling_url_tag_clicks"></span>
...
[meta_clicked](../../classes/class_richtextlabel.md#class_RichTextLabel_signal_meta_clicked) signal to a script function.
...
<span id="doc_bbcode_in_richtextlabel_hr_options"></span>
...
<span id="doc_bbcode_in_richtextlabel_url_options"></span>
...
<span id="doc_bbcode_in_richtextlabel_image_options"></span>
...
- **alt**
  ...
  +-----------+------------------------------------------------------------------------+
  | `Values`  | see [doc_bbcode_in_richtextlabel_image_and_table_alignment](bbcode_in_richtextlabel.md#doc_bbcode_in_richtextlabel_image_and_table_alignment)       |
  +-----------+------------------------------------------------------------------------+
...
<span id="doc_bbcode_in_richtextlabel_image_and_table_alignment"></span>
...
![](img/bbcode_in_richtextlabel_image_align.webp)
...
![](img/bbcode_in_richtextlabel_table_align.webp)
...
<span id="doc_bbcode_in_richtextlabel_font_options"></span>
...
<span id="doc_bbcode_in_richtextlabel_named_colors"></span>

Named colors
~~~~~~~~~~~~

For tags that allow specifying a color by name, you can use names of the constants from
the built-in [class_Color](../../classes/class_color.md#class_Color) class. Named classes can be specified in a number of
...
<span id="doc_bbcode_in_richtextlabel_hex_colors"></span>
...
<span id="doc_bbcode_in_richtextlabel_cell_options"></span>
...
<span id="doc_bbcode_in_richtextlabel_unordered_list_bullet"></span>
...
<span id="doc_bbcode_in_richtextlabel_list_types"></span>
...
[when the SceneTree is paused](../scripting/pausing_games.md#doc_pausing_games). You can change this
...
![](img/bbcode_in_richtextlabel_effect_pulse.webp)
...
![](img/bbcode_in_richtextlabel_effect_wave.webp)
...
![](img/bbcode_in_richtextlabel_effect_tornado.webp)
...
![](img/bbcode_in_richtextlabel_effect_shake.webp)
...
![](img/bbcode_in_richtextlabel_effect_fade.webp)
...
![](img/bbcode_in_richtextlabel_effect_rainbow.webp)
...
You can extend the [class_RichTextEffect](../../classes/class_richtexteffect.md#class_RichTextEffect) resource type to create your own custom
BBCode tags. Create a new script file that extends the [class_RichTextEffect](../../classes/class_richtexteffect.md#class_RichTextEffect) resource type
...
[install_effect()](../../classes/class_richtextlabel.md#class_RichTextLabel_method_install_effect) method:
...
during the draw phase of text rendering. This passes in a [class_CharFXTransform](../../classes/class_charfxtransform.md#class_CharFXTransform)
...
- Finally, `env` is a [class_Dictionary](../../classes/class_dictionary.md#class_Dictionary) of parameters assigned to a given custom
  effect. You can use [get()](../../classes/class_dictionary.md#class_Dictionary_method_get) with an optional default value
