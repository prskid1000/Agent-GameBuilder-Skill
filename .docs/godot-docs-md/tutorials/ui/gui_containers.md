<span id="doc_gui_containers"></span>

## Using Containers

[Anchors](size_and_anchors.md#doc_size_and_anchors) are an efficient way to handle
...
For that, [Containers](../../classes/class_container.md#class_container) are more useful.
...
When a [Container](../../classes/class_container.md#class_Container)-derived node is used, all children [Control](../../classes/class_control.md#class_Control) nodes give up their
...
![](img/container_sizing_options.webp)
...
Arranges child controls vertically or horizontally (via [HBoxContainer](../../classes/class_hboxcontainer.md#class_HBoxContainer) and
[VBoxContainer](../../classes/class_vboxcontainer.md#class_VBoxContainer)). In the opposite of the designated direction
...
Arranges child controls in a grid layout (via [GridContainer](../../classes/class_gridcontainer.md#class_GridContainer), amount
...
[MarginContainer](../../classes/class_margincontainer.md#class_MarginContainer)). Padding will be added on the margins
...
[TabContainer](../../classes/class_tabcontainer.md#class_TabContainer)), with only the *current* one visible.
...
(via [HSplitContainer](../../classes/class_hsplitcontainer.md#class_HSplitContainer) and [VSplitContainer](../../classes/class_vsplitcontainer.md#class_VSplitContainer)).
...
(via [PanelContainer](../../classes/class_panelcontainer.md#class_PanelContainer), respecting the *StyleBox* margins).
...
(via [FoldableContainer](../../classes/class_foldablecontainer.md#class_FoldableContainer)).
...
to allow panning the node around (via [ScrollContainer](../../classes/class_scrollcontainer.md#class_ScrollContainer)). Both
...
(via [AspectRatioContainer](../../classes/class_aspectratiocontainer.md#class_AspectRatioContainer)).
...
![](img/containers_aspectratio.webp)
...
![](img/containers_hflow_drag.webp)
...
(via [CenterContainer](../../classes/class_centercontainer.md#class_CenterContainer)).

![](img/containers_center.webp)

![](img/containers_center_drag.webp)

SubViewportContainer
~~~~~~~~~~~~~~~~~~~~

This is a special control that will only accept a single *Viewport* node as child, and it will display
it as if it was an image (via [SubViewportContainer](../../classes/class_subviewportcontainer.md#class_SubViewportContainer)).
