<span id="doc_gui_theme_type_variations"></span>

## Theme type variations

When designing a user interface there may be times when a [Control](../../classes/class_control.md#class_Control) node
needs to have a different look than what is normally defined by a [Theme](../../classes/class_theme.md#class_Theme).
...
between several controls. Imagine that you use gray, blue, and red variants of [Button](../../classes/class_button.md#class_Button)
throughout your project. Setting it up every time you add a new button element to your interface
is a tedious task.

To help with the organization and to better utilize the [power of themes](gui_skinning.md#doc_gui_skinning)
...
> **Note:** 
   ...
   theme is better described in the [Customizing a project](gui_skinning.md#doc_gui_theme_in_project)
