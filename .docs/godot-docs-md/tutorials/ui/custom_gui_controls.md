...
<span id="doc_custom_gui_controls"></span>
...
For drawing, it is recommended to check the [doc_custom_drawing_in_2d](../2d/custom_drawing_in_2d.md#doc_custom_drawing_in_2d) tutorial.
...
[Control.size](../../classes/class_control.md#class_Control_property_size)
...
[Control.focus_mode](../../classes/class_control.md#class_Control_property_focus_mode)
...
status, the [Control.has_focus()](../../classes/class_control.md#class_Control_method_has_focus) method
exists. Example
...
each other using a [VBoxContainer](../../classes/class_vboxcontainer.md#class_VBoxContainer),
...
[Control._get_minimum_size()](../../classes/class_control.md#class_Control_private_method__get_minimum_size),
for example:
...
This function is
[Control._gui_input()](../../classes/class_control.md#class_Control_private_method__gui_input).
...
For more information about events themselves, check the [doc_inputevent](../inputs/inputevent.md#doc_inputevent)
tutorial.
