<span id="doc_gui_navigation"></span>
...
Every [Control](../../classes/class_control.md#class_Control) node in Godot is capable of having focus.
...
example, [Label](../../classes/class_label.md#class_Label) nodes are set to "None" by default,
while [buttons](../../classes/class_button.md#class_Button) are set to "All".
...
You can use the [Control.grab_focus()](../../classes/class_control.md#class_Control_method_grab_focus) method
