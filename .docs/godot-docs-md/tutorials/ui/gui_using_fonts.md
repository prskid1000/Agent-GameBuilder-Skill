<span id="doc_gui_using_fonts"></span>
...
> **Warning:** 
   ...
   by setting [CanvasItem.texture_filter](../../classes/class_canvasitem.md#class_CanvasItem_property_texture_filter).
...
to [class_Label3D](../../classes/class_label3d.md#class_Label3D).
...
[class_Label](../../classes/class_label.md#class_Label) and [class_RichTextLabel](../../classes/class_richtextlabel.md#class_RichTextLabel). Additionally, font shadows
...
.. tip::
    ...
    [class_LabelSettings](../../classes/class_labelsettings.md#class_LabelSettings) resource that you reuse across Label nodes. This
    resource takes priority over [theme properties](gui_skinning.md#doc_gui_skinning).

### Advanced font features

<span id="doc_using_fonts_antialiasing"></span>
...
> **Note:** Antialiasing cannot be changed on :ref:`MSDF-rendered fonts <doc_using_fonts_msdf>` – these are always rendered with grayscale antialiasing.
<span id="doc_using_fonts_hinting"></span>
...
<span id="doc_using_fonts_mipmaps"></span>
...
can be especially noticeable with [doc_3d_text](../3d/3d_text.md#doc_3d_text) that doesn't have **Fixed
Size** enabled. This can also occur when displaying text with a traditional rasterized
(non-[MSDF](gui_using_fonts.md#doc_using_fonts_msdf)) font in a Control node that has its scale
lower than `(1, 1)`.
...
<span id="doc_using_fonts_msdf"></span>
...
- Rendering new glyphs for the first time *at small font sizes* may be more
  ...
  [doc_using_fonts_font_prerendering](gui_using_fonts.md#doc_using_fonts_font_prerendering) can be used to alleviate this.
...
<span id="doc_using_fonts_emoji"></span>
...
[fallbacks](gui_using_fonts.md#doc_using_fonts_font_fallbacks)) needs to include them.
...
[fallback font](gui_using_fonts.md#doc_using_fonts_font_fallbacks) that points to the
...
with [doc_3d_text](../3d/3d_text.md#doc_3d_text) and TextMesh.
...
the `img` tag in [RichTextLabel](bbcode_in_richtextlabel.md#doc_bbcode_in_richtextlabel). Unlike
...
specify the icon font as a [fallback](gui_using_fonts.md#doc_using_fonts_font_fallbacks).
...
> **Note:** Font fallbacks can also be defined on a local basis similar to :ref:`doc_using_fonts_opentype_font_features`, but this is not covered here for brevity reasons.
<span id="doc_using_fonts_variable_fonts"></span>
...
To use a variable font, create a [class_FontVariation](../../classes/class_fontvariation.md#class_FontVariation) resource in the
...
increases distribution size. A single [variable font](gui_using_fonts.md#doc_using_fonts_variable_fonts)
...
Faux bold and italic is automatically used in [class_RichTextLabel](../../classes/class_richtextlabel.md#class_RichTextLabel)'s bold
...
- **Top:** Additional spacing above glyphs. This is used for multiline text,
  but also to calculate the minimum size of controls such as [class_Label](../../classes/class_label.md#class_Label)
  and [class_Button](../../classes/class_button.md#class_Button).
...
<span id="doc_using_fonts_opentype_font_features"></span>
...
[variable font](gui_using_fonts.md#doc_using_fonts_variable_fonts), then load a font file
...
<span id="doc_using_fonts_system_fonts"></span>
...
[Using emoji](gui_using_fonts.md#doc_using_fonts_emoji) section.

Create a [class_SystemFont](../../classes/class_systemfont.md#class_SystemFont) resource in the location where you desire to
use the system font:
...
See [Runtime loading and saving](../io/runtime_file_loading_and_saving.md#doc_runtime_file_loading_and_saving_fonts)
for details.

<span id="doc_using_fonts_font_prerendering"></span>
...
[internationalization](../i18n/internationalizing_games.md#doc_internationalizing_games). Otherwise, stick to
...
.. tip::
    ...
    If your project supports [internationalization](../i18n/internationalizing_games.md#doc_internationalizing_games),
...
- **Default Font Antialiasing:** Controls the
  [antialiasing](gui_using_fonts.md#doc_using_fonts_antialiasing) method used
  for the default project font.
- **Default Font Hinting:** Controls the
  [hinting](gui_using_fonts.md#doc_using_fonts_hinting) method used for
  the default project font.
- **Default Font Subpixel Positioning:** Controls the
  [subpixel positioning](gui_using_fonts.md#doc_using_fonts_subpixel_positioning)
  method for the default project font.
- **Default Font Multichannel Signed Distance Field:** If `true`, makes the
  default project font use [MSDF font rendering](gui_using_fonts.md#doc_using_fonts_msdf) instead
  of traditional rasterization.
- **Default Font Generate Mipmaps:** If `true`, enables
  [mipmap](gui_using_fonts.md#doc_using_fonts_mipmaps) generation and
