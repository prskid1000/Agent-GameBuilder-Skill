<span id="doc_gui_using_theme_editor"></span>
...
basics behind GUI skinning/theming by reading [doc_gui_skinning](gui_skinning.md#doc_gui_skinning) before starting.

The theme editor is a bottom panel tool that activates automatically, when
a [Theme](../../classes/class_theme.md#class_Theme) resource is selected for editing. It contains
...
Same applies to the contents of complex resource types, such as [StyleBoxes](../../classes/class_stylebox.md#class_StyleBox)
