<span id="doc_gui_skinning"></span>

## Introduction to GUI skinning

It is essential for a game to provide clear, informative, and yet visually
pleasing user interface to its players. While [Control](../../classes/class_control.md#class_Control)
...
The skinning system is driven by the [Theme](../../classes/class_theme.md#class_Theme) resource. Every
...
[your own custom controls](custom_gui_controls.md#doc_custom_gui_controls).
...
> **Note:** 
   ...
   as explained [below](gui_skinning.md#doc_gui_theme_in_project).
...
-  **Color**
   ...
   A [color](../../classes/class_color.md#class_Color) value, which is often used for fonts
...
-  **Constant**
   ...
   controls (such as the item separation in a [BoxContainer](../../classes/class_boxcontainer.md#class_BoxContainer)),
   or for boolean flags (such as the drawing of relationship lines in a [Tree](../../classes/class_tree.md#class_Tree)).

-  **Font**

   A [font](../../classes/class_font.md#class_Font) resource, which is used by controls that
...
-  **Icon**
   ...
   A [texture](../../classes/class_texture2d.md#class_Texture2D) resource, which is normally used
   to display an icon (on a [Button](../../classes/class_button.md#class_Button), for example).

-  **StyleBox**

   A [StyleBox](../../classes/class_stylebox.md#class_StyleBox) resource, a collection of configuration
   options which define the way a UI panel should be displayed. This is
   not limited to the [Panel](../../classes/class_panel.md#class_Panel) control, as styleboxes
...
[dedicated article](gui_theme_type_variations.md#doc_gui_theme_type_variations).
...
essential. Nodes such as [BoxContainer](../../classes/class_boxcontainer.md#class_BoxContainer) and
[GridContainer](../../classes/class_gridcontainer.md#class_GridContainer) use theme constants for defining
separation between their children, and [MarginContainer](../../classes/class_margincontainer.md#class_MarginContainer)
...
<span id="doc_gui_theme_in_project"></span>
...
a [theme](../../classes/class_control.md#class_Control_property_theme) property, which allows you to set a
