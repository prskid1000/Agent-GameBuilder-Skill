<span id="doc_custom_drawing_in_2d"></span>
...
[Control](../../classes/class_control.md#class_Control) or [Node2D](../../classes/class_node2d.md#class_Node2D)-based)
...
Add a script to any [CanvasItem](../../classes/class_canvasitem.md#class_CanvasItem)
derived node, like [Control](../../classes/class_control.md#class_Control) or
[Node2D](../../classes/class_node2d.md#class_Node2D). Then override the
[_draw()](../../classes/class_canvasitem.md#class_CanvasItem_private_method__draw) function.
...
Draw commands are described in the [CanvasItem](../../classes/class_canvasitem.md#class_CanvasItem)
class reference. There are plenty of them and we will see some of them
in the examples below.

### Updating

The [_draw](../../classes/class_canvasitem.md#class_CanvasItem_private_method__draw) function is only called
...
call [CanvasItem.queue_redraw](../../classes/class_canvasitem.md#class_CanvasItem_method_queue_redraw)
...
[setter](../scripting/gdscript/gdscript_basics.md#doc_gdscript_basics_setters_getters), it forces a redraw
...
call [queue_redraw](../../classes/class_canvasitem.md#class_CanvasItem_method_queue_redraw)
from the [_process](../../classes/class_node.md#class_Node_private_method__process) method, like this:
...
[draw_set_transform](../../classes/class_canvasitem.md#class_CanvasItem_method_draw_set_transform) or
[draw_set_transform_matrix](../../classes/class_canvasitem.md#class_CanvasItem_method_draw_set_transform_matrix).

When using [draw_line](../../classes/class_canvasitem.md#class_CanvasItem_method_draw_line), you should
...
The same applies to the [draw_rect](../../classes/class_canvasitem.md#class_CanvasItem_method_draw_rect)
...
Godot offers method parameters in [draw_line](../../classes/class_canvasitem.md#class_CanvasItem_method_draw_line)
...
on specific elements. See [doc_2d_antialiasing](2d_antialiasing.md#doc_2d_antialiasing) for more information.
...
![](img/draw_antialiasing_options.webp)
...
To do this, you can use the [tool annotation](../scripting/gdscript/gdscript_basics.md#doc_gdscript_tool_mode)
on both GDScript and C#. See
[the example below](custom_drawing_in_2d.md#doc_draw_show_drawing_while_editing_example) and
[doc_running_code_in_the_editor](../plugins/running_code_in_the_editor.md#doc_running_code_in_the_editor) for more information.

<span id="doc_draw_custom_example_1"></span>
...
[Polygon2D](../../classes/class_polygon2d.md#class_Polygon2D)), we will use in this case exclusively lower
...
[draw_polygon](../../classes/class_canvasitem.md#class_CanvasItem_method_draw_polygon)
...
![](img/draw_godot_logo_polygon.webp)
...
[example 2](custom_drawing_in_2d.md#doc_draw_custom_example_2)).
...
[draw_polyline](../../classes/class_canvasitem.md#class_CanvasItem_method_draw_polyline) to actually
...
![](img/draw_godot_logo_polyline.webp)
...
code or a predefined color name. Check the class [Color](../../classes/class_color.md#class_Color) for other
...
[draw_circle](../../classes/class_canvasitem.md#class_CanvasItem_method_draw_circle) method. The first
parameter is a [Vector2](../../classes/class_vector2.md#class_Vector2) with the coordinates of its center, the second is
...
[draw_line](../../classes/class_canvasitem.md#class_CanvasItem_method_draw_line) can be used to draw
...
the [draw_multiline](../../classes/class_canvasitem.md#class_CanvasItem_method_draw_multiline) method.

Drawing text
~~~~~~~~~~~~

While using the [Label](../../classes/class_label.md#class_Label) Node is the most common way to add
...
We will use the [draw_string](../../classes/class_canvasitem.md#class_CanvasItem_method_draw_string) method
to do it, like this:
...
![](img/draw_godot_logo_text.webp)

Additional parameters as well as other methods related to text and characters
can be found on the [CanvasItem](../../classes/class_canvasitem.md#class_CanvasItem) class reference.

<span id="doc_draw_show_drawing_while_editing_example"></span>
...
[@tool](../scripting/gdscript/gdscript_basics.md#doc_gdscript_tool_mode) annotation to request the custom drawing
...
[draw_set_transform](../../classes/class_canvasitem.md#class_CanvasItem_method_draw_set_transform)
...
![](img/draw_godot_mouth_animation.webp)
...
standard and high-level methods such as a [Tween](../../classes/class_tween.md#class_Tween) or an
[AnimationPlayer](../../classes/class_animationplayer.md#class_AnimationPlayer) Node. The only difference is
that a `queue_redraw()` call is needed to apply those changes so they get
shown on screen.

<span id="doc_draw_custom_example_2"></span>
...
[sprites](../../classes/class_sprite2d.md#class_Sprite2D) or
[AnimatedSprites](../../classes/class_animatedsprite2d.md#class_AnimatedSprite2D) loading SVG resources (which are
also images defined with vectors) and the
[AnimationPlayer](../../classes/class_animationplayer.md#class_AnimationPlayer) node.
...
[get_mouse_position](../../classes/class_viewport.md#class_Viewport_method_get_mouse_position). If the
...
![](img/draw_line_between_2_points.webp)
...
![](img/draw_dynamic_exported_properties.webp)

To draw the arc, we can use the method
[draw_arc](../../classes/class_canvasitem.md#class_CanvasItem_method_draw_arc). There are many
...
![](img/draw_arc_between_2_points.webp)
