...
.. seealso:: If you are interested in displaying 3D meshes on a 2D viewport, see the [doc_viewport_as_texture](../shaders/using_viewport_as_texture.md#doc_viewport_as_texture) tutorial.
