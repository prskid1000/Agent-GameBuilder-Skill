<span id="doc_using_tilemaps"></span>
...
.. seealso::
    ...
    please read [doc_using_tilesets](using_tilesets.md#doc_using_tilesets) first as you will need a TileSet
    to create a TileMap.

### Introduction

A tilemap is a grid of tiles used to create a game's layout. There are several
benefits to using [TileMapLayer](../../classes/class_tilemaplayer.md#class_TileMapLayer) nodes to design your levels.
First, they make it possible to draw the layout by "painting" the tiles onto a
grid, which is much faster than placing individual [Sprite2D](../../classes/class_sprite2d.md#class_Sprite2D)
...
If you've followed the previous page on [doc_using_tilesets](using_tilesets.md#doc_using_tilesets), you should
...
.. tip::
    ...
    After designing the TileMap consider baking it to a more optimized navigation mesh (and disabling the TileMap NavigationLayer) using a [NavigationRegion2D](../../classes/class_navigationregion2d.md#class_NavigationRegion2D) or the [NavigationServer2D](../../classes/class_navigationserver2d.md#class_NavigationServer2D). See [doc_navigation_using_navigationmeshes](../navigation/navigation_using_navigationmeshes.md#doc_navigation_using_navigationmeshes) for additional information.
...
> **Note:** You can create, rename or reorder layers in the future without affecting existing tiles. Be careful though, as *removing* a layer will also remove all tiles that were placed on the layer.
...
[doc_using_tilesets_creating_terrain_sets](using_tilesets.md#doc_using_tilesets_creating_terrain_sets) if you haven't created a terrain
