<span id="doc_particle_process_material_2d"></span>
...
> **Note:** 
  ...
  For information on how to use it in a 3D scene see [doc_process_material_properties](../3d/particles/process_material_properties.md#doc_process_material_properties).
...
the same amount of time, set by the [Lifetime](../3d/particles/properties.md#doc_3d_particles_properties_time) property. A value of `1` means
...
<span id="doc_particle_systems_2d_animation"></span>

Animation
~~~~~~~~~

> **Note:** Particle flipbook animation is only effective if the CanvasItemMaterial used on the GPUParticles2D or CPUParticles2D node has been :ref:`configured accordingly <doc_particle_systems_2d_using_flipbook>`.
...
> **Note:** The "Load Emission Mask" menu should always be used instead.
