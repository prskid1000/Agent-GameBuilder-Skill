...
<span id="doc_particle_systems_2d"></span>
...
Godot provides two different nodes for 2D particles, [class_GPUParticles2D](../../classes/class_gpuparticles2d.md#class_GPUParticles2D)
and [class_CPUParticles2D](../../classes/class_cpuparticles2d.md#class_CPUParticles2D). GPUParticles2D is more advanced and uses the
...
While GPUParticles2D is configured via a [class_ParticleProcessMaterial](../../classes/class_particleprocessmaterial.md#class_ParticleProcessMaterial)
...
<span id="doc_particle_systems_2d_using_flipbook"></span>
...
<https://www.blender.org/>`__ or EmberGen.
...
Once this is done, the [Animation section](particle_process_material_2d.md#doc_particle_systems_2d_animation)
...
For information on the settings in the ParticleProcessMaterial see [this page](particle_process_material_2d.md#doc_particle_process_material_2d).
