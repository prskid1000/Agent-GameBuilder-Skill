<span id="doc_2d_sprite_animation"></span>
...
First, we'll use [AnimatedSprite2D](../../classes/class_animatedsprite2d.md#class_AnimatedSprite2D) to
...
with [AnimationPlayer](../../classes/class_animationplayer.md#class_AnimationPlayer) and the *Animation*
property of [Sprite2D](../../classes/class_sprite2d.md#class_Sprite2D).
...
![](img/2d_animation_tree1.webp)

> **Note:** :ref:`RigidBody2D <class_RigidBody2D>`. The animation will still be made in the same way. Once the animation is completed, you can assign a shape to the CollisionShape2D. See :ref:`Physics Introduction <doc_physics_introduction>` for more information.
Now select the `AnimatedSprite2D` and in its *SpriteFrames* property, select
"New SpriteFrames".

![](img/2d_animation_new_spriteframes.webp)

Click on the new SpriteFrames resource and you'll see a new panel appear at the
bottom of the editor window:

![](img/2d_animation_spriteframes.webp)

From the FileSystem dock on the left side, drag the 8 individual images into
the center part of the SpriteFrames panel. On the left side, change the name
of the animation from "default" to "run".

![](img/2d_animation_spriteframes_done.webp)
...
![](img/2d_animation_add_from_spritesheet.webp)
...
![](img/2d_animation_spritesheet_select_rows.webp)
...
![](img/2d_animation_spritesheet_selectframes.webp)
...
![](img/2d_animation_spritesheet_animation.webp)

Finally, check the play button on the SpriteFrames editor to see your frog jump!

![](img/2d_animation_play_spritesheet_animation.webp)

### Sprite sheet with AnimationPlayer

Another way that you can animate when using a sprite sheet is to use a standard
[Sprite2D](../../classes/class_sprite2d.md#class_Sprite2D) node to display the texture, and then animating the
change from texture to texture with [AnimationPlayer](../../classes/class_animationplayer.md#class_AnimationPlayer).
...
![](img/2d_animation_setframes.webp)
