<span id="doc_canvas_layers"></span>

## Canvas layers

### Viewport and Canvas items

[CanvasItem](../../classes/class_canvasitem.md#class_CanvasItem) is the base for all 2D nodes, be it regular
2D nodes, such as [Node2D](../../classes/class_node2d.md#class_Node2D), or [Control](../../classes/class_control.md#class_Control).
Both inherit from [CanvasItem](../../classes/class_canvasitem.md#class_CanvasItem).
...
[Viewport](../../classes/class_viewport.md#class_Viewport), that displays them.

The Viewport's property
[Viewport.canvas_transform](../../classes/class_viewport.md#class_Viewport_property_canvas_transform),
allows to apply a custom [Transform2D](../../classes/class_transform2d.md#class_Transform2D)
transform to the CanvasItem hierarchy it contains. Nodes such as
[Camera2D](../../classes/class_camera2d.md#class_Camera2D) work by changing that transform.
...
The answer is [CanvasLayer](../../classes/class_canvaslayer.md#class_CanvasLayer),
...
> **Note:** The standard way to ensuring that a node is correctly drawn 'in front' or 'behind' others is to manipulate the order of the nodes in the scene panel. Perhaps counterintuitively, the topmost nodes in the scene panel are drawn on *behind* lower ones in the viewport. 2D nodes also have the :ref:`CanvasItem.z_index <class_CanvasItem_property_z_index>` property for controlling their drawing order.
