<span id="doc_2d_lights_and_shadows"></span>
...
- [CanvasModulate](../../classes/class_canvasmodulate.md#class_CanvasModulate) (to darken the rest of the scene)
- [PointLight2D](../../classes/class_pointlight2d.md#class_PointLight2D) (for omnidirectional or spot lights)
- [DirectionalLight2D](../../classes/class_directionallight2d.md#class_DirectionalLight2D) (for sunlight or moonlight)
- [LightOccluder2D](../../classes/class_lightoccluder2d.md#class_LightOccluder2D) (for light shadow casters)
- Other 2D nodes that receive lighting, such as Sprite2D or TileMapLayer.

[CanvasModulate](../../classes/class_canvasmodulate.md#class_CanvasModulate) is used to darken the scene by
...
[Sprite2Ds](../../classes/class_sprite2d.md#class_Sprite2D) are used to display the textures for the light
blobs, the background, and for the shadow casters.

[PointLight2Ds](../../classes/class_pointlight2d.md#class_PointLight2D) are used to light the scene. The way a
light typically works is by adding a selected texture over the rest of the scene
to simulate lighting.

[LightOccluder2Ds](../../classes/class_lightoccluder2d.md#class_LightOccluder2D) are used to tell the shader
...
[Light](../../classes/class_pointlight2d.md#class_PointLight2D).
...
<span id="doc_2d_lights_and_shadows_setting_up_shadows"></span>
