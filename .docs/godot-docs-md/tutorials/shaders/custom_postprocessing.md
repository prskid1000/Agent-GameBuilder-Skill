<span id="doc_custom_postprocessing"></span>
...
DOF, and SSAO, which are described in [doc_environment_and_post_processing](../3d/environment_and_post_processing.md#doc_environment_and_post_processing).
...
<class_CanvasLayer>`, and give it a [ColorRect](../../classes/class_colorrect.md#class_ColorRect). Assign a
new [ShaderMaterial](../../classes/class_shadermaterial.md#class_ShaderMaterial) to the newly created
...
For this demo, we will use this [Sprite](../../classes/class_sprite2d.md#class_Sprite2D) of a sheep.

![](img/post_example1.png)

Assign a new [Shader](../../classes/class_shader.md#class_Shader) to the `ColorRect`'s
