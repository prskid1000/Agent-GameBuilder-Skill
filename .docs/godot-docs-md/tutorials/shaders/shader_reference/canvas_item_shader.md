<span id="doc_canvas_item_shader"></span>
...
[Spatial shaders](spatial_shader.md#doc_spatial_shader), but they maintain the same basic structure
...
built-in from the `fragment()` function, you can use a [varying](shading_language.md#doc_shading_language_varyings).
...
|                   | [time_scale](../../../classes/class_engine.md#class_Engine_property_time_scale) but not by pausing. If you need a           |
|                   | `TIME` variable that is not affected by time scale, add your own                              |
|                   | [global shader uniform](shading_language.md#doc_shading_language_global_uniforms) and update it each           |
|                   | frame.                                                                                          |
+-------------------+-------------------------------------------------------------------------------------------------+
...
|                                | [modulate](../../../classes/class_canvasitem.md#class_CanvasItem_property_modulate)            |
|                                | multiplied by CanvasItem's                                     |
|                                | [self_modulate](../../../classes/class_canvasitem.md#class_CanvasItem_property_self_modulate). |
+--------------------------------+----------------------------------------------------------------+
...
The built-in variable `COLOR` is used for a few things:
  ...
  - In the `vertex()` function, `COLOR` contains the color from the vertex
    ...
    [modulate](../../../classes/class_canvasitem.md#class_CanvasItem_property_modulate) multiplied by the
    CanvasItem's [self_modulate](../../../classes/class_canvasitem.md#class_CanvasItem_property_self_modulate).
...
Certain nodes (for example, [Sprite2D](../../../classes/class_sprite2d.md#class_Sprite2D)) display a texture
by default, for example [texture](../../../classes/class_sprite2d.md#class_Sprite2D_property_texture). When
...
Similarly, if a normal map is used in the [CanvasTexture](../../../classes/class_canvastexture.md#class_CanvasTexture), Godot uses
...
+----------------------------------+------------------------------------------------------------------------------+
| in vec4 **LIGHT_COLOR**          | [Color](../../../classes/class_light2d.md#class_Light2D_property_color) of the [class_Light2D](../../../classes/class_light2d.md#class_Light2D).      |
|                                  | If the light is a [class_PointLight2D](../../../classes/class_pointlight2d.md#class_PointLight2D), multiplied by the light's       |
|                                  | [texture](../../../classes/class_pointlight2d.md#class_PointLight2D_property_texture).                         |
+----------------------------------+------------------------------------------------------------------------------+
| in float **LIGHT_ENERGY**        | [Energy multiplier](../../../classes/class_light2d.md#class_Light2D_property_energy) of the               |
|                                  | [class_Light2D](../../../classes/class_light2d.md#class_Light2D).                                                        |
+----------------------------------+------------------------------------------------------------------------------+
| in vec3 **LIGHT_POSITION**       | Position of the [class_Light2D](../../../classes/class_light2d.md#class_Light2D) in screen space. If using a             |
|                                  | [class_DirectionalLight2D](../../../classes/class_directionallight2d.md#class_DirectionalLight2D) this is always `(0.0, 0.0, 0.0)`.          |
+----------------------------------+------------------------------------------------------------------------------+
| in vec3 **LIGHT_DIRECTION**      | Direction of the [class_Light2D](../../../classes/class_light2d.md#class_Light2D) in screen space.                       |
+----------------------------------+------------------------------------------------------------------------------+
| in bool **LIGHT_IS_DIRECTIONAL** | `true` if this pass is a [class_DirectionalLight2D](../../../classes/class_directionallight2d.md#class_DirectionalLight2D).                  |
+----------------------------------+------------------------------------------------------------------------------+
| in vec3 **LIGHT_VERTEX**         | Pixel position, in screen space as modified in the `fragment()` function.  |
+----------------------------------+------------------------------------------------------------------------------+
| inout vec4 **LIGHT**             | Output color for this [class_Light2D](../../../classes/class_light2d.md#class_Light2D).                                  |
+----------------------------------+------------------------------------------------------------------------------+
...
The signed distance field is generated from [class_LightOccluder2D](../../../classes/class_lightoccluder2d.md#class_LightOccluder2D) nodes
present in the scene with the **SDF Collision** property enabled (which is the
default). See the [2D lights and shadows](../../2d/2d_lights_and_shadows.md#doc_2d_lights_and_shadows_setting_up_shadows)
