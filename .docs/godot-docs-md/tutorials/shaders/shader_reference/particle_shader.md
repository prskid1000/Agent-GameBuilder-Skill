<span id="doc_particle_shader"></span>
...
[CanvasItem](canvas_item_shader.md#doc_canvas_item_shader) or [Spatial](spatial_shader.md#doc_spatial_shader)
...
+------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+
| in vec3 **EMITTER_VELOCITY**       | Velocity of the [Particles2D](../../../classes/class_gpuparticles2d.md#class_GPUParticles2D) ([3D](../../../classes/class_gpuparticles3d.md#class_GPUParticles3D)) node.                                        |
+------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+
| in float **INTERPOLATE_TO_END**    | Value of the [interp_to_end](../../../classes/class_gpuparticles2d.md#class_GPUParticles2D_property_interp_to_end)                                                          |
|                                    | ([3D](../../../classes/class_gpuparticles3d.md#class_GPUParticles3D_property_interp_to_end)) property of the Particles node.                                                |
+------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+
| in uint **AMOUNT_RATIO**           | Value of the [amount_ratio](../../../classes/class_gpuparticles2d.md#class_GPUParticles2D_property_amount_ratio)                                                            |
|                                    | ([3D](../../../classes/class_gpuparticles3d.md#class_GPUParticles3D_property_amount_ratio)) property of the Particles node.                                                 |
+------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+

> **Note:** to ``true``. In a ShaderMaterial, access it with the ``COLOR`` variable.
### Start built-ins
