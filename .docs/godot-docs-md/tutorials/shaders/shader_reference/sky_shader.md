...
* If any `LIGHTX_*` properties are used and any
  [DirectionalLight3D](../../../classes/class_directionallight3d.md#class_DirectionalLight3D) changes.
...
[Sky process mode](../../../classes/class_sky.md#class_Sky_property_process_mode) is set to
[PROCESS_MODE_REALTIME](../../../classes/class_sky.md#class_Sky_constant_PROCESS_MODE_REALTIME).

Note that the [process mode](../../../classes/class_sky.md#class_Sky_property_process_mode) only
...
be optimized by setting the sky's [process mode](../../../classes/class_sky.md#class_Sky_property_process_mode)
and the [radiance size](../../../classes/class_sky.md#class_Sky_property_radiance_size) to get the
...
|                                 | rollover                                 |
|                                 | setting). It's affected by [time_scale](../../../classes/class_engine.md#class_Engine_property_time_scale) but not by pausing. If you need a         |
