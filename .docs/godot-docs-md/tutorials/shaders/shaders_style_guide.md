<span id="doc_shaders_style_guide"></span>
...
> **Note:** by default. Let it help you.
...
[doc_shader_preprocessor](shader_reference/shader_preprocessor.md#doc_shader_preprocessor) directives should be written in CONSTANT__CASE.
