<span id="doc_compute_shaders"></span>
...
> **Note:** 
   ...
   to shaders please read [doc_introduction_to_shaders](introduction_to_shaders.md#doc_introduction_to_shaders) and :ref:`your
...
Now to execute our shader we need a local [class_RenderingDevice](../../classes/class_renderingdevice.md#class_RenderingDevice)
which can be created using the [class_RenderingServer](../../classes/class_renderingserver.md#class_RenderingServer):
...
> **Warning:** Local RenderingDevices cannot be debugged using tools such as `RenderDoc <https://renderdoc.org/>`__.
### Provide input data
...
each an [class_RID](../../classes/class_rid.md#class_RID). Because RenderingDevice is meant to be a lower-level
...
[free_rid()](../../classes/class_renderingdevice.md#class_RenderingDevice_method_free_rid) method.
