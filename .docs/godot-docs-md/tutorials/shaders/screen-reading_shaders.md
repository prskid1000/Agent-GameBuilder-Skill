...
Godot [doc_shading_language](shader_reference/shading_language.md#doc_shading_language) has a special texture to access the already
...
In 2D, this can be corrected via the [BackBufferCopy](../../classes/class_backbuffercopy.md#class_BackBufferCopy)
...
You can reproduce the back-buffer logic in 3D by creating a [Viewport](../../classes/class_viewport.md#class_Viewport)
with a camera in the same position as your object, and then use the
[Viewport's](../../classes/class_viewport.md#class_Viewport) texture instead of the screen texture.
