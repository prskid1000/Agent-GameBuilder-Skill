<span id="doc_your_first_spatial_shader"></span>
...
[StandardMaterial3D](../../../classes/class_standardmaterial3d.md#class_StandardMaterial3D) isn't quite meeting your
needs. Either way, you have decided to write your own and now you need to figure
out where to start.

This tutorial will explain how to write a Spatial shader and will cover more
topics than the [CanvasItem](your_first_2d_shader.md#doc_your_first_canvasitem_shader) tutorial.
...
vertex function. In the [second part](your_second_3d_shader.md#doc_your_second_spatial_shader) we
...
> **Note:** (``vec2``, ``float``, ``sampler2D``), and functions. If you are uncomfortable with these concepts it is best to get a gentle introduction from `The Book of Shaders <https://thebookofshaders.com>`_ before completing this tutorial.
### Where to assign my material

In 3D, objects are drawn using [Meshes](../../../classes/class_mesh.md#class_Mesh). Meshes are a resource
...
[MeshInstance3D](../../../classes/class_meshinstance3d.md#class_MeshInstance3D), but you can also use :ref:`GPUParticles3D
<class_GPUParticles3D>`, [MultiMeshes](../../../classes/class_multimesh.md#class_MultiMesh) (with a
[MultiMeshInstance3D](../../../classes/class_multimeshinstance3d.md#class_MultiMeshInstance3D)), or others.
...
Add a new [MeshInstance3D](../../../classes/class_meshinstance3d.md#class_MeshInstance3D) node to your scene.

In the inspector tab, set the MeshInstance3D's **Mesh** property to a new
[PlaneMesh](../../../classes/class_planemesh.md#class_planemesh) resource, by clicking on `<empty>` and
...
Now set **Subdivide Width** and **Subdivide Depth** of the [PlaneMesh](../../../classes/class_planemesh.md#class_planemesh) to `32`.

![](img/plane-sub-set.webp)

You can see that there are now many more triangles in the
[MeshInstance3D](../../../classes/class_meshinstance3d.md#class_MeshInstance3D). This will give us more vertices to work with
and thus allow us to add more detail.

![](img/plane-sub.webp)

[PrimitiveMeshes](../../../classes/class_primitivemesh.md#class_primitivemesh), like PlaneMesh, only have one
...
> **Note:** 
  Materials that inherit from the [class_Material](../../../classes/class_material.md#class_Material) resource, such as [class_StandardMaterial3D](../../../classes/class_standardmaterial3d.md#class_StandardMaterial3D)
  and [class_ParticleProcessMaterial](../../../classes/class_particleprocessmaterial.md#class_ParticleProcessMaterial), can be converted to a [class_ShaderMaterial](../../../classes/class_shadermaterial.md#class_ShaderMaterial)
...
The `vertex()` function determines where the vertices of your [MeshInstance3D](../../../classes/class_meshinstance3d.md#class_MeshInstance3D)
...
to [cos()](../shader_reference/shader_functions.md#shader_func_cos) and [sin()](../shader_reference/shader_functions.md#shader_func_sin); that gives
...
Godot provides the [NoiseTexture2D](../../../classes/class_noisetexture2d.md#class_noisetexture2D) resource for
...
Set this **Noise** parameter to a new [NoiseTexture2D](../../../classes/class_noisetexture2d.md#class_noisetexture2D).
Then in your NoiseTexture2D, set its **Noise** property to a new
[FastNoiseLite](../../../classes/class_fastnoiselite.md#class_fastnoiselite). The FastNoiseLite class is used by
...
[texture()](../shader_reference/shader_functions.md#shader_func_texture) takes a texture as the first argument and
...
[Uniform variables](../shader_reference/shading_language.md#doc_shading_language_uniforms) allow you to pass data
...
[Shader](../../../classes/class_shader.md#class_Shader) using the keyword `uniform`.
...
[set_shader_parameter()](../../../classes/class_shadermaterial.md#class_ShaderMaterial_method_set_shader_parameter)
...
> **Note:** CanvasItem-based nodes. Here, we set the material inside the PlaneMesh resource. In other mesh resources you may need to first access the material by calling ``surface_get_material()``. While in the MeshInstance3D you would access the material using ``get_surface_material()`` or ``material_override``.
...
of the terrain. Combined with [Tweens](../../../classes/class_tween.md#class_Tween), this can be
...
First, we will add an [OmniLight3D](../../../classes/class_omnilight3d.md#class_OmniLight3D) to the scene, and
...
the light shader uses the normals from the [Mesh](../../../classes/class_mesh.md#class_mesh) to calculate
light.
...
Set this second uniform texture to another [NoiseTexture2D](../../../classes/class_noisetexture2d.md#class_noisetexture2D) with another
[FastNoiseLite](../../../classes/class_fastnoiselite.md#class_fastnoiselite). But this time, check **As Normal Map**.
...
that using a [varying](../shader_reference/shading_language.md#doc_shading_language_varyings).
