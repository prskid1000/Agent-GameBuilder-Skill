<span id="doc_your_first_canvasitem_shader"></span>
...
> **Note:** overview of how shaders work in Godot, see the :ref:`Shading Reference <toc-shading-reference>`.
### Setup

[CanvasItem shaders](../shader_reference/canvas_item_shader.md#doc_canvas_item_shader) are used to draw all 2D
objects in Godot, while [Spatial](../shader_reference/spatial_shader.md#doc_spatial_shader) shaders are used
...
[Resource](../../scripting/resources.md#doc_resources). To draw multiple objects with the same
material, the material must be attached to each object.

All objects derived from a [CanvasItem](../../../classes/class_canvasitem.md#class_CanvasItem) have a material
property. This includes all [GUI elements](../../../classes/class_control.md#class_Control), :ref:`Sprite2Ds
<class_Sprite2D>`, [TileMapLayers](../../../classes/class_tilemaplayer.md#class_TileMapLayer), :ref:`MeshInstance2Ds
...
To begin, create a Sprite2D node. [You can use any CanvasItem](../../2d/custom_drawing_in_2d.md#doc_custom_drawing_in_2d),
...
vectors see the [Vector math tutorial](../../math/vector_math.md#doc_vector_math). `COLOR` is both
