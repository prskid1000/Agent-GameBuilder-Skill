<span id="doc_your_second_spatial_shader"></span>
...
importantly, sets the `ALBEDO` color of the [MeshInstance3D](../../../classes/class_meshinstance3d.md#class_MeshInstance3D).
...
> **Note:** Only set it between them for blending between materials.
...
<doc_shading_language>` doc and the [Spatial Shaders](../shader_reference/spatial_shader.md#doc_spatial_shader)
doc. Also look at more advanced tutorials in the :ref:`Shading section
<toc-learn-features-shading>` and the 3D
sections.
