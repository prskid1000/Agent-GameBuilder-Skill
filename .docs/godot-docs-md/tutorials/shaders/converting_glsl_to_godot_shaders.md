<span id="doc_converting_glsl_to_godot_shaders"></span>
...
[Shading Language](shader_reference/shading_language.md#doc_shading_language) reference.
...
The [Godot shader preprocessor](shader_reference/shader_preprocessor.md#doc_shader_preprocessor) supports the following macros:
...
For more information, see the [Shading Language](shader_reference/shading_language.md#doc_shading_language)
reference.
...
[GLSL](converting_glsl_to_godot_shaders.md#glsl_coordinates).
