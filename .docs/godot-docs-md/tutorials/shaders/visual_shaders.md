<span id="doc_visual_shaders"></span>
...
> **Note:** If you are not familiar with shaders, start by reading :ref:`doc_introduction_to_shaders`.
### Creating a VisualShader

VisualShaders can be created in any [class_ShaderMaterial](../../classes/class_shadermaterial.md#class_ShaderMaterial). To begin using
VisualShaders, create a new `ShaderMaterial` in an object of your choice.

![](img/shader_material_create_mesh.webp)

Then assign a [class_Shader](../../classes/class_shader.md#class_Shader) resource to the `Shader` property.

![](img/visual_shader_create.webp)

Click on the new `Shader` resource and the Create Shader dialog will
open automatically. Change the Type option to [class_VisualShader](../../classes/class_visualshader.md#class_VisualShader)
in the dropdown, then give it a name.

![](img/visual_shader_create2.webp)
...
![](img/visual_shader_editor2.webp)
