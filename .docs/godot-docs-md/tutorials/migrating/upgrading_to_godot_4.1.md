...
> **Warning:** The GDExtension API completely breaks compatibility in 4.1, so it's not included in the table below. See the :ref:`updating_your_gdextension_for_godot_4_1` section for more information.
...
<span id="updating_your_gdextension_for_godot_4_1"></span>
