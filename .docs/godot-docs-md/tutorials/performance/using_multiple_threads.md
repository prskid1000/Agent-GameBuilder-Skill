<span id="doc_using_multiple_threads"></span>

## Using multiple threads

.. seealso::

    For a list of multithreading primitives in C++, see [doc_core_concurrency_types](../../engine_details/architecture/core_types.md#doc_core_concurrency_types).
...
> **Note:** threading classes they support.
> **Warning:** Before using a built-in class in a thread, read :ref:`doc_thread_safe_apis` first to check whether it can be safely used in a thread.
### Creating a Thread
...
[Thread.wait_to_finish()](../../classes/class_thread.md#class_Thread_method_wait_to_finish), which will
...
<span id="doc_using_multiple_threads_mutexes"></span>
...
[doc_thread_safe_apis](thread_safe_apis.md#doc_thread_safe_apis) documentation to understand which engine APIs
...
when modified. Always use a [Mutex](../../classes/class_mutex.md#class_Mutex) when accessing
a piece of data from different threads.

When calling [Mutex.lock()](../../classes/class_mutex.md#class_Mutex_method_lock), a thread ensures that
...
[Mutex.unlock()](../../classes/class_mutex.md#class_Mutex_method_unlock), the other threads will be
...
For this, [Semaphores](../../classes/class_semaphore.md#class_Semaphore) are used. The function
[Semaphore.wait()](../../classes/class_semaphore.md#class_Semaphore_method_wait) is used in the thread to
suspend it until some data arrives.

The main thread, instead, uses
[Semaphore.post()](../../classes/class_semaphore.md#class_Semaphore_method_post) to signal that data is
