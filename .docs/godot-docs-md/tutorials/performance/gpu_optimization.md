<span id="doc_gpu_optimization"></span>
...
> **Note:** provide background information that is relevant in later sections.
...
[doc_optimizing_3d_performance](optimizing_3d_performance.md#doc_optimizing_3d_performance).
...
.. seealso::
    ...
    On supported hardware, [doc_variable_rate_shading](../3d/variable_rate_shading.md#doc_variable_rate_shading) can be used to
