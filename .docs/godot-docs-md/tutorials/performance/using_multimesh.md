...
<span id="doc_using_multimesh"></span>
...
[using servers directly](using_servers.md#doc_using_servers) is the recommended optimization.
...
A [MultiMesh](../../classes/class_multimesh.md#class_MultiMesh) is a single draw primitive that can draw up to millions
...
see the [Animating thousands of fish](vertex_animation/animating_thousands_of_fish.md#doc_animating_thousands_of_fish) tutorial. Information
to the shader can be provided via textures (there are floating-point [Image](../../classes/class_image.md#class_Image) formats
...
[RenderingServer.multimesh_set_buffer()](../../classes/class_renderingserver.md#class_RenderingServer_method_multimesh_set_buffer)
...
controlled with the [MultiMesh.visible_instance_count](../../classes/class_multimesh.md#class_MultiMesh_property_visible_instance_count)
