<span id="doc_cpu_optimization"></span>
...
> **Note:** as well as seeing the cost of our own scripting functions at the bottom. Time spent waiting for various built-in servers may not be counted in the profilers. This is a known bug.
...
[doc_debugger_panel](../scripting/debug/debugger_panel.md#doc_debugger_panel).
...
You can [use a number of third-party C++ profilers](../../engine_details/development/profiling/index.md#doc_using_cpp_profilers)
to do this.
...
[GDScript](../scripting/gdscript/index.md#doc_gdscript) is designed to be easy to use and iterate,
...
[C#](../scripting/c_sharp/index.md#doc_c_sharp) is popular and has first-class support in Godot. It
...
GDExtensions and
[custom modules](../../engine_details/engine_api/custom_modules_in_cpp.md#doc_custom_modules_in_cpp).
...
For more information on threads, see [doc_using_multiple_threads](using_multiple_threads.md#doc_using_multiple_threads).
...
One quirk of the [SceneTree](../../classes/class_scenetree.md#class_SceneTree) is that you can sometimes
...
[Node.remove_child(node)](../../classes/class_node.md#class_Node_method_remove_child), then reattach
it later using [Node.add_child(node)](../../classes/class_node.md#class_Node_method_add_child).
...
information, see [doc_using_servers](using_servers.md#doc_using_servers).
...
[here](../physics/interpolation/index.md#doc_physics_interpolation).
