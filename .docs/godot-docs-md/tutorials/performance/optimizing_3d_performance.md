...
<span id="doc_optimizing_3d_performance"></span>
...
using occluder nodes. See [doc_occlusion_culling](../3d/occlusion_culling.md#doc_occlusion_culling) for instructions on
...
Godot sorts objects by [Material](../../classes/class_material.md#class_Material) and :ref:`Shader
...
For more information, see the [GPU optimizations](gpu_optimization.md#doc_gpu_optimization)
doc.
...
- An automatic approach on mesh import using [doc_mesh_lod](../3d/mesh_lod.md#doc_mesh_lod).
- A manual approach configured in the 3D node using [doc_visibility_ranges](../3d/visibility_ranges.md#doc_visibility_ranges).
- [Decals](../3d/using_decals.md#doc_using_decals) and [lights](../3d/lights_and_shadows.md#doc_lights_and_shadows)
...
(for more information on fill rate, see [doc_gpu_optimization](gpu_optimization.md#doc_gpu_optimization)).
...
using [MultiMesh](../../classes/class_multimesh.md#class_MultiMesh) instead. MultiMesh allows the drawing
...
See also the [Using MultiMesh](using_multimesh.md#doc_using_multimesh) documentation.

### Bake lighting

Lighting objects is one of the most costly rendering operations. Realtime
lighting, shadows (especially multiple lights), and
[global illumination](../3d/global_illumination/introduction_to_global_illumination.md#doc_introduction_to_global_illumination) are especially
...
See [doc_using_lightmap_gi](../3d/global_illumination/using_lightmap_gi.md#doc_using_lightmap_gi) for instructions on using baked lightmaps. For
...
and quality is to keep **Dynamic** for the [class_DirectionalLight3D](../../classes/class_directionallight3d.md#class_DirectionalLight3D) node,
...
The [class_VisibleOnScreenEnabler3D](../../classes/class_visibleonscreenenabler3d.md#class_VisibleOnScreenEnabler3D) and [class_VisibleOnScreenNotifier3D](../../classes/class_visibleonscreennotifier3d.md#class_VisibleOnScreenNotifier3D)
...
large worlds. This can be resolved using [doc_large_world_coordinates](../physics/large_world_coordinates.md#doc_large_world_coordinates).
