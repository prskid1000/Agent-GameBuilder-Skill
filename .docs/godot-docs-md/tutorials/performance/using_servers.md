<span id="doc_using_servers"></span>
...
[scene system](../scripting/scene_tree.md#doc_scene_tree). Using nodes and resources simplifies
...
- It is not possible to [use multiple threads](using_multiple_threads.md#doc_using_multiple_threads)
  to control them.
...
* [class_RenderingServer](../../classes/class_renderingserver.md#class_RenderingServer): Handles everything related to graphics.
* [class_PhysicsServer3D](../../classes/class_physicsserver3d.md#class_PhysicsServer3D): Handles everything related to 3D physics.
* [class_PhysicsServer2D](../../classes/class_physicsserver2d.md#class_PhysicsServer2D): Handles everything related to 2D physics.
* [class_AudioServer](../../classes/class_audioserver.md#class_AudioServer): Handles everything related to audio.
...
The key to using servers is understanding Resource ID ([RID](../../classes/class_rid.md#class_RID))
...
inherits [Resource](../../classes/class_resource.md#class_Resource) can be directly casted to an RID. Not
...
> **Warning:** Resources are reference-counted (see :ref:`RefCounted <class_RefCounted>`), and references to a resource's RID are *not* counted when determining whether the resource is still in use. Make sure to **keep a reference** to the resource outside the server. Otherwise, both the resource and its RID will be erased.
For nodes, there are many functions available:

- For CanvasItem, the [CanvasItem.get_canvas_item()](../../classes/class_canvasitem.md#class_CanvasItem_method_get_canvas_item)
  method will return the canvas item RID in the server.
- For CanvasLayer, the [CanvasLayer.get_canvas()](../../classes/class_canvaslayer.md#class_CanvasLayer_method_get_canvas)
  method will return the canvas RID in the server.
- For Viewport, the [Viewport.get_viewport_rid()](../../classes/class_viewport.md#class_Viewport_method_get_viewport_rid)
  method will return the viewport RID in the server.
- For 2D, the [class_World2D](../../classes/class_world2d.md#class_World2D) resource (obtainable in the [class_Viewport](../../classes/class_viewport.md#class_Viewport)
  and [CanvasItem](../../classes/class_canvasitem.md#class_CanvasItem) nodes)
...
- For 3D, the [class_World3D](../../classes/class_world3d.md#class_World3D) resource (obtainable in the [class_Viewport](../../classes/class_viewport.md#class_Viewport)
  and [class_Node3D](../../classes/class_node3d.md#class_Node3D) nodes)
...
- The [class_VisualInstance3D](../../classes/class_visualinstance3d.md#class_VisualInstance3D) class, allows getting the scenario *instance* and
  *instance base* via the [VisualInstance3D.get_instance()](../../classes/class_visualinstance3d.md#class_VisualInstance3D_method_get_instance)
  and [VisualInstance3D.get_base()](../../classes/class_visualinstance3d.md#class_VisualInstance3D_method_get_base) respectively.
...
[class_CanvasItem](../../classes/class_canvasitem.md#class_CanvasItem) API.

> **Note:** When creating canvas items using the RenderingServer, you should reset physics interpolation on the first frame using :ref:`RenderingServer.canvas_item_reset_physics_interpolation() <class_RenderingServer_method_canvas_item_reset_physics_interpolation>`. This ensures proper synchronization between the rendering and physics systems. If this is not done, the canvas item may appear to teleport in when the scene is loaded, rather than appearing directly at its intended location.
.. tabs::
```
```
...
This creates a [class_RigidBody2D](../../classes/class_rigidbody2d.md#class_RigidBody2D) using the [class_PhysicsServer2D](../../classes/class_physicsserver2d.md#class_PhysicsServer2D) API,
and moves a [class_CanvasItem](../../classes/class_canvasitem.md#class_CanvasItem) when the body moves.
...
identical (using [class_RigidBody3D](../../classes/class_rigidbody3d.md#class_RigidBody3D) and [class_PhysicsServer3D](../../classes/class_physicsserver3d.md#class_PhysicsServer3D)
respectively).

### Getting data from the servers

Try to **never** request any information from [class_RenderingServer](../../classes/class_renderingserver.md#class_RenderingServer),
[class_PhysicsServer2D](../../classes/class_physicsserver2d.md#class_PhysicsServer2D), or [class_PhysicsServer3D](../../classes/class_physicsserver3d.md#class_PhysicsServer3D) by calling
