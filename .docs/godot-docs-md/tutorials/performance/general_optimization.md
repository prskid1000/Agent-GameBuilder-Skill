<span id="doc_general_optimization"></span>
...
- Using the [Godot profiler](../scripting/debug/the_profiler.md#doc_the_profiler).
- Using [external CPU profilers](../../engine_details/development/profiling/index.md#doc_using_cpp_profilers).
...
For more info about using Godot's built-in profiler, see [doc_the_profiler](../scripting/debug/the_profiler.md#doc_the_profiler).
