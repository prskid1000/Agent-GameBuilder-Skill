...
<span id="doc_animating_thousands_of_fish"></span>
...
In Godot, this can be accomplished with a custom [Shader](../../../classes/class_shader.md#class_Shader) and
a [MultiMeshInstance3D](../../../classes/class_multimeshinstance3d.md#class_MultiMeshInstance3D). Using the following technique you
...
We will start with a single fish. Load your fish model into a [MeshInstance3D](../../../classes/class_meshinstance3d.md#class_MeshInstance3D)
and add a new [ShaderMaterial](../../../classes/class_shadermaterial.md#class_ShaderMaterial).
...
Typically, you would use bones and a [Skeleton3D](../../../classes/class_skeleton3d.md#class_Skeleton3D) to animate objects. However,
...
Once you have a MultiMeshInstance3D add a [MultiMesh](../../../classes/class_multimesh.md#class_MultiMesh), and to that
MultiMesh add your [Mesh](../../../classes/class_mesh.md#class_Mesh) with the shader from above.
...
a [Color](../../../classes/class_color.md#class_Color).
...
and is described in the [MultiMeshInstance3D tutorial](../../3d/using_multi_mesh_instance.md#doc_using_multi_mesh_instance).
...
In the next tutorial we will cover how to use [GPUParticles3D](../../../classes/class_gpuparticles3d.md#class_GPUParticles3D) to take advantage
