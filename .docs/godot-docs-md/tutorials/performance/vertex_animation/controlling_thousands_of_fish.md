...
<span id="doc_controlling_thousands_of_fish"></span>

## Controlling thousands of fish with Particles

The problem with [MeshInstance3D](../../../classes/class_meshinstance3d.md#class_MeshInstance3D) is that it is expensive to
...
[GPUParticles3D](../../../classes/class_gpuparticles3d.md#class_GPUParticles3D) node. Particles take advantage of GPU acceleration
by computing and setting the per-instance information in a [Shader](../../../classes/class_shader.md#class_Shader).

First create a Particles node. Then, under "Draw Passes" set the Particle's "Draw Pass 1" to your
[Mesh](../../../classes/class_mesh.md#class_Mesh). Then under "Process Material" create a new
[ShaderMaterial](../../../classes/class_shadermaterial.md#class_ShaderMaterial).
...
These functions come from the default [ParticleProcessMaterial](../../../classes/class_particleprocessmaterial.md#class_ParticleProcessMaterial).
...
(through `TRANSFORM`). Please refer to the [Particles Shader Reference](../../shaders/shader_reference/particle_shader.md#doc_particle_shader)
