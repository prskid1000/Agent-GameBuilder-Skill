<span id="doc_gdextension_file"></span>
...
how to get started with C++ (godot-cpp), take a look at the [GDExtension C++ Example](../cpp/gdextension_cpp_example.md#doc_godot_cpp_getting_started).
...
+-------------------------------+------------+------------------------------------------------------------------------------------------------------+
| **android_aar_plugin**        | Boolean    | The GDExtension is part of a [v2 Android plugin](../../platform/android/android_plugin.md#doc_android_plugin). During export this flag  |
...
Here are lists of some of the available built-in options (for more look at the [feature tags](../../export/feature_tags.md#doc_feature_tags)):
...
the stock editor icons. Read the guide for [creating icons](../../../engine_details/editor/creating_icons.md#doc_editor_icons)
