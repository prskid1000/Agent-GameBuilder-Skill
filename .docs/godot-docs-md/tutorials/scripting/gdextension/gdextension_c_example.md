<span id="doc_gdextension_c_example"></span>
...
inherits from [Sprite2D](../../../classes/class_sprite2d.md#class_Sprite2D).
...
create a [StringName](../../../classes/class_stringname.md#class_StringName) and for that we have to get a
...
See [doc_what_is_gdextension_version_compatibility](../cpp/about_godot_cpp.md#doc_what_is_gdextension_version_compatibility) for more information.
...
are working on for the example. Using [feature tags](../../export/feature_tags.md#doc_feature_tags) you
...
![](img/gdextension_c_running.webp)
...
this tutorial, check the page about the [Object class](../../../engine_details/architecture/object_class.md#doc_object_class)
...
![](img/gdextension_c_methods_doc.webp)
...
![](img/gdextension_c_inspector_properties.webp)
...
[_process()](../../../classes/class_node.md#class_Node_private_method__process) and make our custom sprite
move a little bit.
...
First, let's add [class_Vector2](../../../classes/class_vector2.md#class_Vector2) to our `defs.h` file, so we
...
![](img/gdextension_c_moving_sprite.gif)
...
[emit_signal()](../../../classes/class_object.md#class_Object_method_emit_signal) method on our custom node.
...
![](img/gdextension_c_signal_doc.webp)
...
![](img/gdextension_c_signal_print.webp)
...
[godot-cpp documentation](../cpp/index.md#doc_godot_cpp) to see how you can
do this.
