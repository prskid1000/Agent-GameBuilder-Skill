...
[OS](../../classes/class_os.md#class_OS) class,
...
When initialization is complete, [OS](../../classes/class_os.md#class_OS) needs to be
supplied a [MainLoop](../../classes/class_mainloop.md#class_MainLoop)
...
The scene system is the game engine, while the [OS](../../classes/class_os.md#class_OS)
and servers are the low-level API.

The scene system provides its own main loop to OS,
[SceneTree](../../classes/class_scenetree.md#class_SceneTree).
...
-  It contains the root [Viewport](../../classes/class_viewport.md#class_Viewport), to which a
...
[Node.get_tree()](../../classes/class_node.md#class_Node_method_get_tree).

### Root viewport

The root [Viewport](../../classes/class_viewport.md#class_Viewport)
...
[Viewport](../../classes/class_viewport.md#class_Viewport)
...
[SceneTree.change_scene_to_file()](../../classes/class_scenetree.md#class_SceneTree_method_change_scene_to_file)
function:
...
[PackedScene](../../classes/class_packedscene.md#class_PackedScene) resources using the equivalent
function
[SceneTree.change_scene_to_packed(PackedScene scene)](../../classes/class_scenetree.md#class_SceneTree_method_change_scene_to_packed):
...
loading. This must be done manually using [doc_singletons_autoload](singletons_autoload.md#doc_singletons_autoload)
and [doc_background_loading](../io/background_loading.md#doc_background_loading).
