<span id="doc_objectdb_profiler"></span>
...
which is the database that contains all the [class_object](../../../classes/class_object.md#class_object)-derived classes
...
.. seealso::
   ...
   See [doc_node_alternatives](../../best_practices/node_alternatives.md#doc_node_alternatives) for information on using lighter-weight
...
.. tip::
    ...
    `user://objectdb_snapshots/` (see [Data paths](../../io/data_paths.md#doc_data_paths_accessing_persistent_user_data)
...
tab, but it shows the reference counts of [class_refcounted](../../../classes/class_refcounted.md#class_refcounted)-derived
...
> **Note:** 
   ...
   [class_object](../../../classes/class_object.md#class_object), as these don't use reference counting.
