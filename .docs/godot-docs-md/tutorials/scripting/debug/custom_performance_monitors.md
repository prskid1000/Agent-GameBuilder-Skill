<span id="doc_custom_performance_monitors"></span>

## Custom performance monitors

### Introduction

As explained in the [doc_debugger_panel](debugger_panel.md#doc_debugger_panel) documentation, Godot features a
...
from the engine's [class_Performance](../../../classes/class_performance.md#class_Performance) singleton.
...
The main scene features a [class_Timer](../../../classes/class_timer.md#class_Timer) node with the following script attached:
...
[Performance.add_custom_monitor](../../../classes/class_performance.md#class_Performance_method_add_custom_monitor)
is a [class_Callable](../../../classes/class_callable.md#class_Callable).
...
> **Note:** The performance monitor handling code doesn't have to live in the same script as the nodes themselves. You may choose to move the performance monitor registration and getter function to an :ref:`autoload <doc_singletons_autoload>` instead.
...
custom monitor. You can display the value using a [class_Label](../../../classes/class_label.md#class_Label),
[class_RichTextLabel](../../../classes/class_richtextlabel.md#class_RichTextLabel), [doc_custom_drawing_in_2d](../../2d/custom_drawing_in_2d.md#doc_custom_drawing_in_2d), [doc_3d_text](../../3d/3d_text.md#doc_3d_text),
etc.
