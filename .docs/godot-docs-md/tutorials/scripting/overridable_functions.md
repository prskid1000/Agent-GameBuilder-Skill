<span id="doc_overridable_functions"></span>
...
.. seealso:: Under the hood, these functions rely on Godot's low-level
             ...
             [doc_godot_notifications](../best_practices/godot_notifications.md#doc_godot_notifications).
...
.. seealso:: To learn more about getting node references, read
             [doc_nodes_and_scene_instances](nodes_and_scene_instances.md#doc_nodes_and_scene_instances).
...
[doc_idle_and_physics_processing](idle_and_physics_processing.md#doc_idle_and_physics_processing).
...
[Node._unhandled_input()](../../classes/class_node.md#class_Node_private_method__unhandled_input) and
[Node._input()](../../classes/class_node.md#class_Node_private_method__input), which you use to both receive
...
more callbacks like [CanvasItem._draw()](../../classes/class_canvasitem.md#class_CanvasItem_private_method__draw) to
