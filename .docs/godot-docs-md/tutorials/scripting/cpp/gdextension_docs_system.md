<span id="doc_godot_cpp_docs_system"></span>
...
[XML files](../../../engine_details/class_reference/index.md#doc_class_reference_primer) (one per class) to document the exposed constructors, properties, methods,
...
described in [doc_godot_cpp_getting_started](gdextension_cpp_example.md#doc_godot_cpp_getting_started).
...
![](img/gdextension_docs_generation.webp)
...
[doc_class_reference_primer](../../../engine_details/class_reference/index.md#doc_class_reference_primer).
