<span id="doc_godot_cpp_build_system_cmake"></span>
...
.. seealso::
    ...
    Godot instead, see [doc_introduction_to_the_buildsystem](../../../../engine_details/development/compiling/introduction_to_the_buildsystem.md#doc_introduction_to_the_buildsystem).
...
> **Warning:** The Android SDK website_ explicitly states that they do not support using the CMake built-in method, and recommends you stick with their toolchain files. .. _website: https://developer.android.com/ndk/guides/cmake
