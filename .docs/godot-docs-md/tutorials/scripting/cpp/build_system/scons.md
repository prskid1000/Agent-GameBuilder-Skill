<span id="doc_godot_cpp_build_system"></span>
...
.. seealso:: This page documents how to compile godot-cpp. If you're looking to compile Godot instead, see
             [doc_introduction_to_the_buildsystem](../../../../engine_details/development/compiling/introduction_to_the_buildsystem.md#doc_introduction_to_the_buildsystem).

godot-cpp uses SCons as its main build system.
It is modeled after [Godot's build system](../../../../engine_details/development/compiling/index.md#doc_compiling_index), and some commands available there are also
available in godot-cpp projects.

### Getting started

To build a godot-cpp project, it is generally sufficient to install SCons, and simply run it
...
SCons User Guide. Additional commands may be added by
...
For more information, please check out the [IDE configuration guides](../../../../engine_details/development/configuring_an_ide/index.md#doc_configuring_an_ide).
...
Godot loads GDExtensions by finding [.gdextension](../../gdextension/gdextension_file.md#doc_gdextension_file) files in the project directory.
`.gdextension` files are used to select and load a binary compatible with the current computer / operating system.

The godot-cpp-template, as well as the
[Getting Started section](../gdextension_cpp_example.md#doc_godot_cpp_getting_started), provide example `.gdextension` files for GDExtensions
...
mentioned in the godot-cpp-template
.gdextension file.
...
godot-cpp-template contains an
example setup
...
* If you [build Godot yourself](../../../../engine_details/development/compiling/index.md#doc_compiling_index) with different options than the official builds (e.g. `disable_3d=yes` or `precision=double`).
