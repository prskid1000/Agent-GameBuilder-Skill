<span id="doc_godot_cpp_core_types"></span>

## Core functions and types

godot-cpp's API is designed to be as similar as possible to Godot's internal API.

This means that, in general, you can use the [Engine details](../../../engine_details/architecture/index.md#doc_engine_architecture) section to learn how to
work with godot-cpp. In addition, it can often be useful to browse the engine's code
...
Please refer to [doc_common_engine_methods_and_macros](../../../engine_details/architecture/common_engine_methods_and_macros.md#doc_common_engine_methods_and_macros) for information on this. The functions and macros documented
there are also available in godot-cpp.

### Core types

Godot's [Core types](../../../engine_details/architecture/core_types.md#doc_core_types) are also available in godot-cpp, and the same recommendations apply
as described in that article. The types are regularly synchronized with the Godot codebase.

In your own code, you can also use C++ STL types, or types from
...
Please refer to [doc_variant_class](../../../engine_details/architecture/variant_class.md#doc_variant_class) to learn about how to work with `Variant`.
...
Please refer to [doc_object_class](../../../engine_details/architecture/object_class.md#doc_object_class) to learn how to register and work with your own `Object` types.
