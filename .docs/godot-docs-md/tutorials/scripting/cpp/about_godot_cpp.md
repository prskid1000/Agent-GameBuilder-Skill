<span id="doc_about_godot_cpp"></span>
...
godot-cpp is built with the [GDExtension system](../gdextension/index.md#doc_gdextension), which allows access to Godot in almost the
same way as [modules](../../../engine_details/engine_api/custom_modules_in_cpp.md#doc_custom_modules_in_cpp): A lot of engine code
can be used in your godot-cpp project almost exactly as it is.

In particular, godot-cpp has access to all functions that [GDScript](../gdscript/index.md#doc_gdscript) and [C#](../c_sharp/index.md#doc_c_sharp)
...
and [C++ modules](../../../engine_details/engine_api/custom_modules_in_cpp.md#doc_custom_modules_in_cpp) to run C or C++ code in a Godot project.
...
[asset library](../../../community/asset_library/what_is_assetlib.md#doc_what_is_assetlib).
...
We recommend [C++ modules](../../../engine_details/engine_api/custom_modules_in_cpp.md#doc_custom_modules_in_cpp) in cases where
...
> **Note:** If you notice that specific systems are not accessible via godot-cpp but are via custom modules, feel free to open an issue on the `godot-cpp repository <https://github.com/godotengine/godot-cpp>`__ to discuss implementation options for exposing the missing functionality.
<span id="doc_what_is_gdextension_version_compatibility"></span>
...
Godot 4.1 and later (see [updating_your_gdextension_for_godot_4_1](../../migrating/upgrading_to_godot_4.1.md#updating_your_gdextension_for_godot_4_1)).
...
file generated by your custom engine build. See [doc_large_world_coordinates](../../physics/large_world_coordinates.md#doc_large_world_coordinates)
for details.
...
`extension_api.json` files in the [build system section](build_system/scons.md#doc_godot_cpp_build_system).
