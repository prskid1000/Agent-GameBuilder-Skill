<span id="doc_c_sharp_features"></span>
...
<span id="doc_c_sharp_features_type_conversion_and_casting"></span>
...
* One of `GODOT_LINUXBSD`, `GODOT_WINDOWS`, `GODOT_OSX`,
  ...
  [OS](../../../classes/class_os.md#class_OS) singleton, but not every possible OS
