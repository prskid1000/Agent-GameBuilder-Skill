...
[how to use specific features](c_sharp_features.md#doc_c_sharp_features), read about the
[differences between the C# and the GDScript API](c_sharp_differences.md#doc_c_sharp_differences),
and (re)visit the [Scripting section](../../../getting_started/step_by_step/scripting_languages.md#doc_scripting) of the
...
.. attention::
    ...
    experimental and [some limitations apply](index.md#doc_c_sharp_platforms).

> **Note:** This is **not** a full-scale tutorial on the C# language as a whole. If you aren't already familiar with its syntax or features, see the `Microsoft C# guide <https://docs.microsoft.com/en-us/dotnet/csharp/index>`_ or look for a suitable introduction elsewhere.
<span id="doc_c_sharp_setup"></span>
...
.NET support in your build as outlined in the [doc_compiling_with_dotnet](../../../engine_details/development/compiling/compiling_with_dotnet.md#doc_compiling_with_dotnet)
page.

<span id="doc_c_sharp_setup_external_editor"></span>
...
> **Note:** your NuGet configuration may be incorrect and need to be fixed. A simple way to fix the NuGet configuration file is to regenerate it. In a file explorer window, go to ``%AppData%\NuGet``. Rename or delete the ``NuGet.Config`` file. When you build your Godot project again, the file will be automatically created with default values.
...
the tutorials on [doc_scripting](../../../getting_started/step_by_step/scripting_languages.md#doc_scripting) at this point.
...
> **Note:** Keep in mind that the class you wish to attach to your node should have the same name as the ``.cs`` file. Otherwise, you will get the following error: *"Cannot find class XXX for script res://XXX.cs"*
<span id="doc_c_sharp_general_differences"></span>
...
For more information, see the [doc_c_sharp_differences](c_sharp_differences.md#doc_c_sharp_differences) page.

> **Warning:** You need to (re)build the project assemblies whenever you want to see new exported variables or signals in the editor. This build can be manually triggered by clicking the **Build** button in the top right corner of the editor. .. image:: img/build_dotnet.webp You will also need to rebuild the project assemblies to apply changes in "tool" scripts.
...
.. seealso::
    ...
    see [doc_faq_which_programming_language_is_fastest](../../../about/faq.md#doc_faq_which_programming_language_is_fastest).
