<span id="doc_c_sharp_signals"></span>

## C# signals

For a detailed explanation of signals in general, see the [doc_signals](../../../getting_started/step_by_step/signals.md#doc_signals) section in the step
by step tutorial.

Signals are implemented using C# events, the idiomatic way to represent
[the observer pattern](../../../getting_started/introduction/key_concepts_overview.md#doc_key_concepts_signals) in C#. This is the
recommended way to use signals in C# and the focus of this page.

In some cases it's necessary to use the older
[Connect()](../../../classes/class_object.md#class_object_method_connect) and
[Disconnect()](../../../classes/class_object.md#class_object_method_disconnect) APIs.
See [using_connect_and_disconnect](c_sharp_signals.md#using_connect_and_disconnect) for more details.

If you encounter a `System.ObjectDisposedException` while handling a signal,
you might be missing a signal disconnection. See
[disconnecting_automatically_when_the_receiver_is_freed](c_sharp_signals.md#disconnecting_automatically_when_the_receiver_is_freed) for more details.
...
`SignalName` class. This is useful when, for example, you want to await on a signal (see [doc_c_sharp_differences_await](c_sharp_differences.md#doc_c_sharp_differences_await)).
...
Signals support arguments of any [Variant-compatible type](c_sharp_variant.md#c_sharp_variant_compatible_types).
...
Here, the [Button.Pressed](../../../classes/class_basebutton.md#class_BaseButton_signal_pressed) signal does not take any argument. But we
...
<span id="using_connect_and_disconnect"></span>

### Using Connect and Disconnect

In general, it isn't recommended to use
[Connect()](../../../classes/class_object.md#class_object_method_connect) and
[Disconnect()](../../../classes/class_object.md#class_object_method_disconnect). These APIs don't provide as
much type safety as the events. However, they're necessary for
[connecting to signals defined by GDScript](../cross_language_scripting.md#connecting_to_signals_cross_language)
and passing [ConnectFlags](../../../classes/class_object.md#enum_Object_ConnectFlags).
...
<span id="disconnecting_automatically_when_the_receiver_is_freed"></span>
