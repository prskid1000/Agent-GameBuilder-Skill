<span id="doc_c_sharp_collections"></span>
...
* Does your collection need to interact with the Godot engine?
   ...
   * If yes, since Godot only supports [c_sharp_variant_compatible_types](c_sharp_variant.md#c_sharp_variant_compatible_types),
...
* Do you need a Godot collection that represents a list or sequential set of data?
   ...
   * Godot [arrays](c_sharp_collections.md#doc_c_sharp_collections_array) are similar to the C# collection `List<T>`.
   * Godot [packed arrays](c_sharp_collections.md#doc_c_sharp_collections_packedarray) are more memory-efficient arrays,
...
* Do you need a Godot collection that maps a set of keys to a set of values?
   ...
   * Godot [dictionaries](c_sharp_collections.md#doc_c_sharp_collections_dictionary) store pairs of keys and values
     and allow easy access to the values by their associated key.

### Godot collections

<span id="doc_c_sharp_collections_packedarray"></span>
...
does not exist. See the list of [c_sharp_variant_compatible_types](c_sharp_variant.md#c_sharp_variant_compatible_types).

<span id="doc_c_sharp_collections_array"></span>
...
a [Variant-compatible type](c_sharp_variant.md#c_sharp_variant_compatible_types).
...
<span id="doc_c_sharp_collections_dictionary"></span>
...
and value types to a [Variant-compatible type](c_sharp_variant.md#c_sharp_variant_compatible_types).
