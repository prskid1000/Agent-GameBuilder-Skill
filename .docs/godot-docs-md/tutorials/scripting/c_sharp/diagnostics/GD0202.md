...
[Variant-compatible type](../c_sharp_variant.md#c_sharp_variant_compatible_types) is expected.
...
Take a look at the [C# signals](../c_sharp_signals.md#doc_c_sharp_signals) documentation for more
