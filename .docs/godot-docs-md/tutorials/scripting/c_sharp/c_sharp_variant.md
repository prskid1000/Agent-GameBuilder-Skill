<span id="doc_c_sharp_variant"></span>

## C# Variant

For a detailed explanation of Variant in general, see the [Variant](../../../classes/class_variant.md#class_Variant) documentation page.

`Godot.Variant` is used to represent Godot's native [Variant](../../../classes/class_variant.md#class_Variant) type. Any
[Variant-compatible type](c_sharp_variant.md#c_sharp_variant_compatible_types) can be converted from/to it.
...
For example, the third argument of [tween_property](../../../classes/class_tween.md#class_Tween_method_tween_property)
...
<span id="c_sharp_variant_compatible_types"></span>
...
* `string`.
* Classes derived from [GodotObject](../../../classes/class_object.md#class_Object).
