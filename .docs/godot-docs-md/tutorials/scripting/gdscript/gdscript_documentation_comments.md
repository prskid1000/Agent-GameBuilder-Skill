<span id="doc_gdscript_documentation_comments"></span>
...
> **Note:** When the description spans multiple lines, the preceding and trailing white spaces will be stripped and joined with a single space. To preserve the line break use ``[br]``. See also `BBCode and class reference`_ below.
...
![](img/deprecated_and_experimental_tags.webp)
...
<span id="doc_gdscript_documentation_comments_bbcode_and_class_reference"></span>
...
be used in the documentation. See also [class reference bbcode](../../../engine_details/class_reference/index.md#doc_class_reference_bbcode).
Note that this is slightly different from the `RichTextLabel` [BBCode](../../ui/bbcode_in_richtextlabel.md#doc_bbcode_in_richtextlabel).
...
+================================+==============================================+==============================================================+
| | `[Class]`                  | `Move the [Sprite2D].`                     | Move the [class_Sprite2D](../../../classes/class_sprite2d.md#class_Sprite2D).                              |
| | Link to class                |                                              |                                                              |
+--------------------------------+----------------------------------------------+--------------------------------------------------------------+
| | `[annotation Class.name]`  | `See [annotation @GDScript.@rpc].`         | See @GDScript.@rpc. |
| | Link to annotation           |                                              |                                                              |
+--------------------------------+----------------------------------------------+--------------------------------------------------------------+
| | `[constant Class.name]`    | `See [constant Color.RED].`                | See [Color.RED](../../../classes/class_color.md#class_Color_constant_RED).             |
| | Link to constant             |                                              |                                                              |
+--------------------------------+----------------------------------------------+--------------------------------------------------------------+
| | `[enum Class.name]`        | `See [enum Mesh.ArrayType].`               | See [Mesh.ArrayType](../../../classes/class_mesh.md#enum_Mesh_ArrayType).             |
| | Link to enum                 |                                              |                                                              |
+--------------------------------+----------------------------------------------+--------------------------------------------------------------+
| | `[member Class.name]`      | `Get [member Node2D.scale].`               | Get [Node2D.scale](../../../classes/class_node2d.md#class_Node2D_property_scale).       |
| | Link to member (property)    |                                              |                                                              |
+--------------------------------+----------------------------------------------+--------------------------------------------------------------+
| | `[method Class.name]`      | `Call [method Node3D.hide].`               | Call [Node3D.hide()](../../../classes/class_node3d.md#class_Node3D_method_hide).        |
| | Link to method               |                                              |                                                              |
+--------------------------------+----------------------------------------------+--------------------------------------------------------------+
| | `[constructor Class.name]` | `Use [constructor Color.Color].`           | Use  [Color.Color](../../../classes/class_color.md#class_Color_constructor_Color).     |
| | Link to built-in constructor |                                              |                                                              |
+--------------------------------+----------------------------------------------+--------------------------------------------------------------+
| | `[operator Class.name]`    | `Use [operator Color.operator *].`         | Use  [Color.operator *](../../../classes/class_color.md#class_Color_operator_mul_int). |
| | Link to built-in operator    |                                              |                                                              |
+--------------------------------+----------------------------------------------+--------------------------------------------------------------+
| | `[signal Class.name]`      | `Emit [signal Node.renamed].`              | Emit [Node.renamed](../../../classes/class_node.md#class_Node_signal_renamed).        |
| | Link to signal               |                                              |                                                              |
+--------------------------------+----------------------------------------------+--------------------------------------------------------------+
| | `[theme_item Class.name]`  | `See [theme_item Label.font].`             | See [Label.font](../../../classes/class_label.md#class_Label_theme_font_font).         |
| | Link to theme item           |                                              |                                                              |
+--------------------------------+----------------------------------------------+--------------------------------------------------------------+
...
| | Hyperlink                    | | `[url=https://example.com]Website[/url]` | | Website                           |
+--------------------------------+----------------------------------------------+--------------------------------------------------------------+
...
> **Note:** 1. Currently only :ref:`class_@GDScript` has annotations. 2. ``[kbd]`` disables BBCode until the parser encounters ``[/kbd]``. 3. ``[code]`` disables BBCode until the parser encounters ``[/code]``. 4. ``[codeblock]`` disables BBCode until the parser encounters ``[/codeblock]``.
