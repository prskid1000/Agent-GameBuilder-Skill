<span id="doc_gdscript_warning_system"></span>

## GDScript warning system

The GDScript warning system complements [static typing](static_typing.md#doc_gdscript_static_typing)
...
![](img/typed_gdscript_warning_system_settings.webp)
...
![](img/typed_gdscript_warning_example.webp)
...
![](img/typed_gdscript_warning_system_ignore.webp)
