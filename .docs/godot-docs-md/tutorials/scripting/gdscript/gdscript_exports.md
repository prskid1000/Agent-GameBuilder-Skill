<span id="doc_gdscript_exports"></span>

## GDScript exported properties

In Godot, class members can be exported. This means their value gets saved along
with the resource (such as the [scene](../../../classes/class_packedscene.md#class_PackedScene)) they're
attached to, and get transferred over when using [RPCs](../../networking/high_level_multiplayer.md#doc_high_level_multiplayer_rpcs).
...
special export syntax is provided. Additionally, [documentation comments](gdscript_documentation_comments.md#doc_gdscript_documentation_comments) can be
used for tooltip descriptions, visible on mouse over.

> **Note:** Exporting properties can also be done in other languages such as C#. The syntax varies depending on the language. See :ref:`doc_c_sharp_exports` for information on C# exports.
### Basic use
...
if the script is in [doc_gdscript_tool_mode](gdscript_basics.md#doc_gdscript_tool_mode).
...
[doc_gdscript_exports_floats_with_easing_hint](gdscript_exports.md#doc_gdscript_exports_floats_with_easing_hint) instead.
...
<span id="doc_gdscript_exports_floats_with_easing_hint"></span>
...
<span id="doc_gdscript_exports_exporting_bit_flags"></span>
...
Also the property value is copied when [Resource.duplicate()](../../../classes/class_resource.md#class_Resource_method_duplicate)
or [Node.duplicate()](../../../classes/class_node.md#class_Node_method_duplicate) is called, unlike non-exported variables.
...
[doc_gdscript_tool_mode](gdscript_basics.md#doc_gdscript_tool_mode), the value in the inspector won't be updated
automatically. To update it, call
[notify_property_list_changed()](../../../classes/class_object.md#class_Object_method_notify_property_list_changed)
after setting the exported variable's value.

### Reading an exported variable's value early on

If you read an exported variable's value in [_init()](../../../classes/class_object.md#class_Object_private_method__init),
...
[Node._ready()](../../../classes/class_node.md#class_Node_private_method__ready). You can also read the value
...
[_set()](../../../classes/class_object.md#class_Object_private_method__set),
[_get()](../../../classes/class_object.md#class_Object_private_method__get), and
[_get_property_list()](../../../classes/class_object.md#class_Object_private_method__get_property_list) methods as
described in [doc_accessing_data_or_logic_from_object](../../best_practices/godot_interfaces.md#doc_accessing_data_or_logic_from_object).

.. seealso:: For binding properties using the above methods in C++, see
             [doc_binding_properties_using_set_get_property_list](../../../engine_details/architecture/object_class.md#doc_binding_properties_using_set_get_property_list).

> **Warning:** can work from within the editor.
