<span id="doc_gdscript_more_efficiently"></span>
...
that inherit [class_RefCounted](../../../classes/class_refcounted.md#class_RefCounted) (the default if nothing is specified)
will be freed when not used, but manual memory management is allowed too
if inheriting manually from [class_Object](../../../classes/class_object.md#class_Object).
