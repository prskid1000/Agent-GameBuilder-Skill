<span id="doc_gdscript_static_typing"></span>
...
editor autocompletion and [documentation](gdscript_documentation_comments.md#doc_gdscript_documentation_comments)
of your scripts.
...
3. [Built-in types](gdscript_basics.md#doc_gdscript_builtin_types).
4. Native classes (`Object`, `Node`, `Area2D`, `Camera2D`, etc.).
5. [Global classes](gdscript_basics.md#doc_gdscript_basics_class_name).
6. [Inner classes](gdscript_basics.md#doc_gdscript_basics_inner_classes).
...
> **Note:** The ``as`` keyword silently casts the variable to ``null`` in case of a type mismatch at runtime, without an error/warning. While this may be convenient in some cases, it can also lead to bugs. Use the ``as`` keyword only if this behavior is intended. A safer alternative is to use the ``is`` keyword: :: if not (body is PlayerController): push_error("Bug: body is not PlayerController.") var player: PlayerController = body if not player: return player.damage() You can also simplify the code by using the ``is not`` operator: :: if body is not PlayerController: push_error("Bug: body is not PlayerController") Alternatively, you can use the ``assert()`` statement: :: assert(body is PlayerController, "Bug: body is not PlayerController.") var player: PlayerController = body if not player: return player.damage()
> **Note:** If you try to cast with a built-in type and it fails, Godot will throw an error.
<span id="doc_gdscript_static_typing_safe_lines"></span>
...
> **Note:** Detailed documentation about the GDScript warning system has been moved to :ref:`doc_gdscript_warning_system`.
...
| abs()          | | absf(),                                   |
|                                                      |   absi()                                    |
|                                                      | | [Vector2.abs()](../../../classes/class_vector2.md#class_Vector2_method_abs),                                  |
|                                                      |   [Vector2i.abs()](../../../classes/class_vector2i.md#class_Vector2i_method_abs)                                 |
|                                                      | | [Vector3.abs()](../../../classes/class_vector3.md#class_Vector3_method_abs),                                  |
|                                                      |   [Vector3i.abs()](../../../classes/class_vector3i.md#class_Vector3i_method_abs)                                 |
|                                                      | | [Vector4.abs()](../../../classes/class_vector4.md#class_Vector4_method_abs),                                  |
|                                                      |   [Vector4i.abs()](../../../classes/class_vector4i.md#class_Vector4i_method_abs)                                 |
+------------------------------------------------------+-------------------------------------------------------------------------------------+
| ceil()       | | ceilf(),                                 |
|                                                      |   ceili()                                  |
|                                                      | | [Vector2.ceil()](../../../classes/class_vector2.md#class_Vector2_method_ceil)                                 |
|                                                      | | [Vector3.ceil()](../../../classes/class_vector3.md#class_Vector3_method_ceil)                                 |
|                                                      | | [Vector4.ceil()](../../../classes/class_vector4.md#class_Vector4_method_ceil)                                 |
+------------------------------------------------------+-------------------------------------------------------------------------------------+
| clamp()     | | clampf(),                               |
|                                                      |   clampi()                                |
|                                                      | | [Vector2.clamp()](../../../classes/class_vector2.md#class_Vector2_method_clamp),                              |
|                                                      |   [Vector2i.clamp()](../../../classes/class_vector2i.md#class_Vector2i_method_clamp)                             |
|                                                      | | [Vector3.clamp()](../../../classes/class_vector3.md#class_Vector3_method_clamp),                              |
|                                                      |   [Vector3i.clamp()](../../../classes/class_vector3i.md#class_Vector3i_method_clamp)                             |
|                                                      | | [Vector4.clamp()](../../../classes/class_vector4.md#class_Vector4_method_clamp),                              |
|                                                      |   [Vector4i.clamp()](../../../classes/class_vector4i.md#class_Vector4i_method_clamp)                             |
|                                                      | | [Color.clamp()](../../../classes/class_color.md#class_Color_method_clamp)                                   |
|                                                      | | (untyped `clamp()` does not work on Color)                                      |
+------------------------------------------------------+-------------------------------------------------------------------------------------+
| floor()     | | floorf(),                               |
|                                                      |   floori()                                |
|                                                      | | [Vector2.floor()](../../../classes/class_vector2.md#class_Vector2_method_floor)                               |
|                                                      | | [Vector3.floor()](../../../classes/class_vector3.md#class_Vector3_method_floor)                               |
|                                                      | | [Vector4.floor()](../../../classes/class_vector4.md#class_Vector4_method_floor)                               |
+------------------------------------------------------+-------------------------------------------------------------------------------------+
| lerp()       | | lerpf()                                  |
|                                                      | | [Vector2.lerp()](../../../classes/class_vector2.md#class_Vector2_method_lerp)                                 |
|                                                      | | [Vector3.lerp()](../../../classes/class_vector3.md#class_Vector3_method_lerp)                                 |
|                                                      | | [Vector4.lerp()](../../../classes/class_vector4.md#class_Vector4_method_lerp)                                 |
|                                                      | | [Color.lerp()](../../../classes/class_color.md#class_Color_method_lerp)                                     |
|                                                      | | [Quaternion.slerp()](../../../classes/class_quaternion.md#class_Quaternion_method_slerp)                         |
|                                                      | | [Basis.slerp()](../../../classes/class_basis.md#class_Basis_method_slerp)                                   |
|                                                      | | [Transform2D.interpolate_with()](../../../classes/class_transform2d.md#class_Transform2D_method_interpolate_with) |
|                                                      | | [Transform3D.interpolate_with()](../../../classes/class_transform3d.md#class_Transform3D_method_interpolate_with) |
+------------------------------------------------------+-------------------------------------------------------------------------------------+
| round()     | | roundf(),                               |
|                                                      |   roundi()                                |
|                                                      | | [Vector2.round()](../../../classes/class_vector2.md#class_Vector2_method_round)                               |
|                                                      | | [Vector3.round()](../../../classes/class_vector3.md#class_Vector3_method_round)                               |
|                                                      | | [Vector4.round()](../../../classes/class_vector4.md#class_Vector4_method_round)                               |
+------------------------------------------------------+-------------------------------------------------------------------------------------+
| sign()       | | signf()                                  |
|                                                      | | signi()                                  |
|                                                      | | [Vector2.sign()](../../../classes/class_vector2.md#class_Vector2_method_sign),                                |
|                                                      |   [Vector2i.sign()](../../../classes/class_vector2i.md#class_Vector2i_method_sign)                               |
|                                                      | | [Vector3.sign()](../../../classes/class_vector3.md#class_Vector3_method_sign),                                |
|                                                      |   [Vector3i.sign()](../../../classes/class_vector3i.md#class_Vector3i_method_sign)                               |
|                                                      | | [Vector4.sign()](../../../classes/class_vector4.md#class_Vector4_method_sign),                                |
|                                                      |   [Vector4i.sign()](../../../classes/class_vector4i.md#class_Vector4i_method_sign)                               |
+------------------------------------------------------+-------------------------------------------------------------------------------------+
| snapped() | | snappedf()                            |
|                                                      | | snappedi()                            |
|                                                      | | [Vector2.snapped()](../../../classes/class_vector2.md#class_Vector2_method_snapped),                          |
|                                                      |   [Vector2i.snapped()](../../../classes/class_vector2i.md#class_Vector2i_method_snapped)                         |
|                                                      | | [Vector3.snapped()](../../../classes/class_vector3.md#class_Vector3_method_snapped),                          |
|                                                      |   [Vector3i.snapped()](../../../classes/class_vector3i.md#class_Vector3i_method_snapped)                         |
|                                                      | | [Vector4.snapped()](../../../classes/class_vector4.md#class_Vector4_method_snapped),                          |
|                                                      |   [Vector4i.snapped()](../../../classes/class_vector4i.md#class_Vector4i_method_snapped)                         |
+------------------------------------------------------+-------------------------------------------------------------------------------------+
