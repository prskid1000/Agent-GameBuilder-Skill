<span id="doc_gdscript_printf"></span>
...
[String.format()](../../../classes/class_string.md#class_String_method_format)
...
> **Note:** In Godot's C++ code, GDScript format strings can be accessed using the ``vformat()`` helper function in the :ref:`Variant<class_Variant>` header.
