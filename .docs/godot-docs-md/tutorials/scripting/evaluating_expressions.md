<span id="doc_evaluating_expressions"></span>

## Evaluating expressions

Godot provides an [class_Expression](../../classes/class_expression.md#class_Expression) class you can use to evaluate expressions.
...
- A method call on a user-provided script like `update_health()`,
  ...
  [Expression.execute()](../../classes/class_expression.md#class_Expression_method_execute).
...
When calling [Expression.execute()](../../classes/class_expression.md#class_Expression_method_execute),
