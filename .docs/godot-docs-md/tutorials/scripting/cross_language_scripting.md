<span id="doc_cross_language_scripting"></span>
...
(see [doc_gdscript_classes_as_resources](gdscript/gdscript_basics.md#doc_gdscript_classes_as_resources)), the script can be instantiated
with [new()](../../classes/class_csharpscript.md#class_CSharpScript_method_new).
...
be instantiated with [GDScript.New()](../../classes/class_gdscript.md#class_GDScript_method_new).
...
Here we are using an [class_Object](../../classes/class_object.md#class_Object), but you can use type conversion like
explained in [doc_c_sharp_features_type_conversion_and_casting](c_sharp/c_sharp_features.md#doc_c_sharp_features_type_conversion_and_casting).
...
convoluted. You will have to use [GodotObject.Get()](../../classes/class_object.md#class_Object_method_get)
and [GodotObject.Set()](../../classes/class_object.md#class_Object_method_set). The first argument is the name of the field you want to access.
...
[doc_gdscript_builtin_types](gdscript/gdscript_basics.md#doc_gdscript_builtin_types) or classes extending [class_Object](../../classes/class_object.md#class_Object).
...
[GodotObject.Call()](../../classes/class_object.md#class_Object_method_call). The first argument is the
...
<span id="connecting_to_signals_cross_language"></span>
