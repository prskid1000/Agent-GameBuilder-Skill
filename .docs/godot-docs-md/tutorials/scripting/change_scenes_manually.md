<span id="doc_change_scenes_manually"></span>

## Change scenes manually

Sometimes it helps to have more control over how you swap scenes around.
A [Viewport](../../classes/class_viewport.md#class_Viewport)'s child nodes will render to the image
...
from view of the [Viewport](../../classes/class_viewport.md#class_Viewport). The tradeoffs involve
balancing operation speed and memory consumption, as well as balancing data
access and integrity.

1. **Delete the existing scene.**
   [SceneTree.change_scene_to_file()](../../classes/class_scenetree.md#class_SceneTree_method_change_scene_to_file) and
   [SceneTree.change_scene_to_packed()](../../classes/class_scenetree.md#class_SceneTree_method_change_scene_to_packed)
   ...
   `get_node("/root/Main").free()` to delete the whole scene.
    ...
    - Unloads memory.
        ...
        - Note: It can be useful to preserve the data in a soon-to-be-deleted
          ...
          or even directly to the [SceneTree](../../classes/class_scenetree.md#class_SceneTree).
...
2. **Hide the existing scene.** By changing the visibility or collision
   ...
   [CanvasItem.hide()](../../classes/class_canvasitem.md#class_CanvasItem_method_hide) to hide a scene and
   [CanvasItem.show()](../../classes/class_canvasitem.md#class_CanvasItem_method_show) to show it again.
...
3. **Remove the existing scene from the tree.** Assign a variable
   ...
   [Node.remove_child(Node)](../../classes/class_node.md#class_Node_method_remove_child) to detach the entire
   scene from the tree. To attach it later, use
   [Node.add_child(Node)](../../classes/class_node.md#class_Node_method_add_child).
    ...
    - Con: Unlike with hiding it from view only, the data contained within
      ...
      or other data that is derived from [SceneTree](../../classes/class_scenetree.md#class_SceneTree)
      access.
...
[SubViewportContainers](../../classes/class_subviewportcontainer.md#class_SubViewportContainer). This is optimal for
