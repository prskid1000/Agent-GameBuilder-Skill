...
- During execution, by calling [Node.add_to_group()](../../classes/class_node.md#class_Node_method_add_to_group)
  or [Node.remove_from_group()](../../classes/class_node.md#class_Node_method_remove_from_group).
...
![](img/groups_add_new_group_modal.webp)
...
![](img/groups_node_tab_with_created_groups.webp)
...
> **Warning:** Groups with the same name are considered one and the same. This feature is purely organizational.
![](img/groups_node_tab_with_multiple_types_of_groups.webp)
...
![](img/groups_global_groups_settings.webp)
...
The [SceneTree](../../classes/class_scenetree.md#class_SceneTree) class provides many more useful methods
