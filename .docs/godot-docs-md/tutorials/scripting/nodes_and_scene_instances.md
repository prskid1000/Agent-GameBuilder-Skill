<span id="doc_nodes_and_scene_instances"></span>
...
.. seealso::
    ...
    Check the [doc_instancing](../../getting_started/step_by_step/instancing.md#doc_instancing) tutorial to learn about Godot's approach to scene instancing.
...
![](img/nodes_and_scene_instances_player_scene_example.webp)
...
![](img/nodes_and_scene_instances_sprite_node.webp)
...
![](img/nodes_and_scene_instances_sprite_node_renamed.webp)
...
![](img/nodes_and_scene_instances_ui_scene_example.webp)
...
> **Note:** practice is to avoid doing that though not to break encapsulation. You can also start the path with a forward slash to make it absolute, in which case your topmost node would be "/root", the application's predefined root viewport.
Syntactic sugar
~~~~~~~~~~~~~~~
...
![](img/nodes_and_scene_instances_remote_tree_with_sprite.webp)

After the engine freed the node, the remote scene tree doesn't display the
sprite anymore.

![](img/nodes_and_scene_instances_remote_tree_no_sprite.webp)
...
2. Creating an instance of the loaded [PackedScene](../../classes/class_packedscene.md#class_PackedScene)
   resource.
