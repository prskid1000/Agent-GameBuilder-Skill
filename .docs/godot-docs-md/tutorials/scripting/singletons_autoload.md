<span id="doc_singletons_autoload"></span>
...
.. tip::
    ...
    [registering it automatically in the Project Settings](../plugins/editor/making_plugins.md#doc_making_plugins_autoload)
    when the plugin is enabled.

### Autoload

You can create an Autoload to load a scene or a script that inherits from
[class_Node](../../classes/class_node.md#class_Node).

> **Note:** When autoloading a script, a :ref:`class_Node` will be created and the script will be attached to it. This node will be added to the root viewport before any other scenes are loaded.
![](img/singleton.webp)

To autoload a scene or script, start from the menu and navigate to
**Project > Project Settings > Globals > Autoload**.

![](img/autoload_tab.webp)
...
method (see [doc_scene_tree](scene_tree.md#doc_scene_tree) for details). However, if you need more
...
Using [Object.call_deferred()](../../classes/class_object.md#class_Object_method_call_deferred),
