<span id="doc_creating_script_templates"></span>
...
![](img/script_create_dialog_templates.webp)
...
* `node_type` is the node it will apply to (for example, [Node](../../classes/class_node.md#class_Node), or [CharacterBody3D](../../classes/class_characterbody3d.md#class_CharacterBody3D)),
...
![](img/script_create_dialog_custom_templates.webp)

> **Note:** files. This may lead to an issue of a script parser treating those templates as actual scripts within a project. To avoid this, make sure to ignore the directory containing them by creating an empty ``.gdignore`` file. The directory won't be visible throughout the project's filesystem anymore, yet the templates can be modified by an external text editor anytime.
.. tip::
...
`basic_movement` for both [CharacterBody2D](../../classes/class_characterbody2d.md#class_CharacterBody2D) and
[CharacterBody3D](../../classes/class_characterbody3d.md#class_CharacterBody3D) and `plugin` for
[EditorPlugin](../../classes/class_editorplugin.md#class_EditorPlugin).
...
|                          | [EditorSettings](../../classes/class_editorsettings.md#class_EditorSettings)       |
...
[EditorSettings](../../classes/class_editorsettings.md#class_EditorSettings) is disabled, type hints
