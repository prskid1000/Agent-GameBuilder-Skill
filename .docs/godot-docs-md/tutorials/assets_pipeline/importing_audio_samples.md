<span id="doc_importing_audio_samples"></span>
...
AudioStreamPlayer2D or AudioStreamPlayer3D nodes. See [doc_audio_streams](../audio/audio_streams.md#doc_audio_streams)
...
[doc_importing_audio_samples_best_practices](importing_audio_samples.md#doc_importing_audio_samples_best_practices) for more information.
...
[Advanced import settings](importing_audio_samples.md#doc_importing_audio_samples_advanced_import_settings)
...
<span id="doc_importing_audio_samples_advanced_import_settings"></span>
...
<span id="doc_importing_audio_samples_best_practices"></span>
...
Godot has an [extensive bus system](../audio/audio_buses.md#doc_audio_buses) with built-in effects.
...
.. seealso::
    ...
    [runtime file loading and saving](../io/runtime_file_loading_and_saving.md#doc_runtime_file_loading_and_saving_audio_video_files),
