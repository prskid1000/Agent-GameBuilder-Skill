<span id="doc_advanced_import_settings"></span>
...
> **Note:** This page does not go over options also available in the import dock, or anything outside of the advanced import settings. For information on those please read the :ref:`doc_importing_3d_scenes_import_configuration` page.
...
- **Generate > NavMesh:** If checked, generates a NavigationRegion3D *child*
  node for [navigation](../../navigation/navigation_introduction_3d.md#doc_navigation_overview_3d). **Mesh + NavMesh**
...
- **Generate > Occluder:** If checked, generates an OccluderInstance3D *sibling*
  node for [occlusion culling](../../3d/occlusion_culling.md#doc_occlusion_culling) using the mesh's
...
- **Save to File:** Saves the [class_Mesh](../../../classes/class_mesh.md#class_Mesh) *resource* to an external file
  ...
  nodes, such as [class_MeshInstance3D](../../../classes/class_meshinstance3d.md#class_MeshInstance3D), [class_MultiMeshInstance3D](../../../classes/class_multimeshinstance3d.md#class_MultiMeshInstance3D),
  [class_GPUParticles3D](../../../classes/class_gpuparticles3d.md#class_GPUParticles3D) or [class_CPUParticles3D](../../../classes/class_cpuparticles3d.md#class_CPUParticles3D).
...
- **Generate > Shadow Meshes:** Per-mesh override for the **Meshes > Create
  ...
  [doc_importing_3d_scenes_using_the_import_dock](import_configuration.md#doc_importing_3d_scenes_using_the_import_dock). **Default** will use the
...
Several extra options are available for the generated [class_AnimationPlayer](../../../classes/class_animationplayer.md#class_AnimationPlayer)
