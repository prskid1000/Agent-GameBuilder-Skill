<span id="doc_importing_3d_scenes_import_configuration"></span>
...
[doc_importing_3d_scenes_model_export_considerations](model_export_considerations.md#doc_importing_3d_scenes_model_export_considerations) and
[doc_importing_3d_scenes_node_type_customization](node_type_customization.md#doc_importing_3d_scenes_node_type_customization) articles
...
- The **Advanced Import Settings** dialog, which can be accessed by double-clicking
  ...
  preview models and animations. please see the [doc_advanced_import_settings](advanced_import_settings.md#doc_advanced_import_settings)
  page for more information.
- [Import hints](node_type_customization.md#doc_importing_3d_scenes_node_type_customization), which are special
...
<span id="doc_importing_3d_scenes_using_the_import_dock"></span>
...
- **Generate LODs:** If checked, generates lower detail variants of the
  ...
  See [doc_mesh_lod](../../3d/mesh_lod.md#doc_mesh_lod) for more information.
...
- **Light Baking:** Configures the meshes'
  [global illumination mode](../../../classes/class_geometryinstance3d.md#class_GeometryInstance3D_property_gi_mode)
  in the 3D scene. If set to **Static Lightmaps**, sets the meshes' GI mode to
  **Static** and generates UV2 on import for [lightmap baking](../../3d/global_illumination/using_lightmap_gi.md#doc_using_lightmap_gi).
...
- **Use Named Skins:** If checked, use named [Skins](../../../classes/class_skin.md#class_Skin) for animation.
  The [class_MeshInstance3D](../../../classes/class_meshinstance3d.md#class_MeshInstance3D) node contains 3 properties of relevance here: a skeleton
  NodePath pointing to the Skeleton3D node (usually `..`), a mesh, and a skin:

  - The [class_Skeleton3D](../../../classes/class_skeleton3d.md#class_Skeleton3D) node contains a list of bones with names, their pose and rest,
...
- **Path:** Path to an import script, which can run code *after*
  ...
  See [doc_importing_3d_scenes_import_script](import_configuration.md#doc_importing_3d_scenes_import_script) for more information.
...
- **Custom Properties:** If checked, imports custom properties from Blender as glTF extras.
  ...
  [GLTFDocument.register_gltf_document_extension()](../../../classes/class_gltfdocument.md#class_GLTFDocument_method_register_gltf_document_extension),
...
<span id="doc_importing_3d_scenes_import_script"></span>
...
glTF file will be imported as an [class_AnimationLibrary](../../../classes/class_animationlibrary.md#class_AnimationLibrary) instead of a
[class_PackedScene](../../../classes/class_packedscene.md#class_PackedScene). This animation library can then be referenced in an
[class_AnimationPlayer](../../../classes/class_animationplayer.md#class_AnimationPlayer) node.
...
[doc_importing_3d_scenes_using_the_import_dock](import_configuration.md#doc_importing_3d_scenes_using_the_import_dock) for more information.
...
[String.matchn()](../../../classes/class_string.md#class_String_method_matchn) under the hood).
