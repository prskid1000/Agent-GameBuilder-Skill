<span id="doc_importing_3d_scenes_model_export_considerations"></span>
...
.. seealso::
    ...
    For more information on Godot's materials, see [doc_standard_material_3d](../../3d/standard_material_3d.md#doc_standard_material_3d).
