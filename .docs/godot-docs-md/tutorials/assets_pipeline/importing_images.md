<span id="doc_importing_images"></span>
...
- SVG (`.svg`)
  ...
  complex vectors may not render correctly. [Text must be converted to paths](importing_images.md#doc_importing_images_svg_text);
...
without converting them back to an [class_Image](../../classes/class_image.md#class_Image) in a script. This is what
...
<span id="doc_importing_images_changing_import_type"></span>
...
- **BitMap:** 1-bit monochrome texture (intended to be used as a click mask in
  [class_TextureButton](../../classes/class_texturebutton.md#class_TextureButton) and [class_TouchScreenButton](../../classes/class_touchscreenbutton.md#class_TouchScreenButton)). This resource
...
- **Font Data (Monospace Image Font):** Import the image as a bitmap font where
  all characters have the same width. See [doc_gui_using_fonts](../ui/gui_using_fonts.md#doc_gui_using_fonts).
- **Image:** Import the image as-is. This resource type cannot be displayed
  ...
  script using [get_pixel](../../classes/class_image.md#class_Image_method_get_pixel).
...
- **Texture2DArray:** Import the image as a collection of 2-dimensional textures.
  ...
  texture arrays, so you must create a custom shader in [2D](../shaders/shader_reference/canvas_item_shader.md#doc_canvas_item_shader)
  or [3D](../shaders/shader_reference/spatial_shader.md#doc_spatial_shader) to display a texture from a texture array.
- **Texture3D:** Import the image as a 3-dimensional texture. This is *not* a 2D
  ...
  [class_FogMaterial](../../classes/class_fogmaterial.md#class_FogMaterial) density maps in :ref:`volumetric fog
  <doc_volumetric_fog>`, [particle attractor](../3d/particles/attractors.md#doc_3d_particles_attractors)
  vector fields, [class_Environment](../../classes/class_environment.md#class_Environment) 3D LUT color correction, and custom shaders.
...
[class_BaseMaterial3D](../../classes/class_basematerial3d.md#class_BaseMaterial3D)). If this happens, several import options are
...
[doc_importing_images_detect_3d_compress_to](importing_images.md#doc_importing_images_detect_3d_compress_to) is changed. The texture is
...
[doc_importing_images_detect_3d_compress_to](importing_images.md#doc_importing_images_detect_3d_compress_to) option before using the
texture in 3D, or change [doc_importing_images_compress_mode](importing_images.md#doc_importing_images_compress_mode) to
...
.. seealso::
    ...
    [per-material configuration in 3D](../3d/standard_material_3d.md#doc_standard_material_3d_sampling).
    In custom shaders, filter and repeat mode is changed on the `sampler2D`
    uniform using hints described in the [doc_shading_language](../shaders/shader_reference/shading_language.md#doc_shading_language)
    documentation.

<span id="doc_importing_images_compress_mode"></span>
...
textures ([class_Cubemap](../../classes/class_cubemap.md#class_Cubemap), [class_CubemapArray](../../classes/class_cubemaparray.md#class_CubemapArray), [class_Texture2DArray](../../classes/class_texture2darray.md#class_Texture2DArray)
and [class_Texture3D](../../classes/class_texture3d.md#class_Texture3D)). This forces all layers from the texture to be imported
...
<span id="doc_importing_images_mipmaps"></span>
...
- In 2D, a [class_CanvasItemMaterial](../../classes/class_canvasitemmaterial.md#class_CanvasItemMaterial) will need to be created and
  configured to use the **Premul Alpha** blend mode on CanvasItems that use this
  texture. In [custom canvas item shaders](../shaders/shader_reference/canvas_item_shader.md#doc_canvas_item_shader),
  `render_mode blend_premul_alpha;` should be used.
- In 3D, a [class_BaseMaterial3D](../../classes/class_basematerial3d.md#class_BaseMaterial3D) will need to be created and configured
  to use the **Premul Alpha** blend mode on materials that use this texture.
  In [custom spatial shaders](../shaders/shader_reference/spatial_shader.md#doc_spatial_shader),
  `render_mode blend_premul_alpha;` should be used.
...
<span id="doc_importing_images_detect_3d_compress_to"></span>

Detect 3D > Compress To
~~~~~~~~~~~~~~~~~~~~~~~

This changes the [doc_importing_images_compress_mode](importing_images.md#doc_importing_images_compress_mode) option that is used
...
<span id="doc_importing_images_editor_import_options"></span>
...
[Godot's own color palette for editor icons](../../engine_details/editor/creating_icons.md#doc_editor_icons), with the
...
<span id="doc_importing_images_svg_text"></span>
...
To support [multiple resolutions](../rendering/multiple_resolutions.md#doc_multiple_resolutions) with crisp
...
.. seealso::
    ...
    [runtime file loading and saving](../io/runtime_file_loading_and_saving.md#doc_runtime_file_loading_and_saving_images),
