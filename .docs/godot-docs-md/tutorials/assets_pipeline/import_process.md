<span id="doc_import_process"></span>
...
need to use the [Resource Loader](../../classes/class_resourceloader.md#class_ResourceLoader) as it will
automatically take into account where the internal files are saved. If you
try and access an imported asset using the [FileAccess](../../classes/class_fileaccess.md#class_FileAccess) class,
it will work in the editor, but **it will break in the exported project**.

However, the [Resource Loader](../../classes/class_resourceloader.md#class_ResourceLoader) cannot access
non-imported files. Only the [FileAccess](../../classes/class_fileaccess.md#class_FileAccess) class can.

### Changing import parameters

> **Note:** Import parameters are only present in *non-native* Godot resource types. This means Godot's own scene and resource file formats (``.tscn``, ``.scn``, ``.tres``, ``.res``) don't have import options you can select in the Import dock.
To change the import parameters of an asset in Godot, select the relevant
resource in the FileSystem dock:

![](img/import_process_example.webp)
...
![](img/import_process_changing_import_type.webp)
...
![](img/import_process_change_preset.webp)
...
![](img/import_process_import_defaults.webp)
...
- [doc_importing_images](importing_images.md#doc_importing_images)
- [doc_importing_audio_samples](importing_audio_samples.md#doc_importing_audio_samples)
- [doc_importing_3d_scenes](importing_3d_scenes/index.md#doc_importing_3d_scenes)
- [doc_importing_translations](importing_translations.md#doc_importing_translations)
