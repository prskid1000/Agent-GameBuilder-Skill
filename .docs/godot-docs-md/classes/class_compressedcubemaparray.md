<span id="class_CompressedCubemapArray"></span>
...
An optionally compressed [CubemapArray](class_cubemaparray.md#class_CubemapArray).
...
See [CubemapArray](class_cubemaparray.md#class_CubemapArray) for a general description of cubemap arrays.
