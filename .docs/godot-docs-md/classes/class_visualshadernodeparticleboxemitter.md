<span id="class_VisualShaderNodeParticleBoxEmitter"></span>
...
[VisualShaderNodeParticleEmitter](class_visualshadernodeparticleemitter.md#class_VisualShaderNodeParticleEmitter) that makes the particles emitted in box shape with the specified extents.
