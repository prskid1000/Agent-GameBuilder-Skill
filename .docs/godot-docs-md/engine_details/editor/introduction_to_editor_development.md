<span id="doc_introduction_to_editor_development"></span>
...
To create editor plugins in GDScript, see [doc_making_plugins](../../tutorials/plugins/editor/making_plugins.md#doc_making_plugins) instead.

.. seealso::

    If you are new to Godot, we recommended you to read
    [doc_godot_design_philosophy](../../getting_started/introduction/godot_design_philosophy.md#doc_godot_design_philosophy) before continuing. Since the Godot editor
...
[UI system](../../tutorials/ui/index.md#doc_user_interface). It does *not* rely on a toolkit
...
[modules](../engine_api/custom_modules_in_cpp.md#doc_custom_modules_in_cpp). Some of these are only enabled in
...
[open it from the command line](../../tutorials/editor/command_line_tutorial.md#doc_command_line_tutorial) after compiling
