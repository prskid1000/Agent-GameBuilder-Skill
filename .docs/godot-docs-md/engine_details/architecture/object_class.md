...
.. seealso::
    ...
    Looking for the Object class reference? [Have a look here.](../../classes/class_object.md#class_Object)

### General definition

[Object](../../classes/class_object.md#class_object) is the base class for almost everything. Most classes in Godot
...
<span id="doc_binding_properties_using_set_get_property_list"></span>
...
For the values of `p_flags`, see [ConnectFlags](../../classes/class_object.md#enum_Object_ConnectFlags).
...
When an object is passed to you via [Variant](../../classes/class_variant.md#class_Variant), especially when using deferred callbacks, it is
...
[RefCounted](../../classes/class_refcounted.md#class_RefCounted) subclasses are memory managed with
...
All objects in Godot have a [_notification](../../classes/class_object.md#class_Object_private_method__notification)
method that allows them to respond to engine-level callbacks that may relate to it.
More information can be found on the [doc_godot_notifications](../../tutorials/best_practices/godot_notifications.md#doc_godot_notifications) page.

### Resources

[Resource](../../classes/class_resource.md#class_resource) inherits from RefCounted, so all resources
