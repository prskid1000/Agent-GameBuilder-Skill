<span id="doc_binding_to_external_libraries"></span>

## Binding to external libraries

### Modules

The Summator example in [doc_custom_modules_in_cpp](custom_modules_in_cpp.md#doc_custom_modules_in_cpp) is great for small,
custom modules, but what if you want to use a larger, external library?
Let's look at an example using Festival,
