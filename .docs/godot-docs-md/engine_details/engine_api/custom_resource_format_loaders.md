<span id="doc_custom_resource_format_loaders"></span>
...
data types. If not, refer to this guide: [doc_custom_modules_in_cpp](custom_modules_in_cpp.md#doc_custom_modules_in_cpp)

References
~~~~~~~~~~

- [ResourceLoader](../../classes/class_resourceloader.md#class_resourceloader)
...
Godot may not have a proper substitute within its [doc_core_types](../architecture/core_types.md#doc_core_types)
