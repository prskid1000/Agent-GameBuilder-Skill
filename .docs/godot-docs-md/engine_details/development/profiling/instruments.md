<span id="doc_profiler_instruments"></span>

## Instruments

.. seealso:: Please see the [sampling profiler instructions](index.md#doc_sampling_profilers)
             and the [tracing profiler instructions](index.md#doc_tracing_profilers) for
             more information.
