<span id="doc_compiling_for_web"></span>
...
.. seealso::
    ...
    If you're looking to export your project to HTML5 instead, read [doc_exporting_for_web](../../../tutorials/export/exporting_for_web.md#doc_exporting_for_web).
...
By default, the [JavaScriptBridge singleton](../../../tutorials/platform/web/javascript_bridge.md#doc_web_javascript_bridge) will be built
...
[export page](../../../tutorials/export/exporting_for_web.md#doc_javascript_export_options) for more info.
...
Refer to the [export page](../../../tutorials/export/exporting_for_web.md#doc_javascript_export_options) for the web
server requirements.
