<span id="doc_introduction_to_the_buildsystem"></span>

## Introduction to the buildsystem

.. highlight:: shell

Godot is a primarily C++ project and it [uses the SCons build system.](../../../about/faq.md#doc_faq_why_scons)
...
- [doc_compiling_for_android](compiling_for_android.md#doc_compiling_for_android)
- [doc_compiling_for_ios](compiling_for_ios.md#doc_compiling_for_ios)
- [doc_compiling_for_linuxbsd](compiling_for_linuxbsd.md#doc_compiling_for_linuxbsd)
- [doc_compiling_for_macos](compiling_for_macos.md#doc_compiling_for_macos)
- [doc_compiling_for_web](compiling_for_web.md#doc_compiling_for_web)
- [doc_compiling_for_windows](compiling_for_windows.md#doc_compiling_for_windows)
...
<span id="doc_introduction_to_the_buildsystem_resulting_binary"></span>
...
can be either downloaded from godotengine.org, or
you can build them yourself).

Aside from that, there are a few standard options that can be set in all
build targets, and which will be explained below.

<span id="doc_introduction_to_the_buildsystem_target"></span>
...
The list of [command line arguments](../../../tutorials/editor/command_line_tutorial.md#doc_command_line_tutorial)
...
<span id="doc_introduction_to_the_buildsystem_development_and_production_aliases"></span>

### Development and production aliases

When creating builds for development (running debugging/[profiling](../profiling/index.md#doc_using_cpp_profilers)
...
> **Note:** ``dev_build`` should **not** be confused with ``dev_mode``, which is an alias for several development-related options (see above).
...
.. seealso::
    ...
    See [doc_using_sanitizers](../debugging/using_sanitizers.md#doc_using_sanitizers) for more information.

<span id="doc_introduction_to_the_buildsystem_debugging_symbols"></span>
...
<span id="doc_buildsystem_custom_modules"></span>
...
> **Note:** If there's any custom module with the exact directory name as a built-in module, the engine will only compile the custom one. This logic can be used to override built-in module implementations.
.. seealso::

    [doc_custom_modules_in_cpp](../../engine_api/custom_modules_in_cpp.md#doc_custom_modules_in_cpp)
...
<span id="doc_overriding_build_options"></span>
...
time it takes to build the engine. See [doc_optimizing_for_size](optimizing_for_size.md#doc_optimizing_for_size) page for more details.
