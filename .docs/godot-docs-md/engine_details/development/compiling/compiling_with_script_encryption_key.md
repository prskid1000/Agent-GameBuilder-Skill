<span id="doc_compiling_with_script_encryption_key"></span>
...
> **Warning:** This will **not** work if you use official, precompiled export templates. It is absolutely **required** to compile your own export templates to use PCK encryption.
### Step by step
