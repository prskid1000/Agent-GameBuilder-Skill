<span id="doc_compiling_for_android"></span>
...
.. seealso::
    ...
    If you're looking to export your project to Android instead, read [doc_exporting_for_android](../../../tutorials/export/exporting_for_android.md#doc_exporting_for_android).
...
[doc_exporting_for_android](../../../tutorials/export/exporting_for_android.md#doc_exporting_for_android) tutorial before attempting to build
...
<span id="doc_android_setting_up_the_buildsystem"></span>
...
.. seealso::
    ...
    [Vulkan validation layers on Android](../debugging/vulkan/vulkan_validation_layers.md#doc_vulkan_validation_layers_android).
...
See [Setting up the buildsystem](compiling_for_android.md#doc_android_setting_up_the_buildsystem)
