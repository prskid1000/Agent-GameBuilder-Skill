<span id="doc_getting_source"></span>
...
Before [getting into the SCons build system](introduction_to_the_buildsystem.md#doc_introduction_to_the_buildsystem)
...
follow the instructions from the Pull Request workflow.
...
For any stable release, visit the release page
...
you can [continue to compiling Godot](introduction_to_the_buildsystem.md#doc_introduction_to_the_buildsystem).
