<span id="doc_vulkan_validation_layers"></span>
...
> **Note:** Enabling validation layers has a performance impact, so only enable them when you actually need the output to debug the application.
### Windows

Install the Vulkan SDK , which contains
...
[command line argument](../../../../tutorials/editor/command_line_tutorial.md#doc_command_line_tutorial). You can also specify
...
[command line argument](../../../../tutorials/editor/command_line_tutorial.md#doc_command_line_tutorial).
...
<span id="doc_vulkan_validation_layers_android"></span>
