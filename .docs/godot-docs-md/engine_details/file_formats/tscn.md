<span id="doc_tscn_file_format"></span>
...
The [class_Skeleton3D](../../classes/class_skeleton3d.md#class_Skeleton3D) node inherits the Node3D node, but may also have a
...
The [class_BoneAttachment3D](../../classes/class_boneattachment3d.md#class_BoneAttachment3D) node is an intermediate node to describe some
...
An example of a [class_Marker3D](../../classes/class_marker3d.md#class_Marker3D) node parented to a bone in Skeleton:
...
The [class_AnimationPlayer](../../classes/class_animationplayer.md#class_AnimationPlayer) node works with one or more animation libraries
stored in [class_AnimationLibrary](../../classes/class_animationlibrary.md#class_AnimationLibrary) resources. An animation library is a
collection of individual [class_Animation](../../classes/class_animation.md#class_Animation) resources, whose structure is
documented [here](tscn.md#doc_tscn_animation).
...
<span id="doc_tscn_animation"></span>
