<span id="doc_submitting_to_assetlib"></span>
...
to the Godot Asset Library
and share them with the Godot community.

As mentioned in the [doc_using_assetlib](using_assetlib.md#doc_using_assetlib) document, in order to be able to
...
* Make your code conform to the official **style guides**. Having a
  ...
  [doc_gdscript_styleguide](../../tutorials/scripting/gdscript/gdscript_styleguide.md#doc_gdscript_styleguide) or the [doc_c_sharp_styleguide](../../tutorials/scripting/c_sharp/c_sharp_style_guide.md#doc_c_sharp_styleguide).
...
* **Version**:
    ...
    something such as SemVer if you want your asset's
...
> **Note:** For icons hosted on GitHub, URLs must be provided in the form of `https://raw.githubusercontent.com/<user>/<project>/<branch>/Icon.png`.
* **License**:
    ...
    (v2 and v3), MIT, BSD and Boost Software License. You can visit OpenSource.org
...
You can check all assets currently pending a review here .
