<span id="doc_what_is_assetlib"></span>
...
engine, but it can also be accessed at Godot's official website.
...
and usability issues. As with all Godot projects, the code repository is available on GitHub,
